...
public class TF_Loot_Chests {
    ...
    public static void init() {
        ...
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 0), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 1), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 2), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 3), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 4), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 5), 12);
        ...
        TFTreasure.hill2.ultrarare.add(GT_ModHandler.getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0), 1);
        // Hill3 = huge
        ...
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 0), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 1), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 2), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 3), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 4), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 4, 5), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemShard", 2, 6), 12);
        ...
        TFTreasure.hill3.rare.add(GT_ModHandler.getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0), 2);
        ...
        TFTreasure.basement.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemResource", 8, 1), 12); // Nitor
        ...
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 0), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 1), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 2), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 3), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 4), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 5), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 6), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 7), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 8), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 9), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 10), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 11), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 12), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 13), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 14), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "blockCandle", 4, 15), 12);
        ...
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemResource", 2, 1), 12); // Nitor
        ...
        TFTreasure.tower_library.rare.add(GT_ModHandler.getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0), 2);
        TFTreasure.tower_library.rare.add(new ItemStack(Items.potionitem, 1, 8259), 6); // potion fire resistance iI

        // Litch Tower Boss Room
        TFTreasure.tower_room.common.add(GT_ModHandler.getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0), 3);
        TFTreasure.tower_room.common.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemLootBag", 1, 0), 12);
        ...
        TFTreasure.tower_room.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemLootBag", 1, 1), 12);
        TFTreasure.tower_room.uncommon.add(GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.NetherStar, 1L), 2);
        TFTreasure.tower_room.rare.add(GT_ModHandler.getModItem(Thaumcraft.ID, "ItemLootBag", 1, 2), 6);
    }
}
