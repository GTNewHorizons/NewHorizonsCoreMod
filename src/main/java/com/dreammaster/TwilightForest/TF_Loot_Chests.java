...
public class TF_Loot_Chests {
    ...
    public static void init() {
        ...
        // Hill1 = small
        TFTreasure.hill1.common.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dustTiny, (int) (2L)), 6);
        TFTreasure.hill1.common.add(MaterialLibAPI.getStack(Materials.Bronze, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill1.common.add(MaterialLibAPI.getStack(Materials.Nickel, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill1.common.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dustSmall, (int) (2L)), 6);
        TFTreasure.hill1.uncommon.add(MaterialLibAPI.getStack(Materials.Manganese, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill1.uncommon.add(MaterialLibAPI.getStack(Materials.Antimony, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill1.rare.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dust, (int) (1L)), 6);
        TFTreasure.hill1.ultrarare.add(MaterialLibAPI.getStack(Materials.Aluminium, Shapes.dustSmall, (int) (4L)), 12);
        // Hill2 = medium
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dustTiny, (int) (4L)), 12);
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Manganese, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Antimony, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Bronze, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Nickel, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Tin, Shapes.ingot, (int) (6L)), 12);
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Electrum, Shapes.ingot, (int) (2L)), 6);
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Copper, Shapes.ingot, (int) (6L)), 12);
        TFTreasure.hill2.common.add(MaterialLibAPI.getStack(Materials.Magnesium, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.uncommon.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dustSmall, (int) (4L)), 12);
        ...
        TFTreasure.hill2.uncommon.add(MaterialLibAPI.getStack(Materials.DamascusSteel, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.uncommon.add(MaterialLibAPI.getStack(Materials.ElectricalSteel, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.uncommon.add(MaterialLibAPI.getStack(Materials.Cobalt, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.uncommon.add(MaterialLibAPI.getStack(Materials.Molybdenum, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.uncommon.add(MaterialLibAPI.getStack(Materials.RedAlloy, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.uncommon.add(MaterialLibAPI.getStack(Materials.CastIron, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.uncommon.add(MaterialLibAPI.getStack(Materials.Steel, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill2.rare.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dust, (int) (1L)), 12);
        TFTreasure.hill2.rare.add(MaterialLibAPI.getStack(Materials.Mica, Shapes.dust, (int) (16L)), 12);
        TFTreasure.hill2.rare.add(MaterialLibAPI.getStack(Materials.Aluminium, Shapes.dust, (int) (2L)), 12);
        TFTreasure.hill2.ultrarare.add(MaterialLibAPI.getStack(Materials.Gallium, Shapes.ingot, (int) (1L)), 6);
        TFTreasure.hill2.ultrarare.add(getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0), 1);
        // Hill3 = huge
        TFTreasure.hill3.common.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dustTiny, (int) (6L)), 12);
        TFTreasure.hill3.common.add(MaterialLibAPI.getStack(Materials.Manganese, Shapes.ingot, (int) (6L)), 12);
        TFTreasure.hill3.common.add(MaterialLibAPI.getStack(Materials.Antimony, Shapes.ingot, (int) (6L)), 12);
        TFTreasure.hill3.common.add(MaterialLibAPI.getStack(Materials.Tin, Shapes.ingot, (int) (6L)), 12);
        TFTreasure.hill3.common.add(MaterialLibAPI.getStack(Materials.Electrum, Shapes.ingot, (int) (2L)), 12);
        TFTreasure.hill3.common.add(MaterialLibAPI.getStack(Materials.Copper, Shapes.ingot, (int) (6L)), 12);
        TFTreasure.hill3.common.add(MaterialLibAPI.getStack(Materials.Magnesium, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill3.uncommon.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dustSmall, (int) (6L)), 12);
        ...
        TFTreasure.hill3.uncommon.add(MaterialLibAPI.getStack(Materials.DamascusSteel, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill3.uncommon.add(MaterialLibAPI.getStack(Materials.ElectricalSteel, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill3.uncommon.add(MaterialLibAPI.getStack(Materials.Cobalt, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill3.uncommon.add(MaterialLibAPI.getStack(Materials.Molybdenum, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill3.uncommon.add(MaterialLibAPI.getStack(Materials.RedAlloy, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill3.uncommon.add(MaterialLibAPI.getStack(Materials.CastIron, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill3.uncommon.add(MaterialLibAPI.getStack(Materials.Steel, Shapes.ingot, (int) (4L)), 12);
        TFTreasure.hill3.rare.add(MaterialLibAPI.getStack(Materials.Thaumium, Shapes.dust, (int) (1L)), 12);
        TFTreasure.hill3.rare.add(MaterialLibAPI.getStack(Materials.Aluminium, Shapes.dust, (int) (2L)), 12);
        TFTreasure.hill3.rare.add(MaterialLibAPI.getStack(Materials.Aluminium, Shapes.ingot, (int) (1L)), 12);
        TFTreasure.hill3.rare.add(MaterialLibAPI.getStack(Materials.Mica, Shapes.dust, (int) (16L)), 12);
        TFTreasure.hill3.rare.add(getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0), 2);
        TFTreasure.hill3.ultrarare.add(MaterialLibAPI.getStack(Materials.Gallium, Shapes.ingot, (int) (1L)), 6);

        // UrGhast Tower Basment
        TFTreasure.basement.common.add(new ItemStack(Blocks.torch, 16, 0), 2);
        TFTreasure.basement.common
                .add(MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.ingot, (int) (16L)), 12);
        TFTreasure.basement.common.add(MaterialLibAPI.getStack(Materials.Void, Shapes.ingot, (int) (8L)), 6);
        ...
        TFTreasure.tower_library.common
                .add(MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.dust, (int) (4L)), 6);
        TFTreasure.tower_library.common.add(GTOreDictUnificator.get(OrePrefixes.gem, Materials.EnderPearl, 8L), 6);
        TFTreasure.tower_library.common
                .add(MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.ingot, (int) (2L)), 6);
        TFTreasure.tower_library.common.add(MaterialLibAPI.getStack(Materials.Void, Shapes.dust, (int) (2L)), 6);
        ...
        TFTreasure.tower_room.uncommon
                .add(MaterialLibAPI.getStack(Materials.NetherStar, Shapes.dustTiny, (int) (1L)), 2);
