...
public class TF_Loot_Chests {
    ...
    public static void init() {
        boolean isThaumLoaded = Thaumcraft.isModLoaded();
        boolean isDELoaded = DraconicEvolution.isModLoaded();
        ...
        if (isThaumLoaded) {
            ...
            TFTreasure.basement.uncommon.add(getModItem(Thaumcraft.ID, "ItemResource", 16, 14), 6); // Salis Mundus
        }
        ...
        if (isThaumLoaded) {
            ...
            // Nitor
            TFTreasure.tower_library.common.add(getModItem(Thaumcraft.ID, "ItemResource", 2, 1), 12);
            // Alumentum
            TFTreasure.tower_library.common.add(getModItem(Thaumcraft.ID, "ItemResource", 1, 0), 12);
            // Salis Mundus
            TFTreasure.tower_library.common.add(getModItem(Thaumcraft.ID, "ItemResource", 4, 14), 6);
        }

        // Litch Tower Library - Uncommon
        ...
        if (isThaumLoaded) {
            ...
            TFTreasure.tower_library.uncommon.add(getModItem(Thaumcraft.ID, "ItemResource", 4, 14), 6); // Salis Mundus
        }
        if (isDELoaded) {
            TFTreasure.tower_library.uncommon.add(getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0), 1);
        }

        // Litch Tower Library - Rare
        ...
        // Litch Tower Boss Room - Uncommon
