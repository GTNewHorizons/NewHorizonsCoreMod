...
public class TF_Loot_Chests {
    ...
    public static void init() {
        ...
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 0), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 1), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 2), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 3), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 4), 12);
        TFTreasure.hill2.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 5), 12);
        ...
        TFTreasure.hill2.ultrarare.add(GT_ModHandler.getModItem(DraconicEvolution.modID, "dezilsMarshmallow", 1, 0), 1);
        // Hill3 = huge
        ...
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 0), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 1), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 2), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 3), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 4), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 4, 5), 12);
        TFTreasure.hill3.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemShard", 2, 6), 12);
        ...
        TFTreasure.hill3.rare.add(GT_ModHandler.getModItem(DraconicEvolution.modID, "dezilsMarshmallow", 1, 0), 2);
        ...
        TFTreasure.basement.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 8, 1), 12); // Nitor
        ...
        TFTreasure.basement.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 8, 0), 12); // Alumentum
        TFTreasure.basement.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 16, 14), 6); // Salis
                                                                                                             // Mundus
        ...
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 0), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 1), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 2), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 3), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 4), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 5), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 6), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 7), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 8), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 9), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 10), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 11), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 12), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 13), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 14), 12);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "blockCandle", 4, 15), 12);
        TFTreasure.tower_library.common
                .add(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.StainlessSteel, 4L), 6);
        ...
        TFTreasure.tower_library.common
                .add(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 2L), 6);
        TFTreasure.tower_library.common.add(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Void, 2L), 6);
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 2, 1), 12); // Nitor
        TFTreasure.tower_library.common.add(new ItemStack(Items.potionitem, 1, 8201), 6); // potion strength i
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 1, 0), 12); // Alumentum
        TFTreasure.tower_library.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 4, 14), 6); // Salis
                                                                                                               // Mundus
        TFTreasure.tower_library.uncommon.add(new ItemStack(Items.potionitem, 1, 8198), 6); // potion night vision i
        TFTreasure.tower_library.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 2, 1), 8); // Nitor
        ...
        TFTreasure.tower_library.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 1, 0), 8); // Alumentum
        TFTreasure.tower_library.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 4, 14), 6); // Salis
                                                                                                                 // Mundus
        ...
        TFTreasure.tower_library.uncommon
                .add(GT_ModHandler.getModItem(DraconicEvolution.modID, "dezilsMarshmallow", 1, 0), 1);
        ...
        TFTreasure.tower_library.rare.add(GT_ModHandler.getModItem(DraconicEvolution.modID, "dezilsMarshmallow", 1, 0), 2);
        TFTreasure.tower_library.rare.add(new ItemStack(Items.potionitem, 1, 8259), 6); // potion fire resistance iI

        // Litch Tower Boss Room
        TFTreasure.tower_room.common.add(GT_ModHandler.getModItem(DraconicEvolution.modID, "dezilsMarshmallow", 1, 0), 3);
        TFTreasure.tower_room.common.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemLootBag", 1, 0), 12);
        ...
        TFTreasure.tower_room.uncommon.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemLootBag", 1, 1), 12);
        TFTreasure.tower_room.uncommon.add(GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.NetherStar, 1L), 2);
        TFTreasure.tower_room.rare.add(GT_ModHandler.getModItem(Thaumcraft.modID, "ItemLootBag", 1, 2), 6);
    }
}
