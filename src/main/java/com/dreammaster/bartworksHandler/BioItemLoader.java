...
public class BioItemLoader {
    ...
    static {
        ...
        RA.addMultiblockChemicalRecipe(
                new ItemStack[] { BIOTEMSSTACKS[2].copy().splitStack(8), ItemList.Circuit_Chip_Stemcell.get(16),
                        Materials.Salt.getDust(64) },
                new FluidStack[] { FluidRegistry.getFluidStack("unknowwater", 4000),
                        Materials.PhthalicAcid.getFluid(3000), new FluidStack(BIOFLUIDS[1], 1000) },
