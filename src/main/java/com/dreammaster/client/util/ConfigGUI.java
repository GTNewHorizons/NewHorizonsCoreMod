...
public class ConfigGUI extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(
                new GuiCheckBox(1, this.width / 2 - 100, 50, "Weak?", NumberFormatConfig.useForgeFluidMillibuckets));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(
                ...
                StatCollector.translateToLocal("dreamcraft.configmenu.title"),
                this.width / 2,
                15,
                0xFFFFFF);
        if (!CoreModConfig.Modules.WasConfigScreenShown) {
            this.drawCenteredString(
                    this.fontRendererObj,
                    StatCollector.translateToLocal("dreamcraft.configmenu.firsttime"),
                    this.width / 2,
                    25,
                    0x53E0E0);
        }
