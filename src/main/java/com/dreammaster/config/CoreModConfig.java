...
public class CoreModConfig extends ConfigManager
{
  ...
  protected void Init()
  {
    ...
    DebugPrintAllMaterials = _mainConfig.getBoolean( "DebugPrintAllMaterials", "DeepDarkVoidMiner", DebugPrintMaterials, "Set to true to enable logging of all GregTech material names with ores. This is useful for debugging, or finding names to add to the blacklist. See: gregtech.api.enums.Materials" );
    DebugPrintAllWerkstoff = _mainConfig.getBoolean( "DebugPrintAllWerkstoff", "DeepDarkVoidMiner", DebugPrintWerkstoff, "Set to true to enable logging of all BartWorks material names with ores. This is useful for debugging, or finding names to add to the blacklist. See: com.github.bartimaeusnek.bartworks.system.material.Werkstoff" );
