...
public class GT_Loader_FluidPipes {
    ...
    private void registerHighTierPipes() {
        ...
        generateFluidMultiPipes(
                Materials.MysteriousCrystal, Materials.MysteriousCrystal.mName, 5235, 24000, 1000000, true);
        ...
        generateFluidMultiPipes(
                Materials.DraconiumAwakened, Materials.DraconiumAwakened.mName, 5245, 45000, 10000000, true);
        ...
        generateFluidPipes(
                GT_CoreModSupport.RadoxPolymer, GT_CoreModSupport.RadoxPolymer.mName, 5760, 5000, 1500, true);
