...
public class GT_Loader_Machines {
    ...
    private void registerMachines1() {
        ...
        CustomItemList.Hull_UEV.set(new GT_MetaTileEntity_BasicHull(
                        11230, "hull.tier.10", "UEV Machine Hull", 10, GT_Loader_MetaTileEntities.imagination)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Hull_UEV.get(1L), bitsd, new Object[] {
            "PHP",
            "WMW",
            'M',
            CustomItemList.Casing_UEV,
            'W',
        ...
        CustomItemList.Hull_UIV.set(new GT_MetaTileEntity_BasicHull(
                        11231, "hull.tier.11", "UIV Machine Hull", 11, GT_Loader_MetaTileEntities.imagination)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Hull_UIV.get(1L), bitsd, new Object[] {
            "PHP",
            "WMW",
            'M',
            CustomItemList.Casing_UIV,
            'W',
        ...
        CustomItemList.Hull_UMV.set(new GT_MetaTileEntity_BasicHull(
                        11232, "hull.tier.12", "UMV Machine Hull", 12, GT_Loader_MetaTileEntities.imagination)
                .getStackForm(1L));
        ...
        CustomItemList.Generator_Plasma_ZPMV.set(new GT_MetaTileEntity_PlasmaGenerator(
                        10752, "basicgenerator.plasmagenerator.tier.08", "Plasma Generator Mark IV", 7)
                .getStackForm(1L));

        CustomItemList.Generator_Plasma_UV.set(new GT_MetaTileEntity_PlasmaGenerator(
                        10753, "basicgenerator.plasmagenerator.tier.09", "Ultimate Pocket Sun", 8)
                .getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Generator_Plasma_ZPMV.get(1L), bitsd, new Object[] {
            "UCU",
            "FMF",
            "WCW",
            'M',
            ...
            'C',
            GT_CustomLoader.AdvancedGTMaterials.ZPM.getCircuit(),
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Generator_Plasma_UV.get(1L), bitsd, new Object[] {
            "UCU",
            "FMF",
            "WCW",
            'M',
            ...
            'C',
            GT_CustomLoader.AdvancedGTMaterials.UV.getCircuit(),
            'W',
            OrePrefixes.wireGt12.get(Materials.SuperconductorUHV),
            'U',
            OrePrefixes.stick.get(Materials.Americium)
        });
        ...
        CustomItemList.AlloySmelterLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        1,
                        "AlloySmelter.png",
                        GregTech_API.sSoundList.get(208),
                        false,
                        false,
                        0,
                        "ALLOY_SMELTER",
                        new Object[] {
                            ...
                            'E',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getCircuit(),
                            'W',
        ...
        CustomItemList.AlloySmelterUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL,
                            'E',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getCircuit(),
                            'W',
        ...
        CustomItemList.AlloySmelterUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            'E',
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getCircuit(),
                            'W',
        ...
        CustomItemList.AlloySmelterUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            'E',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCircuit(),
                            'W',
        ...
        CustomItemList.AlloySmelterUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            'E',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCircuit(),
                            'W',
        ...
        CustomItemList.AmplifabricatorLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        1,
                        "Amplifabricator.png",
                        GregTech_API.sSoundList.get(200),
                        false,
                        false,
                        0,
                        "AMPLIFAB",
        ...
        CustomItemList.AutoclaveLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getCable(),
                            'I',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getPlate(),
                            'G',
        ...
        CustomItemList.AutoclaveZPM.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getCable(),
                            'I',
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getPlate(),
                            'G',
        ...
        CustomItemList.AutoclaveUV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UV.getCable(),
                            'I',
                            GT_CustomLoader.AdvancedGTMaterials.UV.getPlate(),
                            'G',
        ...
        CustomItemList.AutoclaveUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getCable(),
                            'I',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getPlate(),
                            'G',
        ...
        CustomItemList.AutoclaveUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getCable(),
                            'I',
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getPlate(),
                            'G',
        ...
        CustomItemList.AutoclaveUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCable(),
                            'I',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getPlate(),
                            'G',
        ...
        CustomItemList.AutoclaveUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCable(),
                            'I',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getPlate(),
                            'G',
        ...
        CustomItemList.BendingMachineLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        1,
                        "Bender.png",
                        GregTech_API.sSoundList.get(203),
                        false,
                        false,
                        0,
                        "BENDER",
        ...
        CustomItemList.DistilleryUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.PUMP,
                            'B',
                            OrePrefixes.pipeMedium.get(Materials.Infinity),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCircuit(),
                            'W',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCable(),
        ...
        CustomItemList.DistilleryUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.PUMP,
                            'B',
                            OrePrefixes.pipeMedium.get(Materials.SpaceTime),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCircuit(),
                            'W',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCable(),
        ...
        CustomItemList.ElectricFurnaceLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        1,
                        "E_Furnace.png",
                        GregTech_API.sSoundList.get(207),
                        false,
                        false,
                        0,
                        "ELECTRIC_FURNACE",
        ...
        CustomItemList.ElectrolyzerZPM.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getCable(),
                            'I',
                            OrePrefixes.wireGt02.get(Materials.NiobiumTitanium),
                            'G',
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getGlass()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ElectrolyzerUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getCable(),
                            'I',
                            OrePrefixes.wireGt04.get(Materials.Osmiridium),
                            'G',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getGlass()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ElectrolyzerUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCable(),
                            'I',
                            OrePrefixes.wireGt04.get(Materials.DraconiumAwakened),
                            'G',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getGlass()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ElectrolyzerUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCable(),
                            'I',
                            OrePrefixes.wireGt04.get(Materials.Infinity),
                            'G',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getGlass()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ElectromagneticSeparatorLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        GregTech_API.sSoundList.get(212),
                        false,
                        false,
                        0,
                        ...
                        new Object[] {
                            ...
                            'Z',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getWire(),
                            'V',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getCircuit(),
        ...
        CustomItemList.ElectromagneticSeparatorZPM.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.STICK_ELECTROMAGNETIC,
                            'Z',
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getWire(),
                            'V',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getCircuit(),
        ...
        CustomItemList.ElectromagneticSeparatorUV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.STICK_ELECTROMAGNETIC,
                            'Z',
                            GT_CustomLoader.AdvancedGTMaterials.UV.getWire(),
                            'V',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UV.getCircuit(),
        ...
        CustomItemList.ElectromagneticSeparatorUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.STICK_ELECTROMAGNETIC,
                            'Z',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getWire(),
                            'V',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getCircuit(),
        ...
        CustomItemList.ElectromagneticSeparatorUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.STICK_ELECTROMAGNETIC,
                            'Z',
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getWire(),
                            'V',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getCircuit(),
        ...
        CustomItemList.ElectromagneticSeparatorUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.STICK_ELECTROMAGNETIC,
                            'Z',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getWire(),
                            'V',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCircuit(),
        ...
        CustomItemList.ElectromagneticSeparatorUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.STICK_ELECTROMAGNETIC,
                            'Z',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getWire(),
                            'V',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCircuit(),
        ...
        CustomItemList.ExtruderLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getCircuit(),
                            'P',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getPipe(),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getHCoil()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ExtruderZPM.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getCircuit(),
                            'P',
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getPipe(),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getHCoil()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ExtruderUV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UV.getCircuit(),
                            'P',
                            GT_CustomLoader.AdvancedGTMaterials.UV.getPipe(),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UV.getHCoil()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ExtruderUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getCircuit(),
                            'P',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getPipe(),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getHCoil()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ExtruderUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getCircuit(),
                            'P',
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getPipe(),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getHCoil()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ExtruderUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCircuit(),
                            'P',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getPipe(),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getHCoil()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.ExtruderUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCircuit(),
                            'P',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getPipe(),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getHCoil()
                        })
                .getStackForm(1L));
        ...
        CustomItemList.MaceratorLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        1,
                        "Macerator4.png",
                        GregTech_API.sSoundList.get(201),
                        false,
                        false,
                        1,
                        "PULVERIZER",
        ...
        CustomItemList.MassFabricatorZPM.set(new GT_MetaTileEntity_Massfabricator(
                        10951, "basicmachine.massfab.tier.07", "Elite Mass Fabricator II", 7)
                .getStackForm(1L));
        CustomItemList.MassFabricatorUV.set(new GT_MetaTileEntity_Massfabricator(
                        10952, "basicmachine.massfab.tier.08", "Ultimate Existence Initiator", 8)
                .getStackForm(1L));
        CustomItemList.MassFabricatorUHV.set(new GT_MetaTileEntity_Massfabricator(
                        10953, "basicmachine.massfab.tier.09", "Epic Existence Initiator", 9)
                .getStackForm(1L));
        CustomItemList.MassFabricatorUEV.set(new GT_MetaTileEntity_Massfabricator(
                        10954, "basicmachine.massfab.tier.10", "Epic Existence Initiator II", 10)
                .getStackForm(1L));
        CustomItemList.MassFabricatorUIV.set(new GT_MetaTileEntity_Massfabricator(
                        10955, "basicmachine.massfab.tier.11", "Epic Existence Initiator III", 11)
                .getStackForm(1L));
        CustomItemList.MassFabricatorUMV.set(new GT_MetaTileEntity_Massfabricator(
                        10956, "basicmachine.massfab.tier.12", "Epic Existence Initiator IV", 12)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.MassFabricatorLuV.get(1L), bitsd, new Object[] {
            "CFC",
            "WMW",
            "CFC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MassFabricatorZPM.get(1L), bitsd, new Object[] {
            "CFC",
            "WMW",
            "CFC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MassFabricatorUV.get(1L), bitsd, new Object[] {
            "CFC",
            "WMW",
            "CFC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MassFabricatorUHV.get(1L), bitsd, new Object[] {
            "CFC",
            "WMW",
            "CFC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MassFabricatorUEV.get(1L), bitsd, new Object[] {
            "CFC",
            "WMW",
            "CFC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MassFabricatorUIV.get(1L), bitsd, new Object[] {
            "CFC",
            "WMW",
            "CFC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MassFabricatorUMV.get(1L), bitsd, new Object[] {
            "CFC",
            "WMW",
            "CFC",
            'M',
        ...
        CustomItemList.OreWashingPlantLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL,
                            'R',
                            OrePrefixes.rotor.get(Materials.Chrome),
                            'E',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getCircuit(),
        ...
        CustomItemList.OreWashingPlantZPM.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL,
                            'R',
                            OrePrefixes.rotor.get(Materials.Iridium),
                            'E',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.ZPM.getCircuit(),
        ...
        CustomItemList.OreWashingPlantUV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL,
                            'R',
                            OrePrefixes.rotor.get(Materials.Osmium),
                            'E',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UV.getCircuit(),
        ...
        CustomItemList.OreWashingPlantUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            CustomItemList.Hull_UIV,
                            'R',
                            OrePrefixes.rotor.get(Materials.Infinity),
                            'E',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCircuit(),
        ...
        CustomItemList.OreWashingPlantUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            CustomItemList.Hull_UMV,
                            'R',
                            OrePrefixes.rotor.get(Materials.SpaceTime),
                            'E',
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR,
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCircuit(),
        ...
        CustomItemList.RecyclerLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        1,
                        "Recycler.png",
                        GregTech_API.sSoundList.get(204),
                        false,
                        false,
                        0,
                        "RECYCLER",
        ...
        CustomItemList.ReplicatorUV.set(new GT_MetaTileEntity_Replicator(
                        11002, "basicmachine.replicator.tier.08", "Ultimate Elemental Composer", 8)
                .getStackForm(1L));
        ...
        CustomItemList.ReplicatorUEV.set(new GT_MetaTileEntity_Replicator(
                        11004, "basicmachine.replicator.tier.10", "Epic Elemental Composer II", 10)
                .getStackForm(1L));
        CustomItemList.ReplicatorUIV.set(new GT_MetaTileEntity_Replicator(
                        11005, "basicmachine.replicator.tier.11", "Epic Elemental Composer III", 11)
                .getStackForm(1L));
        CustomItemList.ReplicatorUMV.set(new GT_MetaTileEntity_Replicator(
                        11006, "basicmachine.replicator.tier.12", "Epic Elemental Composer IV", 12)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.ReplicatorLuV.get(1L), bitsd, new Object[] {
            "EFE",
            "CMC",
            "EWE",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ReplicatorZPM.get(1L), bitsd, new Object[] {
            "EFE",
            "CMC",
            "EWE",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ReplicatorUV.get(1L), bitsd, new Object[] {
            "EFE",
            "CMC",
            "EWE",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ReplicatorUHV.get(1L), bitsd, new Object[] {
            "EFE",
            "CMC",
            "EWE",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ReplicatorUEV.get(1L), bitsd, new Object[] {
            "EFE",
            "CMC",
            "EWE",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ReplicatorUIV.get(1L), bitsd, new Object[] {
            "EFE",
            "CMC",
            "EWE",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ReplicatorUMV.get(1L), bitsd, new Object[] {
            "EFE",
            "CMC",
            "EWE",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ScannerLuV.get(1L), bitsd, new Object[] {
            "CTC",
            "WMW",
            "CRC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ScannerZPM.get(1L), bitsd, new Object[] {
            "CTC",
            "WMW",
            "CRC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ScannerUV.get(1L), bitsd, new Object[] {
            "CTC",
            "WMW",
            "CRC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ScannerUHV.get(1L), bitsd, new Object[] {
            "CTC",
            "WMW",
            "CRC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ScannerUEV.get(1L), bitsd, new Object[] {
            "CTC",
            "WMW",
            "CRC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ScannerUIV.get(1L), bitsd, new Object[] {
            "CTC",
            "WMW",
            "CRC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ScannerUMV.get(1L), bitsd, new Object[] {
            "CTC",
            "WMW",
            "CRC",
            'M',
            ...
            ItemList.Sensor_UMV,
            'C',
            OrePrefixes.circuit.get(Materials.Quantum),
            'W',
            OrePrefixes.cableGt01.get(Materials.Draconium)
        });
        // ScannerLuV
        ...
        GT_Values.RA.addSlicerRecipe(
                ...
                new ItemStack(QuantumBread.Instance(), 1),
                20,
                524200);
        ...
        // CustomItemList.PumpUV.set(new GT_MetaTileEntity_Pump(11062, "basicmachine.pump.tier.08", "Reverse
        // Terraformer", 8).getStackForm(1L));
        GT_ModHandler.addCraftingRecipe(CustomItemList.PumpLuV.get(1L), bitsd, new Object[] {
            "CPC",
            "PMP",
            "BPB",
            'M',
            ItemList.Hull_LuV,
            'B',
            GT_CustomLoader.AdvancedGTMaterials.LuV.getPipeL(),
            'C',
            GT_CustomLoader.AdvancedGTMaterials.LuV.getCircuit(),
            'P',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.PumpZPM.get(1L), bitsd, new Object[] {
            "CPC",
            "PMP",
            "BPB",
            'M',
            ItemList.Hull_ZPM,
            'B',
            GT_CustomLoader.AdvancedGTMaterials.ZPM.getPipeL(),
            'C',
            GT_CustomLoader.AdvancedGTMaterials.ZPM.getCircuit(),
            'P',
        ...
        */
        ...
        CustomItemList.ArcFurnaceLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        1,
                        "ArcFurnace.png",
                        GregTech_API.sSoundList.get(202),
                        false,
                        false,
                        0,
                        "ARC_FURNACE",
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL,
                            'P',
                            OrePrefixes.plateDouble.get(Materials.Chrome),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getCircuit(),
                            'W',
                            GT_CustomLoader.AdvancedGTMaterials.LuV.getCable4(),
        ...
        CustomItemList.ArcFurnaceUV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL,
                            'P',
                            OrePrefixes.plateDouble.get(Materials.Osmium),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UV.getCircuit(),
                            'W',
                            GT_CustomLoader.AdvancedGTMaterials.UV.getCable4(),
        ...
        CustomItemList.ArcFurnaceUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL,
                            'P',
                            OrePrefixes.plateTriple.get(Materials.Osmium),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getCircuit(),
                            'W',
                            GT_CustomLoader.AdvancedGTMaterials.UHV.getCable4(),
        ...
        CustomItemList.ArcFurnaceUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            CustomItemList.Hull_UEV,
                            'P',
                            OrePrefixes.plateQuadruple.get(Materials.Osmium),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getCircuit(),
                            'W',
                            GT_CustomLoader.AdvancedGTMaterials.UEV.getCable4(),
        ...
        CustomItemList.ArcFurnaceUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            CustomItemList.Hull_UIV,
                            'P',
                            OrePrefixes.plateDouble.get(Materials.Osmiridium),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCircuit(),
                            'W',
                            GT_CustomLoader.AdvancedGTMaterials.UIV.getCable4(),
        ...
        CustomItemList.ArcFurnaceUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
                        ...
                        new Object[] {
                            ...
                            CustomItemList.Hull_UMV,
                            'P',
                            OrePrefixes.plateQuadruple.get(Materials.Osmiridium),
                            'C',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCircuit(),
                            'W',
                            GT_CustomLoader.AdvancedGTMaterials.UMV.getCable4(),
        ...
        CustomItemList.AcceleratorLV.set(new GT_MetaTileEntity_WorldAccelerator(
                        11100, "basicmachine.accelerator.tier.01", "Basic World Accelerator", 1)
                .getStackForm(1L));
        CustomItemList.AcceleratorMV.set(new GT_MetaTileEntity_WorldAccelerator(
                        11101, "basicmachine.accelerator.tier.02", "Advanced World Accelerator", 2)
                .getStackForm(1L));
        CustomItemList.AcceleratorHV.set(new GT_MetaTileEntity_WorldAccelerator(
                        11102, "basicmachine.accelerator.tier.03", "Advanced World Accelerator II", 3)
                .getStackForm(1L));
        CustomItemList.AcceleratorEV.set(new GT_MetaTileEntity_WorldAccelerator(
                        11103, "basicmachine.accelerator.tier.04", "Advanced World Accelerator III", 4)
                .getStackForm(1L));
        CustomItemList.AcceleratorIV.set(new GT_MetaTileEntity_WorldAccelerator(
                        11104, "basicmachine.accelerator.tier.05", "Advanced World Accelerator IV", 5)
                .getStackForm(1L));
        CustomItemList.AcceleratorLuV.set(new GT_MetaTileEntity_WorldAccelerator(
                        11105, "basicmachine.accelerator.tier.06", "Elite World Accelerator", 6)
                .getStackForm(1L));
        CustomItemList.AcceleratorZPM.set(new GT_MetaTileEntity_WorldAccelerator(
                        11106, "basicmachine.accelerator.tier.07", "Elite World Accelerator II", 7)
                .getStackForm(1L));
        CustomItemList.AcceleratorUV.set(new GT_MetaTileEntity_WorldAccelerator(
                        11107, "basicmachine.accelerator.tier.08", "Ultimate Time Anomaly", 8)
                .getStackForm(1L));
        // Not adding either...

        GT_ModHandler.addCraftingRecipe(CustomItemList.AcceleratorLV.get(1L), bitsd, new Object[] {
            "RMR",
            "PBC",
            "IMI",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.AcceleratorMV.get(1L), bitsd, new Object[] {
            "RMR",
            "PBC",
            "IMI",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.AcceleratorHV.get(1L), bitsd, new Object[] {
            "RMR",
            "PBC",
            "IMI",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.AcceleratorEV.get(1L), bitsd, new Object[] {
            "RMR",
            "PBC",
            "IMI",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.AcceleratorIV.get(1L), bitsd, new Object[] {
            "RMR",
            "PBC",
            "IMI",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.AcceleratorLuV.get(1L), bitsd, new Object[] {
            "RMR",
            "PBC",
            "IMI",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.AcceleratorZPM.get(1L), bitsd, new Object[] {
            "RMR",
            "PBC",
            "IMI",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.AcceleratorUV.get(1L), bitsd, new Object[] {
            "RMR",
            "PBC",
            "IMI",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.BreweryLuV.get(1L), bitsd, new Object[] {
            "GPG",
            "WBW",
            "CZC",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.BreweryZPM.get(1L), bitsd, new Object[] {
            "GPG",
            "WBW",
            "CZC",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.BreweryUV.get(1L), bitsd, new Object[] {
            "GPG",
            "WBW",
            "CZC",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.BreweryUHV.get(1L), bitsd, new Object[] {
            "GPG",
            "WBW",
            "CZC",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.BreweryUEV.get(1L), bitsd, new Object[] {
            "GPG",
            "WBW",
            "CZC",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.BreweryUIV.get(1L), bitsd, new Object[] {
            "GPG",
            "WBW",
            "CZC",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.BreweryUMV.get(1L), bitsd, new Object[] {
            "GPG",
            "WBW",
            "CZC",
            'W',
    ...
    private void registerMachines2() {
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ChemicalReactorLuV.get(1L), bitsd, new Object[] {
            "PRP",
            "WMW",
            "CHC",
            'H',
            ...
            OrePrefixes.rotor.get(Materials.Chrome),
            'P',
            OrePrefixes.pipeMedium.get(Materials.PolyvinylChloride),
            'M',
            ItemList.Electric_Motor_LuV,
            'C',
            OrePrefixes.circuit.get(Materials.Master),
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ChemicalReactorZPM.get(1L), bitsd, new Object[] {
            "PRP",
            "WMW",
            "CHC",
            'H',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ChemicalReactorUV.get(1L), bitsd, new Object[] {
            "PRP",
            "WMW",
            "CHC",
            'H',
            ...
            OrePrefixes.rotor.get(Materials.Osmium),
            'P',
            OrePrefixes.pipeHuge.get(Materials.PolyvinylChloride),
            'M',
            ItemList.Electric_Motor_UV,
            'C',
            OrePrefixes.circuit.get(Materials.Superconductor),
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ChemicalReactorUHV.get(1L), bitsd, new Object[] {
            "PRP",
            "WMW",
            "CHC",
            'H',
            ItemList.Hull_MAX,
            'R',
            OrePrefixes.rotor.get(Materials.Osmiridium),
            'P',
            OrePrefixes.pipeHuge.get(Materials.PolyvinylChloride),
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ChemicalReactorUEV.get(1L), bitsd, new Object[] {
            "PRP",
            "WMW",
            "CHC",
            'H',
            CustomItemList.Hull_UEV,
            'R',
            OrePrefixes.rotor.get(Materials.InfinityCatalyst),
            'P',
            OrePrefixes.pipeHuge.get(Materials.PolyvinylChloride),
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ChemicalReactorUIV.get(1L), bitsd, new Object[] {
            "PRP",
            "WMW",
            "CHC",
            'H',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.ChemicalReactorUMV.get(1L), bitsd, new Object[] {
            "PRP",
            "WMW",
            "CHC",
            'H',
            CustomItemList.Hull_UMV,
            'R',
            OrePrefixes.rotor.get(Materials.TranscendentMetal),
            'P',
            OrePrefixes.pipeLarge.get(Materials.Polybenzimidazole),
            'M',
        ...
        CustomItemList.DisassemblerZPM.set(new GT_MetaTileEntity_Disassembler(
                        11161, "basicmachine.disassembler.tier.07", "Elite Disassembler II", 7)
                .getStackForm(1L));
        CustomItemList.DisassemblerUV.set(new GT_MetaTileEntity_Disassembler(
                        11162, "basicmachine.disassembler.tier.08", "Ultimate Deconstructor", 8)
                .getStackForm(1L));
        ...
        CustomItemList.DisassemblerUEV.set(new GT_MetaTileEntity_Disassembler(
                        11164, "basicmachine.disassembler.tier.10", "Epic Deconstructor II", 10)
                .getStackForm(1L));
        CustomItemList.DisassemblerUIV.set(new GT_MetaTileEntity_Disassembler(
                        11165, "basicmachine.disassembler.tier.11", "Epic Deconstructor III", 11)
                .getStackForm(1L));
        CustomItemList.DisassemblerUMV.set(new GT_MetaTileEntity_Disassembler(
                        11166, "basicmachine.disassembler.tier.12", "Epic Deconstructor IV", 12)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.DisassemblerLuV.get(1L), bitsd, new Object[] {
            "RCR",
            "WHW",
            "RCR",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.DisassemblerZPM.get(1L), bitsd, new Object[] {
            "RCR",
            "WHW",
            "RCR",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.DisassemblerUV.get(1L), bitsd, new Object[] {
            "RCR",
            "WHW",
            "RCR",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.DisassemblerUHV.get(1L), bitsd, new Object[] {
            "RCR",
            "WHW",
            "RCR",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.DisassemblerUEV.get(1L), bitsd, new Object[] {
            "RCR",
            "WHW",
            "RCR",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.DisassemblerUIV.get(1L), bitsd, new Object[] {
            "RCR",
            "WHW",
            "RCR",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.DisassemblerUMV.get(1L), bitsd, new Object[] {
            "RCR",
            "WHW",
            "RCR",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FermenterLuV.get(1L), bitsd, new Object[] {
            "WPW",
            "GBG",
            "WCW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FermenterZPM.get(1L), bitsd, new Object[] {
            "WPW",
            "GBG",
            "WCW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FermenterUV.get(1L), bitsd, new Object[] {
            "WPW",
            "GBG",
            "WCW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FermenterUHV.get(1L), bitsd, new Object[] {
            "WPW",
            "GBG",
            "WCW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FermenterUEV.get(1L), bitsd, new Object[] {
            "WPW",
            "GBG",
            "WCW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FermenterUIV.get(1L), bitsd, new Object[] {
            "WPW",
            "GBG",
            "WCW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FermenterUMV.get(1L), bitsd, new Object[] {
            "WPW",
            "GBG",
            "WCW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidCannerLuV.get(1L), bitsd, new Object[] {
            "GCG",
            "GBG",
            "WPW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidCannerZPM.get(1L), bitsd, new Object[] {
            "GCG",
            "GBG",
            "WPW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidCannerUV.get(1L), bitsd, new Object[] {
            "GCG",
            "GBG",
            "WPW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidCannerUHV.get(1L), bitsd, new Object[] {
            "GCG",
            "GBG",
            "WPW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidCannerUEV.get(1L), bitsd, new Object[] {
            "GCG",
            "GBG",
            "WPW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidCannerUIV.get(1L), bitsd, new Object[] {
            "GCG",
            "GBG",
            "WPW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidCannerUMV.get(1L), bitsd, new Object[] {
            "GCG",
            "GBG",
            "WPW",
            'W',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidExtractorLuV.get(1L), bitsd, new Object[] {
            "GEG",
            "WPW",
            "CMC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidExtractorZPM.get(1L), bitsd, new Object[] {
            "GEG",
            "WPW",
            "CMC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidExtractorUV.get(1L), bitsd, new Object[] {
            "GEG",
            "WPW",
            "CMC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidExtractorUHV.get(1L), bitsd, new Object[] {
            "GEG",
            "WPW",
            "CMC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidExtractorUEV.get(1L), bitsd, new Object[] {
            "GEG",
            "WPW",
            "CMC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidExtractorUIV.get(1L), bitsd, new Object[] {
            "GEG",
            "WPW",
            "CMC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidExtractorUMV.get(1L), bitsd, new Object[] {
            "GEG",
            "WPW",
            "CMC",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidHeaterLuV.get(1L), bitsd, new Object[] {
            "WGW",
            "PMP",
            "RCR",
            'M',
            ...
            OrePrefixes.circuit.get(Materials.Master),
            'W',
            OrePrefixes.wireGt04.get(Materials.NiobiumTitanium),
            'R',
            OrePrefixes.cableGt01.get(Materials.VanadiumGallium),
            'G',
            GT_CustomLoader.AdvancedGTMaterials.LuV.getGlass()
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidHeaterZPM.get(1L), bitsd, new Object[] {
            "WGW",
            "PMP",
            "WCW",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidHeaterUV.get(1L), bitsd, new Object[] {
            "WGW",
            "PMP",
            "WCW",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidHeaterUHV.get(1L), bitsd, new Object[] {
            "WGW",
            "PMP",
            "WCW",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidHeaterUEV.get(1L), bitsd, new Object[] {
            "WGW",
            "PMP",
            "WCW",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidHeaterUIV.get(1L), bitsd, new Object[] {
            "WGW",
            "PMP",
            "WCW",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.FluidHeaterUMV.get(1L), bitsd, new Object[] {
            "WGW",
            "PMP",
            "WCW",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MixerLuV.get(1L), bitsd, new Object[] {
            "GRG",
            "GMG",
            "CBC",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MixerZPM.get(1L), bitsd, new Object[] {
            "GRG",
            "GMG",
            "CBC",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MixerUV.get(1L), bitsd, new Object[] {
            "GRG",
            "GMG",
            "CBC",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MixerUHV.get(1L), bitsd, new Object[] {
            "GRG",
            "GMG",
            "CBC",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MixerUEV.get(1L), bitsd, new Object[] {
            "GRG",
            "GMG",
            "CBC",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MixerUIV.get(1L), bitsd, new Object[] {
            "GRG",
            "GMG",
            "CBC",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.MixerUMV.get(1L), bitsd, new Object[] {
            "GRG",
            "GMG",
            "CBC",
            'R',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Transformer_UEV_UHV.get(1L), bitsd, new Object[] {
            "KBB",
            "CM ",
            "KBB",
            'M',
            ItemList.Hull_MAX,
            'C',
            OrePrefixes.wireGt01.get(Materials.Draconium),
            'B',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Transformer_UIV_UEV.get(1L), bitsd, new Object[] {
            "KBB",
            "CM ",
            "KBB",
            'M',
            CustomItemList.Hull_UEV,
            'C',
            OrePrefixes.wireGt01.get(Materials.NetherStar),
            'B',
            OrePrefixes.wireGt04.get(Materials.Draconium),
            'K',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Transformer_UMV_UIV.get(1L), bitsd, new Object[] {
            "KBB",
            "CM ",
            "KBB",
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Transformer_UXV_UMV.get(1L), bitsd, new Object[] {
            "KBB",
            "CM ",
            "KBB",
            'M',
        ...
        CustomItemList.Battery_Buffer_4by4_UEV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11240, "batterybuffer.16.tier.10", "Extremely Ultimate Battery Buffer", 10, "", 16)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_4by4_UEV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UEV,
        ...
        CustomItemList.Battery_Buffer_4by4_UIV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11241, "batterybuffer.16.tier.11", "Insanely Ultimate Battery Buffer", 11, "", 16)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_4by4_UIV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UIV,
            'W',
            OrePrefixes.wireGt16.get(Materials.NetherStar),
            'T',
            OreDictNames.craftingChest
        });

        CustomItemList.Battery_Buffer_4by4_UMV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11242, "batterybuffer.16.tier.12", "Mega Ultimate Battery Buffer", 12, "", 16)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_4by4_UMV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UMV,
        ...
        CustomItemList.Battery_Buffer_4by4_UXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11243, "batterybuffer.16.tier.13", "Extended Mega Ultimate Battery Buffer", 13, "", 16)
                .getStackForm(1L));

        CustomItemList.Battery_Buffer_4by4_MAXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11245, "batterybuffer.16.tier.14", "Maximum Battery Buffer", 14, "", 16)
                .getStackForm(1L));
        ...
        CustomItemList.Battery_Buffer_3by3_UEV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11250, "batterybuffer.09.tier.10", "Extremely Ultimate Battery Buffer", 10, "", 9)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_3by3_UEV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UEV,
            'W',
            OrePrefixes.wireGt08.get(Materials.Draconium),
            'T',
            OreDictNames.craftingChest
        });

        CustomItemList.Battery_Buffer_3by3_UIV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11251, "batterybuffer.09.tier.11", "Insanely Ultimate Battery Buffer", 11, "", 9)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_3by3_UIV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UIV,
            'W',
            OrePrefixes.wireGt08.get(Materials.NetherStar),
            'T',
            OreDictNames.craftingChest
        });

        CustomItemList.Battery_Buffer_3by3_UMV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11252, "batterybuffer.09.tier.12", "Mega Ultimate Battery Buffer", 12, "", 9)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_3by3_UMV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UMV,
            'W',
            OrePrefixes.wireGt08.get(Materials.Quantium),
            'T',
            OreDictNames.craftingChest
        });

        CustomItemList.Battery_Buffer_3by3_UXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11253, "batterybuffer.09.tier.13", "Extended Mega Ultimate Battery Buffer", 13, "", 9)
                .getStackForm(1L));

        CustomItemList.Battery_Buffer_3by3_MAXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11255, "batterybuffer.09.tier.14", "Maximum Battery Buffer", 14, "", 9)
                .getStackForm(1L));
        ...
        CustomItemList.Battery_Buffer_2by2_UEV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11260, "batterybuffer.04.tier.10", "Extremely Ultimate Battery Buffer", 10, "", 4)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_2by2_UEV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UEV,
        ...
        CustomItemList.Battery_Buffer_2by2_UIV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11261, "batterybuffer.04.tier.11", "Insanely Ultimate Battery Buffer", 11, "", 4)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_2by2_UIV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UIV,
        ...
        CustomItemList.Battery_Buffer_2by2_UMV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11262, "batterybuffer.04.tier.12", "Mega Ultimate Battery Buffer", 12, "", 4)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_2by2_UMV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UMV,
        ...
        CustomItemList.Battery_Buffer_2by2_UXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11263, "batterybuffer.04.tier.13", "Extended Mega Ultimate Battery Buffer", 13, "", 4)
                .getStackForm(1L));

        CustomItemList.Battery_Buffer_2by2_MAXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11265, "batterybuffer.04.tier.14", "Maximum Battery Buffer", 14, "", 4)
                .getStackForm(1L));
        ...
        CustomItemList.Battery_Buffer_1by1_UEV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11270, "batterybuffer.01.tier.10", "Extremely Ultimate Battery Buffer", 10, "", 1)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_1by1_UEV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UEV,
        ...
        CustomItemList.Battery_Buffer_1by1_UIV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11271, "batterybuffer.01.tier.11", "Insanely Ultimate Battery Buffer", 11, "", 1)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_1by1_UIV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UIV,
        ...
        CustomItemList.Battery_Buffer_1by1_UMV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11272, "batterybuffer.01.tier.12", "Mega Ultimate Battery Buffer", 12, "", 1)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_Buffer_1by1_UMV.get(1L), bitsd, new Object[] {
            "WTW",
            "WMW",
            'M',
            CustomItemList.Hull_UMV,
        ...
        CustomItemList.Battery_Buffer_1by1_UXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11273, "batterybuffer.01.tier.13", "Extended Mega Ultimate Battery Buffer", 13, "", 1)
                .getStackForm(1L));

        CustomItemList.Battery_Buffer_1by1_MAXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
                        11275, "batterybuffer.01.tier.14", "Maximum Battery Buffer", 14, "", 1)
                .getStackForm(1L));
        ...
        CustomItemList.Battery_Charger_4by4_UEV.set(new GT_MetaTileEntity_Charger(
                        11280, "batterycharger.16.tier.10", "Extremely Ultimate Battery Charger", 10, "", 4)
                .getStackForm(1L));

        CustomItemList.Battery_Charger_4by4_UIV.set(new GT_MetaTileEntity_Charger(
                        11281, "batterycharger.16.tier.11", "Insanely Ultimate Battery Charger", 11, "", 4)
                .getStackForm(1L));

        CustomItemList.Battery_Charger_4by4_UMV.set(new GT_MetaTileEntity_Charger(
                        11282, "batterycharger.16.tier.12", "Mega Ultimate Battery Charger", 12, "", 4)
                .getStackForm(1L));
        ...
        if (Loader.isModLoaded("miscutils")) {
            ...
            GT_ModHandler.addCraftingRecipe(CustomItemList.Transformer_HA_UEV_UHV.get(1L), bitsd, new Object[] {
                "KBB",
                "CM ",
                "KBB",
                Character.valueOf('M'),
            ...
            GT_ModHandler.addCraftingRecipe(CustomItemList.Transformer_HA_UIV_UEV.get(1L), bitsd, new Object[] {
                "KBB",
                "CM ",
                "KBB",
                Character.valueOf('M'),
            ...
            GT_ModHandler.addCraftingRecipe(CustomItemList.Transformer_HA_UMV_UIV.get(1L), bitsd, new Object[] {
                "KBB",
                "CMK",
                "KBB",
                Character.valueOf('M'),
            ...
            GT_ModHandler.addCraftingRecipe(CustomItemList.Transformer_HA_UXV_UMV.get(1L), bitsd, new Object[] {
                "KBB",
                "CMK",
                "KBB",
                Character.valueOf('M'),
            ...
            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_LV_ULV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.Lead),
                'C',
                OrePrefixes.cableGt16.get(Materials.Lead),
                'S',
                OrePrefixes.spring.get(Materials.Tin),
                'X',
                OrePrefixes.cableGt08.get(Materials.Tin),
                'O',
                OrePrefixes.cell.get(Materials.Lubricant),
                'P',
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 877)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_MV_LV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.Tin),
                'C',
                OrePrefixes.cableGt16.get(Materials.Tin),
                'S',
                ...
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 878)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_HV_MV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.AnyCopper),
                'C',
                OrePrefixes.cableGt16.get(Materials.AnyCopper),
                'S',
                OrePrefixes.spring.get(Materials.Gold),
                'X',
                OrePrefixes.cableGt08.get(Materials.Gold),
                'O',
                OrePrefixes.cell.get(Materials.Lubricant),
                'P',
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 879)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_EV_HV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.Gold),
                'C',
                OrePrefixes.cableGt16.get(Materials.Gold),
                'S',
                OrePrefixes.spring.get(Materials.Aluminium),
                'X',
                OrePrefixes.cableGt08.get(Materials.Aluminium),
                'O',
                OrePrefixes.cell.get(Materials.Lubricant),
                'P',
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 880)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_IV_EV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.Aluminium),
                'C',
                OrePrefixes.cableGt16.get(Materials.Aluminium),
                'S',
                OrePrefixes.spring.get(Materials.Tungsten),
                'X',
                OrePrefixes.cableGt08.get(Materials.Tungsten),
                'O',
                OrePrefixes.cell.get(Materials.Lubricant),
                'P',
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 881)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_LuV_IV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.Tungsten),
                'C',
                OrePrefixes.cableGt16.get(Materials.Tungsten),
                'S',
                OrePrefixes.spring.get(Materials.VanadiumGallium),
                'X',
                OrePrefixes.cableGt08.get(Materials.VanadiumGallium),
                'O',
                OrePrefixes.cell.get(Materials.Lubricant),
                'P',
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 882)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_ZPM_LuV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.VanadiumGallium),
                'C',
                OrePrefixes.cableGt16.get(Materials.VanadiumGallium),
                'S',
                OrePrefixes.spring.get(Materials.Naquadah),
                'X',
                OrePrefixes.cableGt08.get(Materials.Naquadah),
                'O',
                OrePrefixes.cell.get(Materials.Lubricant),
                'P',
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 883)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_UV_ZPM.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.Naquadah),
                'C',
                OrePrefixes.cableGt16.get(Materials.Naquadah),
                'S',
                OrePrefixes.spring.get(Materials.NaquadahAlloy),
                'X',
                OrePrefixes.cableGt08.get(Materials.NaquadahAlloy),
                'O',
                OrePrefixes.cell.get(Materials.Lubricant),
                'P',
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 884)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_UHV_UV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.NaquadahAlloy),
                'C',
                OrePrefixes.cableGt16.get(Materials.NaquadahAlloy),
                'S',
                OrePrefixes.spring.get(Materials.Neutronium),
                'X',
                ...
                ItemList.Electric_Pump_LV,
                'T',
                GT_ModHandler.getModItem("gregtech", "gt.blockmachines", 1, 885)
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_UEV_UHV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
            ...
            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_UIV_UEV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.Draconium),
                'C',
                OrePrefixes.wireGt16.get(Materials.Draconium),
                'S',
                OrePrefixes.spring.get(Materials.BlackPlutonium),
                'X',
                OrePrefixes.wireGt08.get(Materials.NetherStar),
                'O',
                ...
                ItemList.Electric_Pump_HV,
                'T',
                CustomItemList.Transformer_HA_UIV_UEV
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_UMV_UIV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.BlackPlutonium),
                'C',
                OrePrefixes.wireGt16.get(Materials.NetherStar),
                'S',
                OrePrefixes.spring.get(Materials.Quantium),
                'X',
                OrePrefixes.wireGt08.get(Materials.Quantium),
                'O',
                ...
                ItemList.Electric_Pump_IV,
                'T',
                CustomItemList.Transformer_HA_UMV_UIV
            });

            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_UXV_UMV.get(1L), bitsd, new Object[] {
                "XOC",
                "STA",
                "POC",
                'A',
                OrePrefixes.springSmall.get(Materials.SpaceTime),
                'C',
                OrePrefixes.wireGt16.get(Materials.Quantium),
                'S',
                OrePrefixes.spring.get(Materials.Infinity),
                'X',
                OrePrefixes.wireGt08.get(Materials.BlackPlutonium),
                'O',
                ItemList.Reactor_Coolant_Sp_1,
                'P',
                ItemList.Electric_Pump_LuV,
                'T',
                CustomItemList.Transformer_HA_UXV_UMV
            });
        } else {
            GT_ModHandler.addCraftingRecipe(CustomItemList.WetTransformer_LV_ULV.get(1L), bitsd, new Object[] {
                "XOC",
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_ULV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            CustomItemList.WetTransformer_LV_ULV,
            'M',
            ItemList.Battery_Charger_4by4_ULV,
            'B',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_LV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            CustomItemList.WetTransformer_MV_LV,
            'M',
            ItemList.Battery_Charger_4by4_LV,
            'B',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_MV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            CustomItemList.WetTransformer_HV_MV,
            'M',
            ItemList.Battery_Charger_4by4_MV,
            'B',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_HV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            CustomItemList.WetTransformer_EV_HV,
            'M',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_EV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            CustomItemList.WetTransformer_IV_EV,
            'M',
            ItemList.Battery_Charger_4by4_EV,
            'B',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_IV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            ...
            'M',
            ItemList.Battery_Charger_4by4_IV,
            'B',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_LuV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            ...
            'M',
            ItemList.Battery_Charger_4by4_LuV,
            'B',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_ZPM.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            CustomItemList.WetTransformer_UV_ZPM,
            'M',
            ItemList.Battery_Charger_4by4_ZPM,
            'B',
            ItemList.Energy_LapotronicOrb2,
            'C',
            OrePrefixes.cableGt16.get(Materials.Naquadah),
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_UV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            ...
            'M',
            ItemList.Battery_Charger_4by4_UV,
            'B',
            ItemList.ZPM2,
            'C',
            OrePrefixes.cableGt16.get(Materials.NaquadahAlloy),
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Battery_TurboCharger_4by4_UHV.get(1L), bitsd, new Object[] {
            "BTB",
            "CMC",
            "BXB",
            'T',
            CustomItemList.WetTransformer_UEV_UHV,
            'M',
            ItemList.Battery_Charger_4by4_MAX,
            'B',
            ItemList.ZPM2,
            'C',
            OrePrefixes.wireGt16.get(Materials.SuperconductorUHV), // DONT COPY THIS it has superconductor: cable->wire
            'X',
            OrePrefixes.circuit.get(Materials.Infinite)
        });

        // CustomItemList.Battery_TurboCharger_4by4_UEV.set(new GT_MetaTileEntity_TurboCharger(
        //		12050, "batteryturbocharger.16.tier.10", "Extremely Ultimate Turbo Charger",10,"64A in /16A out",
        // 4).getStackForm(1L));

        // CustomItemList.Battery_TurboCharger_4by4_UIV.set(new GT_MetaTileEntity_TurboCharger(
        //		12051, "batteryturbocharger.16.tier.11", "Insanely Ultimate Turbo Charger",11,"64A in /16A out",
        // 4).getStackForm(1L));

        // CustomItemList.Battery_TurboCharger_4by4_UMV.set(new GT_MetaTileEntity_TurboCharger(
        //		12052, "batteryturbocharger.16.tier.12", "Mega Ultimate Turbo Charger",12,"64A in /16A out",
        // 4).getStackForm(1L));

        // CustomItemList.Battery_TurboCharger_4by4_UXV.set(new GT_MetaTileEntity_TurboCharger(
        //		12053, "batteryturbocharger.16.tier.13", "Extended Mega Ultimate Turbo Charger",13,"64A in /16A out",
        // 4).getStackForm(1L));

        // CustomItemList.Battery_TurboCharger_4by4_MAXV.set(new GT_MetaTileEntity_TurboCharger(
        //		12055, "batteryturbocharger.16.tier.14", "Maximum Turbo Charger",14,"64A in /16A out", 4).getStackForm(1L));
        ...
        CustomItemList.Automation_ChestBuffer_UEV.set(new GT_MetaTileEntity_ChestBuffer(
                        12060, "automation.chestbuffer.tier.10", "Ultra High Voltage Chest Buffer", 10)
                .getStackForm(1L));

        CustomItemList.Automation_ChestBuffer_UIV.set(new GT_MetaTileEntity_ChestBuffer(
                        12061, "automation.chestbuffer.tier.11", "UIV Voltage Chest Buffer", 11)
                .getStackForm(1L));

        CustomItemList.Automation_ChestBuffer_UMV.set(new GT_MetaTileEntity_ChestBuffer(
                        12062, "automation.chestbuffer.tier.12", "UMV Voltage Chest Buffer", 12)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.Automation_ChestBuffer_UEV.get(1L), bitsd, new Object[] {
            "CMV",
            " X ",
            'M',
            CustomItemList.Hull_UEV,
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.Automation_ChestBuffer_UIV.get(1L), bitsd, new Object[] {
            "CMV",
            " X ",
            'M',
            CustomItemList.Hull_UIV,
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.nameRemover.get(1L), bitsd, new Object[] {
            "SsS",
            "VMV",
            "SXS",
            'M',
            ItemList.Hull_ULV,
            'V',
            OrePrefixes.gearGtSmall.get(Materials.AnyBronze),
            'S',
        ...
        CustomItemList.RockBreakerUEV.set(new GT_MetaTileEntity_RockBreaker(
                        12084, "rockbreaker.tier.10", "Cryogenic Magma Solidifier R-13200", 10)
                .getStackForm(1L));

        CustomItemList.RockBreakerUIV.set(new GT_MetaTileEntity_RockBreaker(
                        12085, "rockbreaker.tier.11", "Cryogenic Magma Solidifier R-14200", 11)
                .getStackForm(1L));

        CustomItemList.RockBreakerUMV.set(new GT_MetaTileEntity_RockBreaker(
                        12086, "rockbreaker.tier.12", "Cryogenic Magma Solidifier R-15200", 12)
                .getStackForm(1L));

        GT_ModHandler.addCraftingRecipe(CustomItemList.RockBreakerLuV.get(1L), bitsd, new Object[] {
            "PED",
            "WMW",
            "GGG",
            'P',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.RockBreakerZPM.get(1L), bitsd, new Object[] {
            "PED",
            "WMW",
            "GGG",
            'P',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.RockBreakerUV.get(1L), bitsd, new Object[] {
            "PED",
            "WMW",
            "GGG",
            'P',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.RockBreakerUHV.get(1L), bitsd, new Object[] {
            "PED",
            "WMW",
            "GGG",
            'P',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.RockBreakerUEV.get(1L), bitsd, new Object[] {
            "PED",
            "WMW",
            "GGG",
            'P',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.RockBreakerUIV.get(1L), bitsd, new Object[] {
            "PED",
            "WMW",
            "GGG",
            'P',
        ...
        GT_ModHandler.addCraftingRecipe(CustomItemList.RockBreakerUMV.get(1L), bitsd, new Object[] {
            "PED",
            "WMW",
            "GGG",
            'P',
        ...
        for (int aTier = 10; aTier < 15; aTier++) {
            GT_Values.RA.addAssemblerRecipe(
                    flInputs[aTier - 10],
                    GT_CoreModSupport.RadoxPolymer.getMolten((long) (2.25 * Math.pow(2, (aTier - 9)))),
                    inHatches[aTier - 10],
                    480,
