...
// ===================================================================================================
		...
		CustomItemList.AutoclaveLuV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
				...
				GT_Recipe.GT_Recipe_Map.sAutoclaveRecipes, 2, 4, 8000, 0, 1, "Autoclave4.png",
...
// CONTINUE HERE 18.10.2015 00:22
		...
		*/
		...
		CustomItemList.Battery_Buffer_4by4_MAXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
				11245, "batterybuffer.16.tier.14", "Maximum Battery Buffer",14,"", 16).getStackForm(1L));
		...
		CustomItemList.Battery_Buffer_3by3_MAXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
				11255, "batterybuffer.09.tier.14", "Maximum Battery Buffer",14,"", 9).getStackForm(1L));
		...
		CustomItemList.Battery_Buffer_2by2_MAXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
				11265, "batterybuffer.04.tier.14", "Maximum Battery Buffer",14,"", 4).getStackForm(1L));
		...
		CustomItemList.Battery_Buffer_1by1_MAXV.set(new GT_MetaTileEntity_BasicBatteryBuffer(
				11275, "batterybuffer.01.tier.14", "Maximum Battery Buffer",14,"", 1).getStackForm(1L));
...
//						}
				...
				CustomItemList.CircuitAssemblerMAX.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(
						12096, "basicmachine.circuitassembler.tier.14", "MAX Circuit Assembling Machine", 14, "Avengers, Assemble!",
						GT_Recipe.GT_Recipe_Map.sCircuitAssemblerRecipes, 6, 1, 16000, 0, 1, "CircuitAssembler.png",
						"", false, false, 0, "CIRCUITASSEMBLER",
				null
//						new Object[] {
...
//						}
		...
		CustomItemList.Hatch_Input_MAX.set(new GT_MetaTileEntity_Hatch_Input(12102, "hatch.input.tier.14", "Input Hatch (MAX)",14).getStackForm(1L));
		...
		CustomItemList.Hatch_Output_MAX.set(new GT_MetaTileEntity_Hatch_Output(12108, "hatch.output.tier.14", "Output Hatch (MAX)",14).getStackForm(1L));
