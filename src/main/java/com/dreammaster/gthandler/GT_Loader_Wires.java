...
public class GT_Loader_Wires {
    ...
    private void registerWires() {
        ...
        makeWires(Materials.ElectrumFlux, 1900, 3L, 2L, 8L, GTValues.V[8], true, false);
        ...
        makeWires(Materials.Draconium, 11330, 32L, 96L, 12L, GTValues.V[10], true, false);
        makeWires(Materials.NetherStar, 11350, 64L, 160L, 4L, GTValues.V[11], true, false);
        ...
        makeWires(Materials.DraconiumAwakened, 11410, 64L, 64L, 24L, GTValues.V[14], false, false);
