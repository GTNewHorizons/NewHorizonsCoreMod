...
//        GT_Values.RA.addAssemblerRecipe(CustomItemList.HeavyDutyPlateTier7.get(1L), CustomItemList.BlackPlutoniumCompressedPlate.get(14L), Materials.Neutronium.getMolten(4608L), CustomItemList.HeavyDutyAlloyIngotT8.get(1L), 1200, 2000000);
    ...
    public void run3() {
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Naquadah, 16), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.HSSE, 16), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.YttriumBariumCuprate, 16), GT_Utility.getIntegratedCircuit(6)}, Materials.Polybenzimidazole.getMolten(576L), ItemList.Circuit_Parts_ResistorASMD.get(64L), 300, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.VibrantAlloy, 16), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.VanadiumGallium, 8), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.HSSG, 16), GT_Utility.getIntegratedCircuit(6)}, Materials.Polybenzimidazole.getMolten(576L), ItemList.Circuit_Parts_TransistorASMD.get(64L), 300, 1920);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSE, 16), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Enderium, 8), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.BlueSteel, 16), GT_Utility.getIntegratedCircuit(6)}, Materials.Polybenzimidazole.getMolten(576L), ItemList.Circuit_Parts_CapacitorASMD.get(64L), 300, 1920);

        if (Loader.isModLoaded("bartworks")) {
            GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IndiumGalliumPhosphide, 2), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iridium, 16), GT_ModHandler.getModItem("bartworks", "gt.bwMetaGeneratedwireFine", 64L, 88), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.VividAlloy, 16), GT_Utility.getIntegratedCircuit(6)}, Materials.Polybenzimidazole.getMolten(576L), ItemList.Circuit_Parts_DiodeASMD.get(64L), 300, 1920);
        }
