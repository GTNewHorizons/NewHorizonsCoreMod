...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addAssemblerRecipe(CustomItemList.EngineCore.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 10L), GT_ModHandler.getModItem(MOD_ID_FR, "engine", 1L, 4), 200, 16);
        GT_Values.RA.addAssemblerRecipe(CustomItemList.EngineCore.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 10L), GT_ModHandler.getModItem(MOD_ID_FR, "engine", 1L, 1), 200, 16);
        GT_Values.RA.addAssemblerRecipe(CustomItemList.EngineCore.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Bronze, 10L), GT_ModHandler.getModItem(MOD_ID_FR, "engine", 1L, 2), 200, 16);
        GT_Values.RA.addAssemblerRecipe(CustomItemList.EngineCore.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Invar, 10L), GT_ModHandler.getModItem(MOD_ID_BC_CORE, "engineBlock", 1L, 29), 200, 16);
