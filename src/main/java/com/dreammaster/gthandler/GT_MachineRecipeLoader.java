...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{CustomItemList.EngineCore.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 10L),  GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 1L), GT_Utility.getIntegratedCircuit(10)},  GT_Values.NF, GT_ModHandler.getModItem(MOD_ID_FR, "engine", 1L, 0), 200, 16);
