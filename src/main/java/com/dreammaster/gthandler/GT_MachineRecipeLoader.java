...
//        GT_Values.RA.addAssemblerRecipe(CustomItemList.HeavyDutyPlateTier7.get(1L), CustomItemList.BlackPlutoniumCompressedPlate.get(14L), Materials.Neutronium.getMolten(4608L), CustomItemList.HeavyDutyAlloyIngotT8.get(1L), 1200, 2000000);
        ...
        //NaAlO2 + CO2 = Al2O3 + Na2CO3
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SodiumAluminate, 4L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SodiumHydroxide, 3L), Materials.CarbonDioxide.getGas(1000L), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 5L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SodiumCarbonate, 6L), 50, 480, 1200);
        ...
        //6Al2O3 =Na3AlF6= 12Al
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 30L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Cryolite, 1L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Aluminium, 12L), GT_Values.NI, 2400, 120, 963);
