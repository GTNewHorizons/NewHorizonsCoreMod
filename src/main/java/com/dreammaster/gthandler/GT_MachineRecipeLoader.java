...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run2() {
        ...
        if (Loader.isModLoaded("Genetics")) GT_Values.RA.addChemicalRecipe(
                ...
                120,
                true);
        if (Loader.isModLoaded("gendustry")) GT_Values.RA.addChemicalRecipe(
                CustomItemList.TheBigEgg.get(1L),
        ...
        GT_Values.RA.addChemicalRecipe(
                ...
                480,
                true);
        if (Loader.isModLoaded("HardcoreEnderExpansion")) GT_Values.RA.addChemicalRecipe(
                CustomItemList.EnderEgg.get(1L),
                ...
                1024,
                true);
        if (Loader.isModLoaded("DraconicEvolution")) GT_Values.RA.addChemicalRecipe(
                CustomItemList.DraconiumEgg.get(1L),
                ...
                1920,
                true);
        if (Loader.isModLoaded("harvestcraft")) GT_Values.RA.addChemicalBathRecipe(
    ...
    public void run3() {
        ...
        // GT_Values.RA.addChemicalRecipe(ItemList.Circuit_Chip_Stemcell.get(4L),
        // GT_OreDictUnificator.get(OrePrefixes.dust, Materials.MysteriousCrystal, 1),
        // Materials.BioMediumRaw.getFluid(1000L), FluidRegistry.getFluidStack("mutagen", 250),
        // ItemList.Circuit_Chip_Biocell.get(1L), 1200, 500000);
