...
//        GT_Values.RA.addAssemblerRecipe(CustomItemList.HeavyDutyPlateTier7.get(1L), CustomItemList.BlackPlutoniumCompressedPlate.get(14L), Materials.Neutronium.getMolten(4608L), CustomItemList.HeavyDutyAlloyIngotT8.get(1L), 1200, 2000000);
    ...
    public void run3() {
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(21), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Gold, 4L), GT_ModHandler.getModItem("IC2", "reactorHeatSwitch", 1L, 0)}, Materials.StainlessSteel.getMolten(72), GT_ModHandler.getModItem("IC2", "reactorHeatSwitch", 1L, 1), 30, 480);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(21), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Lapis, 4L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Diamond, 1L), GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 2L), GT_ModHandler.getModItem("IC2", "reactorHeatSwitch", 2L, 1)}, GT_Values.NF, GT_ModHandler.getModItem("IC2", "reactorHeatSwitchDiamond", 1L, 1), 60, 480);
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(21), ItemList.IC2_Industrial_Diamond.get(1L), GT_ModHandler.getModItem("IC2", "reactorVent", 1L, 1), GT_OreDictUnificator.get(OrePrefixes.bars, Materials.StainlessSteel, 4L)}, GT_Values.NF, GT_ModHandler.getModItem("IC2", "reactorVentDiamond", 1L, 1), 300, 256);
