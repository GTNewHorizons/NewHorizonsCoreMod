    ...
    public void run() {
        ...
        if (MineAndBladeBattleGear2.isModLoaded()) {
            ...
            GTModHandler.removeRecipeByOutputDelayed(
                    ...
                    true);
            GTModHandler.removeRecipeByOutputDelayed(
                    getModItem(MineAndBladeBattleGear2.ID, "chain", 1, 0),
                    true,
                    false,
                    true);
        }
        ...
        if (NaturesCompass.isModLoaded()) {
            GTModHandler.removeRecipeByOutputDelayed(
                    getModItem(NaturesCompass.ID, "NaturesCompass", 1, 0),
                    true,
                    false,
                    true);
        }
        ...
        if (OpenSecurity.isModLoaded()) {
            ...
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(OpenSecurity.ID, "rfidreader", 1, 0), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(OpenSecurity.ID, "rfidwriter", 1, 0), true, false, true);
            GTModHandler.removeRecipeByOutputDelayed(getModItem(OpenSecurity.ID, "alarm", 1, 0), true, false, true);
            GTModHandler.removeRecipeByOutputDelayed(
                    getModItem(OpenSecurity.ID, "entitydetector", 1, 0),
                    true,
                    false,
                    true);
            GTModHandler.removeRecipeByOutputDelayed(
                    getModItem(OpenSecurity.ID, "doorcontroller", 1, 0),
                    true,
                    false,
                    true);
            GTModHandler.removeRecipeByOutputDelayed(
            ...
            GTModHandler.removeRecipeByOutputDelayed(
                    ...
                    true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(OpenSecurity.ID, "keypadLock", 1, 0), true, false, true);
            GTModHandler.removeRecipeByOutputDelayed(
                    getModItem(OpenSecurity.ID, "biometricScanner", 1, 0),
                    true,
                    false,
                    true);
            GTModHandler.removeRecipeByOutputDelayed(
        ...
        if (Railcraft.isModLoaded()) {
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 0), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 1), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 2), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 3), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 4), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 5), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 6), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 7), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 8), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 9), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 10), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 11), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 12), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 13), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 14), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineBeta, 1, 15), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineAlpha, 1, 0), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineAlpha, 1, 1), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineAlpha, 1, 2), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineAlpha, 1, 3), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineAlpha, 1, 5), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineAlpha, 1, 6), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineAlpha, 1, 8), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, aTextMachineAlpha, 1, 9), true, false, true);
            GTModHandler
            ...
            GTModHandler.removeRecipeByOutputDelayed(
                    ...
                    true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, "borehead.iron", 1, 0), true, false, true);
            GTModHandler
                    .removeRecipeByOutputDelayed(getModItem(Railcraft.ID, "borehead.steel", 1, 0), true, false, true);
            GTModHandler
