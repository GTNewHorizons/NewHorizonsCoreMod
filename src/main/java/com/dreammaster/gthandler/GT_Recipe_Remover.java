...
public class GT_Recipe_Remover implements Runnable {
    ...
    public static void removeRecipeShaped(Object aOutput) {
        if (aOutput instanceof String) {
            for (ItemStack stack : OreDictionary.getOres((String) aOutput)) {
                GT_ModHandler.removeRecipeByOutputDelayed(stack, true, true, false);
            }
        } else if (aOutput instanceof ItemStack) {
            GT_ModHandler.removeRecipeByOutputDelayed((ItemStack) aOutput, true, true, false);
    ...
    public static void removeRecipeByOutput(Object aOutput) {
        if (aOutput instanceof String) {
            for (ItemStack stack : OreDictionary.getOres((String) aOutput)) {
                GT_ModHandler.removeRecipeByOutputDelayed(stack, true, false, false);
            }
        } else if (aOutput instanceof ItemStack) {
            GT_ModHandler.removeRecipeByOutputDelayed((ItemStack) aOutput, true, false, false);
        } else throw new IllegalArgumentException("Invalid output");
    }
    ...
    public void run() {
        ...
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 32596, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 32618, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 32638, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 32648, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 32658, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 32688, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 32698, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 32678, missing));
        ...
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 3500, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 4500, missing));
        ...
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.blockmachines", 1, 1145, missing));
        ...
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 17084, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 3084, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 4084, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 12084, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 1084, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 13084, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 84, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 7084, missing));
        removeRecipeByOutputDelayed(getModItem("gregtech", "gt.metaitem.02", 1, 2084, missing));
        ...
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 8502, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 8503, missing));
        ...
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 8503, missing));
        removeRecipeShapelessDelayed(getModItem("minecraft", "dye", 1, 4, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 2530, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 8530, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 2500, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 8503, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 2881, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 2506, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 2084, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 2836, missing));
        ...
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 2526, missing));
        removeRecipeShapelessDelayed(getModItem("gregtech", "gt.metaitem.01", 1, 2501, missing));
        removeRecipeShapelessDelayed(
