...
import static com.dreammaster.MissingModIDs.BloodMagic;
import static com.dreammaster.MissingModIDs.Botania;
import static com.dreammaster.MissingModIDs.BuildCraftCore;
...
import static com.dreammaster.MissingModIDs.NEIOrePlugin;
import static com.dreammaster.MissingModIDs.NaturesCompass;
import static com.dreammaster.MissingModIDs.OpenBlocks;
import static com.dreammaster.MissingModIDs.OpenGlasses;
import static com.dreammaster.MissingModIDs.OpenModularTurrets;
...
import static gregtech.api.enums.ModIDs.IronTanks;
...
public class AssemblerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockAlloyGlass", 1L, 0),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemCellEmpty", 1L, 0),
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                60);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemCellEmpty", 3L, 0),
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                120);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemCellEmpty", 6L, 0),
        ...
        GT_Values.RA.addFormingPressRecipe(
                ...
                120);
        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorRubBoots", 1L, 0),
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorNanoBoots", 1L, GT_Values.W),
                CustomItemList.NanoRubberBoots.get(1L),
                800,
                1024);

        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorNanoLegs", 1L, GT_Values.W),
                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.StainlessSteel, 4L),
                CustomItemList.NanoPlatedLeggings.get(1L),
                800,
                1024);
        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorNanoHelmet", 1L, GT_Values.W),
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorHazmatHelmet", 1L, 0),
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                1920);
        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem(GraviSuite.modID, "advNanoChestPlate", 1L, GT_Values.W),
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_ModHandler.getModItem(TwilightForest.modID, "item.nagaScale", 1L, 0),
                200,
                96);
        GT_Values.RA.addAssemblerRecipe(
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                256);
        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 4L, 14),
                GT_ModHandler.getModItem(TwilightForest.modID, "item.trophy", 0L, 2),
                CustomItemList.LichBone.get(1L),
                900,
                256);
        GT_Values.RA.addAssemblerRecipe(
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Utility.getIntegratedCircuit(6),
                Materials.Thaumium.getMolten(216L),
                GT_ModHandler.getModItem(TwilightForest.modID, "item.carminite", 1L, 0),
                350,
                1920);
        GT_Values.RA.addAssemblerRecipe(
                ...
                4096);
        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 10L, 14),
                GT_ModHandler.getModItem(TwilightForest.modID, "item.trophy", 0L, 4),
                CustomItemList.SnowQueenBlood.get(1L),
                1800,
                7680);
        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem(Thaumcraft.modID, "ItemResource", 16L, 14),
                GT_ModHandler.getModItem(Witchery.modID, "ingredient", 1L, 130),
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Values.NF,
                GT_ModHandler.getModItem(Forestry.modID, "engine", 1L, 0),
                200,
                16);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { CustomItemList.EngineCore.get(1L),
                        ...
                        GT_Utility.getIntegratedCircuit(10) },
                GT_Values.NF,
                GT_ModHandler.getModItem(Forestry.modID, "engine", 1L, 1),
                200,
                16);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { CustomItemList.EngineCore.get(1L),
                        ...
                        GT_Utility.getIntegratedCircuit(10) },
                GT_Values.NF,
                GT_ModHandler.getModItem(Forestry.modID, "engine", 1L, 2),
                200,
                16);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { CustomItemList.EngineCore.get(1L),
                        ...
                        GT_Utility.getIntegratedCircuit(10) },
                GT_Values.NF,
                GT_ModHandler.getModItem(BuildCraftCore.modID, "engineBlock", 1L, 2),
                200,
                16);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { CustomItemList.EngineCore.get(1L),
                        ...
                        GT_Utility.getIntegratedCircuit(10) },
                GT_Values.NF,
                GT_ModHandler.getModItem(Forestry.modID, "engine", 1L, 4),
                200,
                16);
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "endoplasm", 1L, 0),
                200,
                240);
        GT_Values.RA.addAssemblerRecipe(
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Utility.getIntegratedCircuit(6),
                FluidRegistry.getFluidStack("endergoo", 200),
                GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "arcane_shard", 1L, 0),
                200,
                240);
        // HEE Runes
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "rune", 1L, 0),
                2400,
                7680);
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Utility.getIntegratedCircuit(9),
                FluidRegistry.getFluidStack("endergoo", 1000),
                GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "rune", 1L, 1),
                2400,
                7680);
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Utility.getIntegratedCircuit(9),
                FluidRegistry.getFluidStack("endergoo", 1000),
                GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "rune", 1L, 2),
                2400,
                7680);
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Utility.getIntegratedCircuit(9),
                FluidRegistry.getFluidStack("endergoo", 1000),
                GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "rune", 1L, 3),
                2400,
                7680);
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Utility.getIntegratedCircuit(9),
                FluidRegistry.getFluidStack("endergoo", 1000),
                GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "rune", 1L, 4),
                2400,
                7680);
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Utility.getIntegratedCircuit(9),
                FluidRegistry.getFluidStack("endergoo", 1000),
                GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "rune", 1L, 5),
                2400,
                7680);
        ...
        GT_Values.RA
                .addAssemblerRecipe(
                        new ItemStack[] {
                                GT_ModHandler
                                        .getModItem(IndustrialCraft2.modID, "itemBatREDischarged", 4L, GT_Values.W),
                                GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 1L),
                                GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 1L),
                                GT_Utility.getIntegratedCircuit(1) },
                        Materials.SolderingAlloy.getMolten(144L),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatChargeRE", 1L, 0),
                        200,
                        30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemAdvBat", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemAdvBat", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemAdvBat", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemAdvBat", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitchSpread", 1L, 1),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitch", 1L, 1),
                        GT_OreDictUnificator.get(OrePrefixes.cableGt02, Materials.Copper, 1L),
                        GT_Utility.getIntegratedCircuit(1) },
                Materials.SolderingAlloy.getMolten(288L),
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatChargeAdv", 1L, 0),
                400,
                120);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatCrystal", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatCrystal", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatCrystal", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatCrystal", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitchSpread", 1L, 1),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitchSpread", 1L, 1),
                ...
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatChargeCrystal", 1L, 0),
                800,
                480);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] {
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatLamaCrystal", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatLamaCrystal", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatLamaCrystal", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatLamaCrystal", 1L, GT_Values.W),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitchDiamond", 1L, 1),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitchDiamond", 1L, 1),
                        GT_OreDictUnificator.get(OrePrefixes.cableGt08, Materials.Aluminium, 1L),
                        GT_Utility.getIntegratedCircuit(1) },
                Materials.SolderingAlloy.getMolten(1440L),
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemBatChargeLamaCrystal", 1L, 0),
                1200,
                1920);
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack(Items.diamond, 1, 0),
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemPartCircuit", 4L, 0),
                CustomItemList.TwilightCrystal.get(1L),
                600,
                16);
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_ModHandler.getModItem(IronTanks.modID, "goldDiamondUpgrade", 1L, 0),
                600,
                120);
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Carbon, 1L),
                        ...
                        GT_ModHandler.getModItem(FloodLights.modID, "electricIncandescentLightBulb", 1L, 0),
                        GT_Utility.getIntegratedCircuit(1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(GalacticraftCore.modID, "tile.glowstoneTorch", 32L, 0),
                400,
                192);
        ...
        GT_Values.RA
                .addAssemblerRecipe(
                        new ItemStack[] { CustomItemList.CarbonPartHelmet.get(1L),
                                GT_ModHandler
                                        .getModItem(IndustrialCraft2.modID, "itemNightvisionGoggles", 1L, GT_Values.W),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorNanoHelmet", 1),
                        600,
                        480);
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorNanoChestplate", 1),
                600,
                480);
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorNanoLegs", 1),
                600,
                480);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { CustomItemList.CarbonPartBoots.get(1L), CustomItemList.NanoCrystal.get(1L),
                        ...
                        GT_Utility.getIntegratedCircuit(1) },
                Materials.RedstoneAlloy.getMolten(288L),
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemArmorNanoBoots", 1),
                600,
                480);
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { ItemList.Hull_LV.get(1L),
                        GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 1L),
                        GT_ModHandler.getModItem(IronChests.modID, "BlockIronChest", 1L, 0) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockPersonal", 1L, 0),
                200,
                30);
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Naquadria, 4L),
                        GT_ModHandler.getModItem(GTPlusPlus.modID, "itemFoilPikyonium64B", 2L),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.foil, Materials.BlackPlutonium, 4L),
                        GT_ModHandler.getModItem(GTPlusPlus.modID, "itemFoilArceusAlloy2B", 2L),
                        GT_OreDictUnificator
                                .get(OrePrefixes.foil, Materials.Tetranaquadahdiindiumhexaplatiumosminid, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 1L),
                        GT_Utility.getIntegratedCircuit(9) },
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Draconium, 4L),
                        GT_ModHandler.getModItem(GTPlusPlus.modID, "itemFoilCinobiteA243", 2L),
                        GT_OreDictUnificator
                                .get(OrePrefixes.foil, Materials.Tetranaquadahdiindiumhexaplatiumosminid, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 1L),
                        GT_Utility.getIntegratedCircuit(9) },
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Tritanium, 4L),
                        GT_ModHandler.getModItem(GTPlusPlus.modID, "itemFoilLafiumCompound", 2L),
                        GT_OreDictUnificator
                                .get(OrePrefixes.foil, Materials.Tetranaquadahdiindiumhexaplatiumosminid, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 1L),
                        GT_Utility.getIntegratedCircuit(9) },
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] {
                        // hikarium foil
                        GT_ModHandler.getModItem(BartWorks.modID, "gt.bwMetaGeneratedfoil", 4L, 10105),
                        // artherium-sn foil
                        GT_ModHandler.getModItem(BartWorks.modID, "gt.bwMetaGeneratedfoil", 1L, 10102),
                        GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.SuperconductorLuV, 1L),
                        GT_Utility.getIntegratedCircuit(9) },
                Xenoxene.getFluid(144L),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(21),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemPartAlloy", 2L),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockMachine", 1L, 12) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockReactorChamber", 1L),
                1200,
                480);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(22),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Titanium, 2L),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockReactorChamber", 3L),
                        GT_OreDictUnificator.get(OrePrefixes.cableGt08, Materials.Platinum, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 1L) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockGenerator", 1L, 5),
                1200,
                960);

        // Irradiant Glass Pane
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_ModHandler.getModItem(AdvancedSolarPanel.modID, "asp_crafting_items", 4L, 2),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockAlloyGlass", 4L, 0),
                        Materials.Glowstone.getPlates(1), GT_Utility.getIntegratedCircuit(1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(AdvancedSolarPanel.modID, "asp_crafting_items", 4L, 5),
                100,
                480);

        // Solar Light Splitter
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_ModHandler.getModItem(SuperSolarPanels.modID, "bluecomponent", 3L, 0),
                        GT_ModHandler.getModItem(SuperSolarPanels.modID, "redcomponent", 3L, 0),
                        GT_ModHandler.getModItem(SuperSolarPanels.modID, "greencomponent", 3L, 0),
                        GT_Utility.getIntegratedCircuit(1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(SuperSolarPanels.modID, "solarsplitter", 1L, 0),
                100,
                480);
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(21),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitch", 1L, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitchCore", 1L, 1),
                60,
                120);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(21),
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVent", 1L, 1),
                200,
                120);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(22),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVent", 1L, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVentCore", 1L, 1),
                300,
                256);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(21), ItemList.IC2_Industrial_Diamond.get(1L),
                        ...
                        CustomItemList.StainlessSteelBars.get(4L) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVentDiamond", 1L, 1),
                300,
                256);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(22),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVentDiamond", 1L, 1) },
                Materials.StainlessSteel.getMolten(72),
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVentGold", 1L, 1),
                400,
                480);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(21),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVent", 1L, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVentSpread", 1L),
                300,
                256);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(21),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.RedAlloy, 4L),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorHeatSwitchCore", 2L, 1),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorVentCore", 1L, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorCondensator", 1L, 1),
                600,
                480);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(21),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorCondensator", 1L, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorCondensatorLap", 1L, 1),
                900,
                480);
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(22),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemPartAlloy", 4L) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorPlating", 1L),
                400,
                120);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(21),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorPlating", 1L) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorPlatingHeat", 1L),
                600,
                256);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(23),
                        ...
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorPlating", 1L) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorPlatingExplosive", 1L),
                600,
                256);
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Copper, 1L),
                        ...
                        GT_Utility.getIntegratedCircuit(1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorReflector", 1L, 1),
                1200,
                480,
                true);
        GT_Values.RA.addAssemblerRecipe(
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Beryllium, 2L),
                        ...
                        GT_Utility.getIntegratedCircuit(1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "reactorReflectorThick", 1L, 0),
                600,
                1920,
                true);
        GT_Values.RA.addAssemblerRecipe(
        ...
        if (OpenBlocks.isModLoaded() && BloodMagic.isModLoaded()) {
            ItemStack[] trophies = { GT_ModHandler.getModItem(OpenBlocks.modID, "trophy", 1L),
                    GT_ModHandler.getModItem(OpenBlocks.modID, "trophy", 1L),
                    GT_ModHandler.getModItem(OpenBlocks.modID, "trophy", 1L),
                    GT_ModHandler.getModItem(OpenBlocks.modID, "trophy", 1L), };
            ...
            ItemStack flightpotion = GT_ModHandler.getModItem(BloodMagic.modID, "alchemyFlask", 1L);
        ...
        if (EnderIO.isModLoaded()) {
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(EnderIO.modID, "blockFusedQuartz", 1L),
                            Materials.Glowstone.getDust(4), GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(EnderIO.modID, "blockFusedQuartz", 1L, 2),
                    500,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.VanadiumGallium, 4),
                            ...
                            GT_ModHandler.getModItem(EnderIO.modID, "itemMaterial", 1L, 13),
                            GT_Utility.getIntegratedCircuit(1) },
                    ...
                    30720);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BartWorks.modID, "gt.bwMetaGeneratedbolt", 4L, 10024),
                            GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Manganese, 4),
                            ItemList.Gravistar.get(1L),
                            GT_ModHandler.getModItem(EnderIO.modID, "itemFrankenSkull", 1L, 5),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StellarAlloy, 2),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Neutronium.getMolten(1440),
                    GT_ModHandler.getModItem(EnderIO.modID, "itemBasicCapacitor", 1L, 6),
                    200,
                    122880);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(EnderIO.modID, "itemBasicCapacitor", 1L, 5),
                            ItemList.Gravistar.get(1L),
                            GT_ModHandler.getModItem(EnderIO.modID, "itemFrankenSkull", 1L, 5),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StellarAlloy, 2) },
                    ...
                    122880);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Minecraft.modID, "skull", 1L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "rotten_flesh", 2L, 0),
        ...
        if (OpenComputers.isModLoaded()) {
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 1),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(OpenComputers.modID, "cable", 1L, 0),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 1),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(OpenComputers.modID, "keyboard", 1L, 0),
                    200,
                    64);
            // case 1
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_MV.get(1L),
                            ...
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 24),
                    ...
                    GT_ModHandler.getModItem(OpenComputers.modID, "case1", 1, 0),
                    200,
                    120);
            // case 2
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_HV.get(1L),
                            ...
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                            GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.Aluminium, 2),
                            GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 2L) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "case2", 1, 0),
                    200,
                    256);
            // case 3
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_EV.get(1L),
                            ...
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 26),
                            GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.Aluminium, 2),
                            GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 2L) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "case3", 1, 0),
                    200,
                    480);
            // micro case 1
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_MV.get(1L), ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 82),
                    200,
                    120);
            // mirco case 2
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_HV.get(1L), ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 86),
                    200,
                    256);
            // drone case 1
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 82),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 71),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.Aluminium, 4L),
                            GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 1L),
                            ItemList.Electric_Motor_HV.get(4L) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1, 83),
                    300,
                    256);
            // drone case 2
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 86),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 72),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 26),
                    ...
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1, 87),
                    300,
                    480);
            // Card
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Iron, 1),
                            ...
                            GT_Utility.getIntegratedCircuit(2) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 33),
                    200,
                    64);
            // floppy
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 19),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 2L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 19),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 24),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 4L, 1),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 5),
                    300,
                    120);
            // HDD 2
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Titanium, 2L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 4L, 19),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 4L, 2),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 6),
                    300,
                    256);
            // HDD 3
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.TungstenSteel, 2L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 8L, 19),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 26),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 4L, 38),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 7),
                    300,
                    480);
            // disk
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 19),
                    200,
                    120);
            // rack
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "relay", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "powerDistributor", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 13),
                            ItemList.Circuit_Board_Plastic_Advanced.get(2L),
                            GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.Aluminium, 4L),
                            GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 4L),
                            CustomItemList.SteelBars.get(2L) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "rack", 1L, 0),
                    200,
                    256);
            // adapter block
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_LV.get(1L), ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 24),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "adapter", 1L, 0),
                    200,
                    120);
            // assembler
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "assembler", 1L, 0),
                    200,
                    256);
            // disassembler
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_HV.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 28),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 4),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                            ItemList.Robot_Arm_HV.get(2L) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "disassembler", 1L, 0),
                    200,
                    256);
            // capacitor
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_LV.get(2L),
                            GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockElectric", 1L, 7),
                            ItemList.Circuit_Board_Plastic_Advanced.get(2L), ItemList.Circuit_Parts_Transistor.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "capacitor", 1L, 0),
                    200,
                    120);
            // charger
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_HV.get(1L),
                            GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockChargepad", 2L, 2),
                            ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 26),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "charger", 1L, 0),
                    200,
                    256);
            // diskDrive
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_LV.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 3L, 25),
                            ItemList.Electric_Motor_MV.get(1L),
                    ...
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "diskDrive", 1L, 0),
                    200,
                    120);
            // diskDriver
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "diskDrive", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 24),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 109),
                    200,
                    480);
            // geolyzer
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_MV.get(1L), ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 0), ItemList.Sensor_MV.get(2L),
                            GT_OreDictUnificator.get(OrePrefixes.lens, Materials.EnderEye, 2),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(OpenComputers.modID, "geolyzer", 1L, 0),
                    200,
                    120);
            // hologram1
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(2L),
                            ...
                            GT_Utility.getIntegratedCircuit(10) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "hologram1", 1L, 0),
                    200,
                    120);
            // hologram2
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(2L),
                            ...
                            GT_Utility.getIntegratedCircuit(10) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "hologram2", 1L, 0),
                    200,
                    256);
            // motionSensor
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 42),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Plastic, 2),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0),
                            new ItemStack(Blocks.daylight_detector, 2, 0), GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "motionSensor", 1L, 0),
                    200,
                    120);
            // netSplitter
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_LV.get(1L), ItemList.Circuit_Board_Plastic_Advanced.get(2L),
                            ...
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 3L, 0),
                            ItemList.Electric_Piston_LV.get(1L), GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "netSplitter", 1L, 0),
                    200,
                    64);
            // printer
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Machine_HV_Printer.get(1L),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "printer", 1L, 0),
                    200,
                    256);
            // powerConverter
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Transformer_HV_MV.get(1L),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "powerConverter", 1L, 0),
                    200,
                    256);
            // powerDistributor
            GT_Values.RA.addAssemblerRecipe(
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "diskDrive", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 43),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 1),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Plastic, 4),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "raid", 1L, 0),
                    200,
                    256);
            // redstone
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_MV.get(1L), ItemList.Circuit_Board_Plastic_Advanced.get(2L),
                            ...
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 66),
                            ItemList.Cover_ActivityDetector.get(1L) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "redstone", 1L, 0),
                    200,
                    120);
            // relay
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_MV.get(1L), ItemList.Circuit_Board_Plastic_Advanced.get(2L),
                            ...
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "relay", 1L, 0),
                    200,
                    120);
            // transposer
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Automation_ChestBuffer_LV.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 61),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 77),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Plastic, 2),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "transposer", 2L, 0),
                    400,
                    120);
            // waypoint
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Casing_MV.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 48),
                            ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 24),
                            ItemList.Circuit_Parts_Transistor.get(2L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "waypoint", 1L, 0),
                    200,
                    64);
            // cartridge empty
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(36L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 94),
                    200,
                    64);
            // cartridge full
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 94),
                    ...
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 95),
                    200,
                    64);
            // Interweb
            GT_Values.RA.addAssemblerRecipe(
            ...
            // Linked Card
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 13),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 28),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 48),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.EnderEye.getMolten(288L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 51),
                    400,
                    480);
            // Manual
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { new ItemStack(Items.book, 1, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Glue.getFluid(144L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 98),
                    100,
                    30);
            // Nano Machine
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "capacitor", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 2),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 13),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 42),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 18),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 9L, 96) },
                    Materials.Plastic.getMolten(144L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 107),
                    400,
                    256);
            // Server Tier 1
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "case1", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 24),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 3),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(144L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 45),
                    400,
                    256);
            // Server Tier 2
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "case2", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 26),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 38),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(144L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 46),
                    400,
                    480);
            // Server Tier 3
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Fiberglass_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "case3", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 26),
                            GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 39),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(144L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 40),
                    400,
                    1024);
            // Tablet Case Tier 1
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "screen2", 1L, 0),
                            ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 70),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 24),
                            GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Electrum, 4L) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 74),
                    400,
                    120);
            // Tablet Case Tier 2
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "screen2", 1L, 0),
                            ...
                            GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Electrum, 4L) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 92),
                    400,
                    256);
            // remote Monitor
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "screen2", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 34),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 13),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 26),
                            GT_ModHandler.getModItem(OpenComputers.modID, "keyboard", 1L, 0),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(144L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 41),
                    400,
                    120);
            // Terminal Server
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Fiberglass_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 3L, 13),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 108),
                    400,
                    480);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { new ItemStack(Items.paper, 64, 0), new ItemStack(Items.paper, 64, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(3) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(OpenPrinters.modID, "openprinter.printerPaperRoll", 1L, 0),
                    200,
                    64);
            // Black Ink Cartridge
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 94),
                            ...
                            GT_Utility.getIntegratedCircuit(2) },
                    Materials.Water.getFluid(1000L),
                    GT_ModHandler.getModItem(OpenPrinters.modID, "openprinter.printerInkBlack", 1L, GT_Values.W),
                    300,
                    120);
            GT_Values.RA
                    .addAssemblerRecipe(
                            new ItemStack[] {
                                    GT_ModHandler
                                            .getModItem(OpenPrinters.modID, "openprinter.printerInkBlack", 1L, GT_Values.W),
                                    GT_ModHandler.getModItem(GregTech.modID, "gt.metaitem.02", 1L, 32414),
                                    GT_ModHandler.getModItem(GregTech.modID, "gt.metaitem.02", 1L, 32414),
                                    GT_ModHandler.getModItem(GregTech.modID, "gt.metaitem.02", 1L, 32414),
                                    GT_Utility.getIntegratedCircuit(2) },
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 94),
                            ...
                            GT_Utility.getIntegratedCircuit(2) },
                    Materials.Water.getFluid(1000L),
                    GT_ModHandler.getModItem(OpenPrinters.modID, "openprinter.printerInkColor", 1L, GT_Values.W),
                    300,
                    120);
            GT_Values.RA
                    .addAssemblerRecipe(
                            new ItemStack[] {
                                    GT_ModHandler
                                            .getModItem(OpenPrinters.modID, "openprinter.printerInkColor", 1L, GT_Values.W),
                                    GT_ModHandler.getModItem(GregTech.modID, "gt.metaitem.02", 1L, 32415),
                                    GT_ModHandler.getModItem(GregTech.modID, "gt.metaitem.02", 1L, 32416),
                                    GT_ModHandler.getModItem(GregTech.modID, "gt.metaitem.02", 1L, 32418),
                                    GT_Utility.getIntegratedCircuit(2) },
            ...
            // RFID Reader
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenSecurity.modID, "opensecurity.rfidReaderCard", 1L, 0),
                            ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0),
                            GT_Utility.getIntegratedCircuit(2) },
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 1),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 28),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0),
                            ItemList.Circuit_Parts_Transistor.get(2L) },
                    Materials.Plastic.getMolten(72L),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { new ItemStack(Blocks.noteblock, 1, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenSecurity.modID, "alarm", 1L, 0),
                    300,
                    120);
            // Entity Detector
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 33),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 1),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 28),
                            GT_Utility.getIntegratedCircuit(1) },
            ...
            // Door Controler
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 28),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            ItemList.Circuit_Parts_Transistor.get(2L),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Obsidian, 4L),
                            GT_Utility.getIntegratedCircuit(1) },
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 104),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 1L, 0),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "relay", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 4L, 0),
            ...
            // energy turret
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenModularTurrets.modID, "laserTurret", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 4L, 25),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 4L, 0),
                            ItemList.Circuit_Parts_Transistor.get(2L), GT_Utility.getIntegratedCircuit(2) },
                    Materials.Plastic.getMolten(72L),
            ...
            // keypad
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "keyboard", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 24),
                            ItemList.Circuit_Parts_Transistor.get(2L),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_ModHandler.getModItem(OpenSecurity.modID, "opensecurity.magCard", 2L, 0),
                    150,
                    64);
            // RFID Card
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    Materials.Glue.getMolten(144L),
                    GT_ModHandler.getModItem(OpenSecurity.modID, "opensecurity.rfidCard", 2L, 0),
                    150,
                    64);
            // RFID Reader Card
            GT_Values.RA.addAssemblerRecipe(
            ...
            // Secure Network Card
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 11),
                            GT_ModHandler.getModItem(OpenComputers.modID, "cable", 2L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 26),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 63),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 24),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Redstone.getMolten(72L),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "geolyzer", 1L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 43),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 38),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(144L),
                    GT_ModHandler.getModItem(OpenGlasses.modID, "openglassesterminal", 1L, 0),
                    300,
                    480);
            // Open Glasses
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "screen3", 2L, 0),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 10),
                            GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 13),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(72L),
                    GT_ModHandler.getModItem(OpenGlasses.modID, "openglasses", 1L, GT_Values.W),
                    300,
                    480);
        }
        ...
        if (PamsHarvestCraft.isModLoaded()) {
            for (int i = 0; i < OreDictionary.getOres("cropCotton").size(); ++i) {
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        GT_Values.NF,
                        GT_ModHandler.getModItem(PamsHarvestCraft.modID, "wovencottonItem", 1L, 0),
                        400,
                        30,
                        false);
            }
        ...
        if (JABBA.isModLoaded()) {
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Wood, 2),
                            GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2),
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 0),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 1),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 2),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 3),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 4),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 5),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 6),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 7),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 8),
                    200,
                    16);
            if (BartWorks.isModLoaded()) {
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                                GT_ModHandler.getModItem(BartWorks.modID, "gt.bwMetaGeneratedplate", 2L, 88),
                                GT_ModHandler.getModItem(BartWorks.modID, "gt.bwMetaGeneratedstick", 2L, 88),
                                GT_Utility.getIntegratedCircuit(13) },
                        GT_Values.NF,
                        GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 9),
                        200,
                        16);
            } else {
                GT_Values.RA.addAssemblerRecipe(
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 10),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 11),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 12),
                    200,
                    16);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(JABBA.modID, "barrel", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(13) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(JABBA.modID, "upgradeStructural", 1L, 13),
                    200,
                    16);
        }
        ...
        if (ZTones.isModLoaded()) {
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { new ItemStack(Blocks.stone_slab, 4), new ItemStack(Blocks.stone, 1),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(ZTones.modID, "stoneTile", 8L, 0),
                    160,
                    4);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { new ItemStack(Blocks.glass, 4), new ItemStack(Items.dye, 1, GT_Values.W),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(ZTones.modID, "auroraBlock", 8L, 0),
                    160,
                    4);
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_ModHandler.getModItem(ZTones.modID, "cleanDirt", 8L, 0),
                    160,
                    4);
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_ModHandler.getModItem(ZTones.modID, "booster", 1L, 0),
                    100,
                    30);
            ...
            for (int j = 0; j < 21; j++) {
                for (int i = 0; i < 16; i++) {
                    GT_Values.RA.addAssemblerRecipe(
                            new ItemStack[] { GT_ModHandler.getModItem(ZTones.modID, "stoneTile", 4L, 0), item[j],
                                    GT_Utility.getIntegratedCircuit(i == 0 ? 24 : i) },
                            GT_Values.NF,
                            GT_ModHandler.getModItem(ZTones.modID, "tile." + blockName[j] + "Block", 8L, i),
                            200,
                            16);
                }
            }
            ...
            for (int j = 0; j < 12; j++) {
                for (int i = 0; i < 16; i++) {
                    GT_Values.RA.addAssemblerRecipe(
                            new ItemStack[] { GT_ModHandler.getModItem(ZTones.modID, "auroraBlock", 4L, 0), zitem[j],
                                    GT_Utility.getIntegratedCircuit(i == 0 ? 24 : i) },
                            GT_Values.NF,
                            GT_ModHandler.getModItem(ZTones.modID, "tile." + zblockName[j] + "Block", 8L, i),
                            200,
                            16);
                }
            }
            ...
            for (int i = 0; i < 16; i++) {
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(ZTones.modID, "auroraBlock", 4L, 0),
                                new ItemStack(Blocks.glass, 1, 0), GT_Utility.getIntegratedCircuit(i == 0 ? 24 : i) },
                        GT_Values.NF,
                        GT_ModHandler.getModItem(ZTones.modID, "tile.glaxx", 8L, i),
                        200,
                        16);
            }
        }
        ...
        if (PamsHarvestCraft.isModLoaded() && Forestry.isModLoaded() && OpenComputers.isModLoaded()) {
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sugar, 1L),
                            ...
                            GT_ModHandler.getModItem(PamsHarvestCraft.modID, "pepperoniItem", 1L, 0),
        ...
        if (GTPlusPlus.isModLoaded()) { // GT++, remember to remove later
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(GTPlusPlus.modID, "blockFishTrap", 1L, 0),
                    200,
                    64);
        }
        ...
        if (TinkerConstruct.isModLoaded()) {
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Stone, 2L),
                            GT_ModHandler.getModItem(TinkerConstruct.modID, "GlassPane", 2L),
                            GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Tin, 1L) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepowercobblestone", 1L),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepowerwood", 1L),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2L),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepowersandstone", 1L),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(ForgeMicroblocks.modID, "stoneRod", 2L),
                            GT_ModHandler.getModItem(TinkerConstruct.modID, "GlassPane", 2L),
                            GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Nickel, 1L) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepowerstone", 1L),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepowerquartz", 1L),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepoweriron", 1L),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepowergold", 1L),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepoweremerald", 1L),
                    200,
                    120);
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(BuildCraftTransport.modID, "item.buildcraftPipe.pipepowerdiamond", 1L),
                    200,
                    120);

            // Assembler
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(TinkerConstruct.modID, "slime.gel", 1L, 1),
                            GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockITNT", 1L, 0),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(TinkerConstruct.modID, "explosive.slime", 1L, 0),
                    600,
                    30);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(TinkerConstruct.modID, "slime.gel", 1L, 0),
                            GT_ModHandler.getModItem(TinkerConstruct.modID, "explosive.slime", 1L, 0),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(TinkerConstruct.modID, "explosive.slime", 1L, 2),
                    600,
                    64);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Aluminium, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(TinkerConstruct.modID, "heartCanister", 1L, 0),
                    2400,
                    480);
        }

        if (Forestry.isModLoaded()) {
            ItemStack alveary = GT_ModHandler.getModItem(Forestry.modID, "alveary", 1L, 0);

            // Impregnated Frame
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Railcraft.modID, "slab", 3L, 38),
                            GT_ModHandler.getModItem(PamsHarvestCraft.modID, "wovencottonItem", 1L),
                            GT_ModHandler.getModItem(Forestry.modID, "oakStick", 5L, 0) },
                    Materials.SeedOil.getFluid(100L),
                    GT_ModHandler.getModItem(Forestry.modID, "frameImpregnated", 1L, 0),
                    1200,
                    64);
            ...
            for (ItemStack stack : fence) {
                if (Forestry.isModLoaded()) {
                    GT_Values.RA.addAssemblerRecipe(
                            new ItemStack[] { GT_ModHandler.getModItem(Forestry.modID, "frameImpregnated", 1L, 0),
                                    GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Steel, 2L),
                                    GT_OreDictUnificator.get(OrePrefixes.slab, Materials.Wood, 2L),
                                    GT_ModHandler.getModItem(Forestry.modID, "beeCombs", 1L, GT_Values.W),
                                    GT_ModHandler.getModItem(Forestry.modID, "apiculture", 2L, 2),
                                    stack.splitStack(2) },
                            Materials.SeedOil.getFluid(1000L),
                            GT_ModHandler.getModItem(Forestry.modID, "apiculture", 1L, 0),
                            1200,
                            64);
                }
            }
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Gold, 2L),
                            GT_ModHandler.getModItem(Forestry.modID, "royalJelly", 1L, 0),
                            GT_ModHandler.getModItem(Forestry.modID, "oakStick", 3L, 0),
                            GT_ModHandler.getModItem(Forestry.modID, "beeswax", 2L, 0),
                            GT_ModHandler.getModItem(Forestry.modID, "pollen", 1L, GT_Values.W) },
                    Materials.Honey.getFluid(1000L),
                    GT_ModHandler.getModItem(Forestry.modID, "craftingMaterial", 1L, 6),
                    1200,
                    64);

            // Swarmer
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 5),
                            GT_OreDictUnificator.get(OrePrefixes.foil, Materials.RoseGold, 2L),
                            GT_ModHandler.getModItem(Forestry.modID, "royalJelly", 2L, 0),
                            GT_ModHandler.getModItem(Forestry.modID, "frameProven", 1L, 0) },
                    Materials.Honey.getFluid(2500L),
                    GT_ModHandler.getModItem(Forestry.modID, "alveary", 1L, 2),
                    1200,
                    120);

            // Alveary Fan
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 11),
                            CustomItemList.SteelBars.get(3L),
                            GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.Bronze, 1L),
                            ItemList.Electric_Motor_MV.get(1L) },
                    Materials.Honey.getFluid(2500L),
                    GT_ModHandler.getModItem(Forestry.modID, "alveary", 1L, 3),
                    1200,
                    120);

            // Alveary Heater
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 7),
                            CustomItemList.SteelBars.get(1L),
                            GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemRecipePart", 3L),
                            ItemList.Electric_Motor_MV.get(1L) },
                    Materials.Honey.getFluid(2500L),
                    GT_ModHandler.getModItem(Forestry.modID, "alveary", 1L, 4),
                    1200,
                    120);

            // Alveary Hygroregulator
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 6),
                            GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 1L),
                            GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 2L, 0),
                    ...
                    Materials.Honey.getFluid(2500L),
                    GT_ModHandler.getModItem(Forestry.modID, "alveary", 1L, 5),
                    1200,
                    120);

            // Alveary Stabiliser
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 4),
                            com.dreammaster.item.ItemList.ChargedCertusQuartzPlate.getIS(2),
                            ItemList.Component_Filter.get(2L),
                            GT_ModHandler.getModItem(Forestry.modID, "royalJelly", 1L, 0) },
                    Materials.Honey.getFluid(2500L),
                    GT_ModHandler.getModItem(Forestry.modID, "alveary", 1L, 6),
                    1200,
                    120);

            // Alveary Sieve
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 3),
                            GT_ModHandler.getModItem(Forestry.modID, "craftingMaterial", 4L, 3),
                            GT_ModHandler.getModItem(Forestry.modID, "pollenFertile", 1L) },
                    Materials.Honey.getFluid(2500L),
                    GT_ModHandler.getModItem(Forestry.modID, "alveary", 1L, 7),
                    1200,
                    120);
        }
        ...
        if (ExtraBees.isModLoaded()) {
            ...
            // Mutator
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 12),
                            ...
                            GT_ModHandler.getModItem(ExtraBees.modID, "hiveFrame.soul", 1L, 0) },
                    Materials.Honey.getFluid(3750L),
                    GT_ModHandler.getModItem(ExtraBees.modID, "alveary", 1L, 0),
                    1200,
                    120);

            // Frame Housing
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 10),
                            ...
                            GT_ModHandler.getModItem(Forestry.modID, "frameProven", 1L, 0) },
                    Materials.Honey.getFluid(3750L),
                    GT_ModHandler.getModItem(ExtraBees.modID, "alveary", 1L, 1),
                    1200,
                    120);

            // Rain Shield
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 8),
                            GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockRubber", 4L),
                            new ItemStack(Blocks.brick_block, 1, 0), },
                    Materials.Honey.getFluid(3750L),
                    GT_ModHandler.getModItem(ExtraBees.modID, "alveary", 1L, 2),
                    1200,
                    120);

            // Alveary Lighting
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 2),
                            new ItemStack(Blocks.stained_glass, 4, GT_Values.W),
                            new ItemStack(Blocks.redstone_lamp, 1, 0) },
                    Materials.Honey.getFluid(3750L),
                    GT_ModHandler.getModItem(ExtraBees.modID, "alveary", 1L, 3),
                    1200,
                    120);

            // Electrical Stimulator
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 1),
                            GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Silver, 2L),
                            GT_ModHandler.getModItem(Forestry.modID, "chipsets", 2L, 2),
                            ItemList.Electric_Motor_HV.get(1L) },
                    Materials.Honey.getFluid(3750L),
                    GT_ModHandler.getModItem(ExtraBees.modID, "alveary", 1L, 4),
                    1200,
                    120);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 3),
                            ...
                            GT_ModHandler.getModItem(Forestry.modID, "apiculture", 1L, 0) },
                    Materials.Honey.getFluid(3750L),
                    GT_ModHandler.getModItem(ExtraBees.modID, "alveary", 1L, 5),
                    1200,
                    120);

            // Alveary Transmission
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { alveary, GT_ModHandler.getModItem(Forestry.modID, "thermionicTubes", 4L, 0),
                            GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 1L),
                            GT_OreDictUnificator.get(OrePrefixes.cableGt02, Materials.Aluminium, 3L),
                            ItemList.Hull_HV.get(1L) },
                    Materials.Honey.getFluid(3750L),
                    GT_ModHandler.getModItem(ExtraBees.modID, "alveary", 1L, 6),
                    1200,
                    120);
        }
        ...
        if (AppliedEnergistics2.isModLoaded() && TinkerConstruct.isModLoaded()) {
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(TinkerConstruct.modID, "GlassPane", 1L, 0),
                    ...
                    GT_Values.NF,
                    GT_ModHandler.getModItem(ExtraCells2.modID, "item.ItemMultiMaterial", 1L, 39),
                    100,
                    16);
        }
        ...
        if (AppliedEnergistics2.isModLoaded()) {
            GT_Values.RA.addAssemblerRecipe(
                    GT_ModHandler.getModItem(ExtraCells2.modID, "item.ItemMultiMaterial", 1L, 24),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Cover_Screen.get(1L),
                            ...
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.RedAlloy, 1L) },
                    Materials.SolderingAlloy.getMolten(144L),
                    GT_ModHandler.getModItem(ExtraCells2.modID, "item.ItemMultiPart", 1L, 180),
                    100,
                    4);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Hatch_Output_Bus_HV.get(1L),
                            GT_ModHandler.getModItem(ExtraCells2.modID, "item.ItemMultiPart", 1L, 440),
                            GT_ModHandler.getModItem(ExtraCells2.modID, "item.ItemMultiMaterial", 4L, 30),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { ItemList.Hatch_Output_HV.get(1L),
                            GT_ModHandler.getModItem(AE2FluidCraft.modID, "part_fluid_interface", 1L),
                            GT_ModHandler.getModItem(ExtraCells2.modID, "item.ItemMultiMaterial", 4L, 30),
                            GT_Utility.getIntegratedCircuit(1) },
                    GT_Values.NF,
        ...
        if (Gendustry.isModLoaded()) {
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Gendustry.modID, "Labware", 1),
                            GT_ModHandler.getModItem(Minecraft.modID, "string", 1),
                            GT_ModHandler.getModItem(Minecraft.modID, "paper", 1) },
                    GT_Values.NF,
                    GT_ModHandler.getModItem(Gendustry.modID, "PollenKit", 1),
                    200,
                    7680);
        }
        ...
        if (ExtraUtilities.isModLoaded()) {
            ...
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    GT_Utility.getIntegratedCircuit(1),
                    Materials.UUMatter.getMolten(1000L),
                    GT_ModHandler.getModItem(ExtraUtilities.modID, "unstableingot", 1L, 2),
                    1,
                    122880);
        ...
        if (ExtraUtilities.isModLoaded() && IronChests.isModLoaded()) {
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(IronChests.modID, "BlockIronChest", 1L, 0),
                            GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Plastic.getMolten(144L),
                    GT_ModHandler.getModItem(ExtraUtilities.modID, "filing", 1L, 0),
                    300,
                    120);
        }
        ...
        if (GalaxySpace.isModLoaded()) {
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalaxySpace.modID, "item.CompressedDualBronze", 1L, 0),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalaxySpace.modID, "item.CompressedDualBronze", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "item.CompressedDualAluminium", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "item.ModuleSmallCanister", 1L, 0),
                            GT_Utility.getIntegratedCircuit(2) },
                    Materials.StainlessSteel.getMolten(72L),

                    GT_ModHandler.getModItem(GalaxySpace.modID, "item.ModuleSmallFuelCanister", 1L, 0),
                    20,
                    (int) TierEU.RECIPE_LV);
            ...
            // Engine
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalaxySpace.modID, "item.CompressedSDHD120", 2L, 0),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "item.heavyPlating", 4L, 0),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalacticraftCore.modID, "item.engine", 2L, 1),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "item.engine", 2L, 0),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "item.itemBasicAsteroids", 5L, 0),
                            GT_Utility.getIntegratedCircuit(3) },
                    GT_Values.NF,
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { CustomItemList.Tier2Booster.get(2),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "item.itemBasicAsteroids", 2L, 1),
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler
                            .getModItem(ProjectRedIllumination.modID, "projectred.illumination.cagelamp2.inv", 1L, 14),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "item.heavyPlating", 4L, 0),
                            GT_Utility.getIntegratedCircuit(4) },
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalacticraftCore.modID, "item.noseCone", 1L, 0),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "item.itemBasicAsteroids", 4L, 0),
                            GT_Utility.getIntegratedCircuit(4) },
                    ...
                    (int) TierEU.RECIPE_MV);
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalacticraftMars.modID, "item.heavyNoseCone", 1L, 0),
            ...
            // rocket fins
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalacticraftCore.modID, "item.basicItem", 2L, 9),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "item.heavyPlating", 4L, 0),
                            GT_Utility.getIntegratedCircuit(5) },
                    GT_Values.NF,
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalacticraftMars.modID, "item.null", 2L, 3),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "item.itemBasicAsteroids", 4L, 0),
                            GT_Utility.getIntegratedCircuit(5) },
                    GT_Values.NF,
            ...
            // // booster
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(GalacticraftCore.modID, "item.meteoricIronIngot", 3L, 1),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "item.heavyPlating", 4L, 0),
        ...
        if (IronTanks.isModLoaded()) {
            // Copper Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Copper, 1L),
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "copperTank", 1L, 0),
                    300,
                    30);
            // Iron Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "ironTank", 1L, 0),
                    400,
                    30);
            // Steel Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "silverTank", 1L, 0),
                    500,
                    30);
            // Gold Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "goldTank", 1L, 0),
                    600,
                    30);
            // Diamond Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "diamondTank", 1L, 0),
                    800,
                    30);
            // Obsidian Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "obsidianTank", 1L, 0),
                    900,
                    30);
            // Aluminium Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "emeraldTank", 1L, 0),
                    1000,
                    60);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "stainlesssteelTank", 1L, 0),
                    1100,
                    120);
            // Titanium Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "titaniumTank", 1L, 0),
                    1200,
                    256);
            // Tungsten Steel Tank
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(BuildCraftFactory.modID, "tankBlock", 1L, 0),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(144L),
                    GT_ModHandler.getModItem(IronTanks.modID, "tungstensteelTank", 1L, 0),
                    1300,
                    480);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Glass, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "glassCopperUpgrade", 1L, 0),
                    300,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Glass, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "glassIronUpgrade", 1L, 0),
                    400,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Copper, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "copperIronUpgrade", 1L, 0),
                    500,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Copper, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "copperSilverUpgrade", 1L, 0),
                    600,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "ironGoldUpgrade", 1L, 0),
                    700,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "silverGoldUpgrade", 1L, 0),
                    700,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "silverDiamondUpgrade", 1L, 0),
                    800,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Diamond, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "diamondObsidianUpgrade", 1L, 0),
                    900,
                    30);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Diamond, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "diamondEmeraldUpgrade", 1L, 0),
                    1000,
                    60);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "emeraldStainlesssteelUpgrade", 1L, 0),
                    1100,
                    120);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "stainlesssteelTitaniumUpgrade", 1L, 0),
                    1200,
                    256);
            ...
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 1L),
                            ...
                            GT_Utility.getIntegratedCircuit(4) },
                    Materials.Glass.getMolten(72L),
                    GT_ModHandler.getModItem(IronTanks.modID, "titaniumTungstensteelUpgrade", 1L, 0),
                    1300,
                    480);
        }
    }
    ...
    private static final void registerReinforcedIronAlloyPlates() {
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemPartAlloy", 4),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemPartCarbonPlate", 4),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemPartAlloy", 4),
                        GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemPartIridium", 4),
                        GT_ModHandler.getModItem(AdvancedSolarPanel.modID, "asp_crafting_items", 1, 6) },
                GT_Values.NF,
                GT_ModHandler.getModItem(AdvancedSolarPanel.modID, "asp_crafting_items", 1, 7),
                100,
                122880);
    ...
    private static final void registerMixedMetalIngotRecipes() {
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 1L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Zinc, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 2L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 3L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 4L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Zinc, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 5L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 6L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Zinc, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 8L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Zinc, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 10L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 12L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.AnnealedCopper, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 14L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.AnnealedCopper, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 16L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.AnnealedCopper, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 18L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.AnnealedCopper, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 20L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
        ...
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSG, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 22L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSE, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 24L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSE, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 26L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSG, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 28L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSE, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 30L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSE, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 32L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Naquadah, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 34L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.NaquadahAlloy, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 36L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                ...
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 38L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Naquadah, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 40L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.NaquadahAlloy, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 42L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Draconium, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 44L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                ...
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 48L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Naquadah, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 52L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.NaquadahAlloy, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 56L, 4),
                100,
                30);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[] { GT_Utility.getIntegratedCircuit(3),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.BlackPlutonium, 1) },
                GT_Values.NF,
                GT_ModHandler.getModItem(IndustrialCraft2.modID, "itemIngot", 64L, 4),
                100,
                30);
    }
    ...
    private static final void registerNEIPlanetRecipes() {
        ...
        if (NEIOrePlugin.isModLoaded()) {
            ...
            // Overworld
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "stone", 64L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "grass", 64L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "sapling", 1L, 0),
                            GT_Utility.getIntegratedCircuit(1) },
                    Materials.Water.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ow", 1L, 0),
                    300,
                    30);
            // Twilight Forest
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "stone", 64L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "grass", 64L, 0),
                            GT_ModHandler.getModItem(TwilightForest.modID, "tile.TFSapling", 1L, 1),
                            GT_Utility.getIntegratedCircuit(2) },
                    Materials.Water.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_TF", 1L, 0),
                    300,
                    30);
            // Nether
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "netherrack", 64L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "soul_sand", 64L, 0),
                            GT_ModHandler.getModItem(BiomesOPlanty.modID, "ash", 64L, 0),
                            GT_Utility.getIntegratedCircuit(3) },
                    Materials.Lava.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ne", 1L, 0),
                    300,
                    30);
            // End
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "end_stone", 64L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "obsidian", 64L, 0),
                            GT_ModHandler.getModItem(Natura.modID, "Cloud", 64L, 1), GT_Utility.getIntegratedCircuit(4) },
                    FluidRegistry.getFluidStack("ender", 10000),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_ED", 1L, 0),
                    300,
                    30);
            // Far End Asteroids
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "end_stone_terrain", 64L, 0),
                            GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "end_stone_terrain", 64L, 1),
                            GT_ModHandler.getModItem(HardcoreEnderExpansion.modID, "end_stone_terrain", 64L, 2),
                            GT_Utility.getIntegratedCircuit(5) },
                    FluidRegistry.getFluidStack("endergoo", 10000),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_EA", 1L, 0),
                    300,
                    30);
            // T1 Planets
            // The Moon
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "tile.moonBlock", 64L, 3),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "tile.moonBlock", 64L, 4),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "tile.moonBlock", 64L, 14),
                            GT_Utility.getIntegratedCircuit(6) },
                    Materials.SaltWater.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Mo", 1L, 0),
                    300,
                    480);
            // T2 Planets
            // Deimos
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "deimosblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "deimosblocks", 64L, 1),
                            GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Uranium, 64L),
                            GT_Utility.getIntegratedCircuit(7) },
                    Materials.SulfuricAcid.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_De", 1L, 0),
                    300,
                    1920);
            // Phobos
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "phobosblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "phobosblocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "phobosblocks", 64L, 2),
                            GT_Utility.getIntegratedCircuit(8) },
                    Materials.SulfuricAcid.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ph", 1L, 0),
                    300,
                    1920);
            // Mars
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "tile.mars", 64L, 5),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "tile.mars", 64L, 6),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "tile.mars", 64L, 7),
                            GT_Utility.getIntegratedCircuit(9) },
                    Materials.Chlorobenzene.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ma", 1L, 0),
                    300,
                    1920);
            // T3 Planets
            // Ceres
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "ceresblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "ceresblocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "ceresblocks", 64L, 2),
                            GT_Utility.getIntegratedCircuit(10) },
                    Materials.Oxygen.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ce", 1L, 0),
                    300,
                    7680);
            // Callisto
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "callistoblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "callistoblocks", 64L, 1),
                            GT_OreDictUnificator.get(OrePrefixes.ore, Materials.CallistoIce, 64L),
                            GT_Utility.getIntegratedCircuit(11) },
                    Materials.LiquidAir.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ca", 1L, 0),
                    300,
                    7680);
            // Asteroids
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "tile.asteroidsBlock", 64L, 0),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "tile.asteroidsBlock", 64L, 1),
                            GT_ModHandler.getModItem(GalacticraftMars.modID, "tile.denseIce", 64L, 0),
                            GT_Utility.getIntegratedCircuit(12) },
                    FluidRegistry.getFluidStack("ice", 10000),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_As", 1L, 0),
                    300,
                    7680);
            // Ganymede
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "ganymedeblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "ganymedeblocks", 64L, 1),
                            GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Platinum, 64L),
                            GT_Utility.getIntegratedCircuit(13) },
                    Materials.Oxygen.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ga", 1L, 0),
                    300,
                    7680);
            // Europa
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "europagrunt", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "europagrunt", 64L, 1),
                            GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Manganese, 64L),
                            GT_Utility.getIntegratedCircuit(14) },
                    Materials.Water.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Eu", 1L, 0),
                    300,
                    7680);
            // Ross 128b
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "dirt", 64L, 2),
                            GT_ModHandler.getModItem(Minecraft.modID, "stone", 64L, 0),
                            ItemList.Generator_Naquadah_Mark_I.get(1L), GT_Utility.getIntegratedCircuit(15) },
                    Materials.Lava.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Rb", 1L, 0),
                    300,
                    7680);
            // T4 Planets
            // Io
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "ioblocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "ioblocks", 64L, 2),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "ioblocks", 64L, 3),
                            GT_Utility.getIntegratedCircuit(16) },
                    Materials.Lead.getMolten(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Io", 1L, 0),
                    300,
                    30720);
            // Mercury
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "mercuryblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "mercuryblocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "mercuryblocks", 64L, 2),
                            GT_Utility.getIntegratedCircuit(17) },
                    Materials.Iron.getMolten(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Me", 1L, 0),
                    300,
                    30720);
            // Venus
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "venusblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "venusblocks", 64L, 1),
                            GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Quantium, 64L),
                            GT_Utility.getIntegratedCircuit(18) },
                    Materials.CarbonDioxide.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ve", 1L, 0),
                    300,
                    30720);
            // T5 Planets
            // Miranda
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "mirandablocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "mirandablocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "mirandablocks", 64L, 2),
                            GT_Utility.getIntegratedCircuit(19) },
                    Materials.HydricSulfide.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Mi", 1L, 0),
                    300,
                    122880);
            // Oberon
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "oberonblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "oberonblocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "oberonblocks", 64L, 2),
                            GT_Utility.getIntegratedCircuit(20) },
                    Materials.CarbonMonoxide.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ob", 1L, 0),
                    300,
                    122880);
            // Enceladus
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "enceladusblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "enceladusblocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "enceladusblocks", 64L, 2),
                            GT_Utility.getIntegratedCircuit(21) },
                    Materials.Oxygen.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_En", 1L, 0),
                    300,
                    122880);
            // Titan
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "titanblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "titanblocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "titanblocks", 64L, 2),
                            GT_Utility.getIntegratedCircuit(22) },
                    Materials.Methane.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ti", 1L, 0),
                    300,
                    122880);
            // Ross 128ba
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "tile.moonBlock", 64L, 3),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "tile.moonBlock", 64L, 4),
                            GT_ModHandler.getModItem(GalacticraftCore.modID, "tile.moonBlock", 64L, 5),
                            GT_Utility.getIntegratedCircuit(23) },
                    Materials.Helium_3.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ra", 1L, 0),
                    300,
                    122880);
            // T6 Planets
            // Triton
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "tritonblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "tritonblocks", 64L, 1),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "tritonblocks", 64L, 2),
                            GT_Utility.getIntegratedCircuit(24) },
                    Materials.Ethylene.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Tr", 1L, 0),
                    300,
                    491520);
            // Proteus
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "proteusblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "proteusblocks", 64L, 2),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "proteusblocks", 64L, 3),
                            CI.getNumberedAdvancedCircuit(1) },
                    Materials.Deuterium.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Pr", 1L, 0),
                    300,
                    491520);
            // T7 Planets
            // Haumea
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "haumeablocks", 64L, 0),
                    ...
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Ha", 1L, 0),
                    300,
                    1966080);
            // Pluto
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "plutoblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "plutoblocks", 64L, 4),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "plutoblocks", 64L, 6),
                            CI.getNumberedAdvancedCircuit(3) },
                    Materials.Fluorine.getGas(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_Pl", 1L, 0),
                    300,
                    1966080);
            // Makemake
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "makemakegrunt", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "makemakegrunt", 64L, 1),
                    ...
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_MM", 1L, 0),
                    300,
                    1966080);
            // Kuiper Belt
            GT_Values.RA.addAssemblerRecipe(
                    ...
                    FluidRegistry.getFluidStack("ice", 10000),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_KB", 1L, 0),
                    300,
                    1966080);
            // T8 Planets
            // Vega B
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "vegabgrunt", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "vegabsubgrunt", 64L, 0),
                    ...
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_VB", 1L, 0),
                    300,
                    7864320);
            // Barnard C
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "stone", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "barnardaCgrass", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "barnardaCsapling", 1L, 0),
                            CI.getNumberedAdvancedCircuit(7) },
                    FluidRegistry.getFluidStack("unknowwater", 10000),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_BC", 1L, 0),
                    300,
                    7864320);
            // Barnard E
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "barnardaEgrunt", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "barnardaEsubgrunt", 64L, 0),
                            GT_OreDictUnificator.get(OrePrefixes.block, Materials.Unstable, 64L),
                            CI.getNumberedAdvancedCircuit(8) },
                    Materials.LiquidAir.getFluid(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_BE", 1L, 0),
                    300,
                    7864320);
            // Barnard F
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "barnardaFgrunt", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "barnardaFsubgrunt", 64L, 0),
                    ...
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_BF", 1L, 0),
                    300,
                    7864320);
            // T Ceti E
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "tcetieblocks", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "tcetieblocks", 64L, 2),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "tcetiedandelions", 64L, 4),
                            CI.getNumberedAdvancedCircuit(10) },
                    GT_ModHandler.getDistilledWater(10000L),
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_TE", 1L, 0),
                    300,
                    7864320);
            // Alpha Centauri Bb
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "acentauribbgrunt", 64L, 0),
                            GT_ModHandler.getModItem(GalaxySpace.modID, "acentauribbsubgrunt", 64L, 0),
                    ...
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_CB", 1L, 0),
                    300,
                    7864320);
            // Technically T9
            // Deep Dark
            GT_Values.RA.addAssemblerRecipe(
                    new ItemStack[] { GT_ModHandler.getModItem(Botania.modID, "tinyPlanetBlock", 1L, 0),
                            GT_ModHandler.getModItem(Minecraft.modID, "cobblestone", 64L, 0),
                    ...
                    GT_ModHandler.getModItem(NEIOrePlugin.modID, "blockDimensionDisplay_DD", 1L, 0),
                    300,
                    125829120);
            GT_Values.RA.addAssemblerRecipe(
        ...
        for (Materials tMat : solderingMaterials) { // TODO dream things using soldering go in here!
            ...
            if (StevesCarts2.isModLoaded()) {
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Phenolic_Good.get(1L),
                                GT_ModHandler.getModItem(StevesCarts2.modID, "ModuleComponents", 2L, 9),
            ...
            if (SuperSolarPanels.isModLoaded()) {
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        GT_ModHandler.getModItem(SuperSolarPanels.modID, "SpectralSolarPanel", 1L, 0),
                        1600,
                        30720);
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        GT_ModHandler.getModItem(SuperSolarPanels.modID, "SingularSolarPanel", 1L, 0),
                        1800,
                        122880);
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        GT_ModHandler.getModItem(SuperSolarPanels.modID, "AdminSolarPanel", 1L, 0),
                        2000,
                        500000);
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        GT_ModHandler.getModItem(SuperSolarPanels.modID, "PhotonicSolarPanel", 1L, 0),
                        2200,
                        2000000);
            }
            ...
            if (OpenComputers.isModLoaded()) {
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Casing_MV.get(1L), ItemList.Cover_Screen.get(1L),
                                ...
                                ItemList.Circuit_Parts_Transistor.get(2L), GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "screen1", 1L, 0),
                        240,
                        64);
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Casing_MV.get(1L), ItemList.Cover_Screen.get(1L),
                ...
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "screen2", 1L, 0),
                        240,
                        120);
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Casing_HV.get(1L),
                ...
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(288L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "screen3", 1L, 0),
                        240,
                        256);
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Casing_EV.get(1L),
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 2L),
                                GT_ModHandler.getModItem(ExtraUtilities.modID, "angelBlock", 1L, 0),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 49),
                        250,
                        256);
                ...
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 99),
                        250,
                        256);
                ...
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 100),
                        250,
                        480);
                // battery upgrade 1
                GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Titanium, 2L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "capacitor", 2L, 0),
                                ItemList.Circuit_Parts_Transistor.get(4L),
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Silver, 8L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 64),
                        250,
                        256);
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Fiberglass_Advanced.get(1L),
                                ...
                                GT_ModHandler.getModItem(OpenComputers.modID, "capacitor", 4L, 0),
                                ItemList.Circuit_Parts_Transistor.get(8L),
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Electrum, 16L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 65),
                        250,
                        480);
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Fiberglass_Advanced.get(1L),
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 53),
                        300,
                        120);
                // inventory controller upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 53),
                                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 2L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 24),
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Electrum, 8L),
                                GT_Utility.getIntegratedCircuit(1) },
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 76),
                        300,
                        120);
                // tank controller upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 76),
                                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 2L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 24),
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Electrum, 8L),
                                GT_Utility.getIntegratedCircuit(1) },
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 25),
                                GT_ModHandler.getModItem(Forestry.modID, "beealyzer", 1L, 0),
                                ItemList.Sensor_MV.get(2L),
                                GT_OreDictUnificator.get(OrePrefixes.lens, Materials.EnderEye, 2),
                                GT_Utility.getIntegratedCircuit(10) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item.forestry", 1L, 0),
                        200,
                        120);
                // configurator upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "wrench", 1L, 0),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 24),
                                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 2L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 115),
                        300,
                        120);
                // riteg upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getIC2Item("RTGPellets", 1),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 3L, 26),
                                GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.Lead, 4L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 116),
                        300,
                        256);
                // card container 1
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 33),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 57),
                        250,
                        120);
                // card container 2
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 33),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 58),
                        250,
                        256);
                // card container 3
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 33),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 59),
                        250,
                        480);
                // upgrade container 1
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 54),
                        250,
                        120);
                // upgrade container 2
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 55),
                        250,
                        256);
                // upgrade container 3
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Fiberglass_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 56),
                        250,
                        480);
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 78),
                        250,
                        120);
                // database upgrade 2
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 79),
                        250,
                        256);
                // database upgrade 3
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Fiberglass_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 80),
                        250,
                        480);
                // experience upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 52),
                        250,
                        120);
                // crafting component
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 14),
                        250,
                        120);
                // generator upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(EnderIO.modID, "blockStirlingGenerator", 1L, 0),
                                ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 24),
                                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 1L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 15),
                        250,
                        120);
                // leash upgrade
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 85),
                        250,
                        120);
                // mfu upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "adapter", 1L, 0),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 51),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 4L, 96),
                                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Lapis, 2L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 112),
                        250,
                        480);
                // navigation upgrade
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 36),
                        250,
                        256);
                // piston upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 75),
                        250,
                        120);
                // sing IO upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 35),
                        250,
                        120);
                // solar upgrade
                GT_Values.RA.addAssemblerRecipe(
                ...
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 67),
                        250,
                        480);
                // trading upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 110),
                        250,
                        256);
                // hover Boots
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "capacitor", 1L, 0),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 83),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 100),
                                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 4L),
                                ItemList.Electric_Piston_MV.get(2L), GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(OpenComputers.modID, "hoverBoots", 1L, GT_Values.W),
                        350,
                        256);
                // ME Upgrade 1
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Plastic_Advanced.get(1L),
                                GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Titanium, 2L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 13),
                                GT_ModHandler.getModItem(ExtraCells2.modID, "item.ItemMultiMaterial", 1L, 41),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 24),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(ExtraCells2.modID, "oc.upgrade", 1L, 2),
                        250,
                        256);
                // ME Upgrade 2
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(ExtraCells2.modID, "oc.upgrade", 1L, 1),
                        250,
                        1024);
                // ME Upgrade 3
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Fiberglass_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(ExtraCells2.modID, "oc.upgrade", 1L),
                        250,
                        4096);
            }
            ...
            if (Computronics.isModLoaded()) {
                // Camera Upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(Computronics.modID, "computronics.camera", 1L, 0),
                                ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                                ItemList.Circuit_Parts_TransistorSMD.get(2L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 0),
                        250,
                        256);
                // Chat Upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(Computronics.modID, "computronics.chatBox", 1L, 0),
                                ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                                ItemList.Circuit_Parts_TransistorSMD.get(2L),
                                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 4L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 1),
                        250,
                        256);
                // Radar Upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(Computronics.modID, "computronics.radar", 1L, 0),
                                ItemList.Circuit_Board_Fiberglass_Advanced.get(1L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 26),
                                ItemList.Circuit_Parts_TransistorSMD.get(4L),
                                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 4L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 2),
                        250,
                        480);
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(Computronics.modID, "computronics.radar", 1L, 0),
                ...
                GT_Values.RA.addAssemblerRecipe(
                        ...
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 3),
                        250,
                        480);
                // Spoofing Card
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 11),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 50),
                                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Clay, 2L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 4),
                        250,
                        480);
                // Beep Card
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 33),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 28),
                                GT_ModHandler.getModItem(Computronics.modID, "computronics.speaker", 1L, 0),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 5),
                        250,
                        480);
                // Self Destruction Card
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 66),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 24),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 28),
                                GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockITNT", 2L, 0),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 6),
                        250,
                        256);
                // Colorful Upgrade
                GT_Values.RA
                        .addAssemblerRecipe(
                                new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                        ...
                                        ItemList.Circuit_Parts_TransistorSMD.get(2L),
                                        GT_ModHandler
                                                .getModItem(Computronics.modID, "computronics.colorfulLamp", 1L, 0),
                                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 4L, 96),
                                        GT_Utility.getIntegratedCircuit(1) },
                                tMat.getMolten(144L * tMultiplier / 2L),
                                GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 7),
                                250,
                                480);
                // Noise Card
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 5),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 1),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 27),
                                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.NetherQuartz, 2L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 8),
                        250,
                        480);
                // Sound Card
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 8),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 26),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 38),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 1L, 29),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 9),
                        250,
                        1024);
                // Light Board
                GT_Values.RA
                        .addAssemblerRecipe(
                                ...
                                tMat.getMolten(144L * tMultiplier / 2L),
                                GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 10),
                                250,
                                256);
                // Server Selfdestructor
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 2L, 6),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 24),
                                ItemList.Dye_SquidInk.get(4L),
                                GT_ModHandler.getModItem(IndustrialCraft2.modID, "blockITNT", 2L, 0),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 11),
                        250,
                        256);
                // Rack Capacitor
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                ...
                                ItemList.Dye_SquidInk.get(4L), GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 12),
                        250,
                        256);
                // Switch Board
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                ...
                                ItemList.Dye_SquidInk.get(4L), GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 13),
                        250,
                        256);
                // Speech Upgrade
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { GT_ModHandler.getModItem(Computronics.modID, "computronics.speechBox", 1L, 0),
                                ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 25),
                                ItemList.Circuit_Parts_TransistorSMD.get(2L),
                                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 4L),
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.ocParts", 1L, 14),
                        250,
                        256);
                ...
                GT_Values.RA.addAssemblerRecipe(
                        new ItemStack[] { ItemList.Circuit_Board_Epoxy_Advanced.get(1L),
                                ...
                                GT_Utility.getIntegratedCircuit(1) },
                        tMat.getMolten(144L * tMultiplier / 2L),
                        GT_ModHandler.getModItem(Computronics.modID, "computronics.droneStation", 1L, 0),
                        250,
                        480);
                ...
                GT_Values.RA
                        .addAssemblerRecipe(
                                new ItemStack[] {
                                        GT_ModHandler
                                                .getModItem(Computronics.modID, "computronics.droneStation", 1L, 0),
                                        GT_ModHandler.getModItem(OpenComputers.modID, "item", 2L, 26),
                                        ItemList.Circuit_Parts_TransistorSMD.get(2L),
                                        GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Aluminium, 2L),
                                        GT_Utility.getIntegratedCircuit(1) },
                                tMat.getMolten(144L * tMultiplier / 2L),
                                GT_ModHandler.getModItem(Computronics.modID, "computronics.dockingUpgrade", 1L, 0),
                                250,
                                480);
            }
        }
