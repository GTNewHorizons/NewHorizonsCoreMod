    ...
    public void run() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { getModItem(OpenComputers.ID, "item", 4, 90), ItemList.Optically_Perfected_CPU.get(1),
                        ItemList.Sensor_UEV.get(1), new Object[] { OrePrefixes.circuit.get(Materials.UHV), 2L },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                (int) TierEU.RECIPE_UHV,
                32,
                new Object[] { ItemList.Hull_UIV.get(4), new Object[] { OrePrefixes.circuit.get(Materials.UIV), 8L },
                        ...
                        GTOreDictUnificator.get(OrePrefixes.foil, Materials.RadoxPolymer, 64) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { ItemList.Hull_UIV.get(4),
                        ...
                        GTOreDictUnificator.get(OrePrefixes.stickLong, Materials.RadoxPolymer, 32) },
                new FluidStack[] { MaterialsElements.STANDALONE.RHUGNOR.getFluidStack(40),
                        Materials.SuperCoolant.getFluid(16_000), new FluidStack(solderUEV, 11_520),
                        Materials.UUMatter.getFluid(8_000) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new FluidStack[] { Materials.RadoxPolymer.getMolten(2_304), Materials.SuperCoolant.getFluid(32_000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { ItemList.Hull_UIV.get(4), NHItemList.IrradiantReinforcedBedrockiumPlate.get(4),
                        ...
                        GTOreDictUnificator.get(OrePrefixes.itemCasing, Materials.RadoxPolymer, 64) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                (int) TierEU.RECIPE_UMV,
                64,
                new Object[] { GGItemList.AdvAssLine.get(1), ItemList.CoherencePreservingPlasmaConduit.get(4),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
                ...
                new Object[] { GTModHandler.getModItem(IndustrialCraft2.ID, "blockMachine2", 1, 0),
                        ItemList.CoherencePreservingPlasmaConduit.get(4), ItemList.Casing_Dim_Bridge.get(16),
                        GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.SuperconductorUIV, 16),
                        new Object[] { OrePrefixes.circuit.get(Materials.UIV), 16L },
                        GGMaterial.tairitsu.get(OrePrefixes.plateDense, 8),
                        GTOreDictUnificator.get(OrePrefixes.plateDense, Materials.Churitsu, 8),
