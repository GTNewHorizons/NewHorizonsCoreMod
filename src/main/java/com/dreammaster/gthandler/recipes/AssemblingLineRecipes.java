        ...
        if (EternalSingularity.isModLoaded()) {
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                    ...
                    new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Netherite, 1),
                            ItemList.Optically_Perfected_CPU.get(8),
            ...
            TTRecipeAdder.addResearchableAssemblylineRecipe(
                    ...
                    new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.CosmicNeutronium, 1),
                            WerkstoffLoader.HDCS.get(OrePrefixes.plate, 32),
                            ItemList.Optically_Compatible_Memory.get(8), ItemRefer.HiC_T4.get(4),
                            new Object[] { OrePrefixes.circuit.get(Materials.UEV), 1 }, ItemList.Emitter_UHV.get(1),
