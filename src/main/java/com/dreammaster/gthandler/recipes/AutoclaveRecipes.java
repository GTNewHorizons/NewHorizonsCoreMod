...
public class AutoclaveRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(EnderZoo.ID, "enderFragment", 4, 0)).circuit(1)
                ...
                .fluidInputs(MU.materialOf(Materials2Materials.Water).getFluid(100)).duration(60 * SECONDS)
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MU.materialOf(Materials2Materials.Water).getFluid(100))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MU.materialOf(Materials2Materials.Water).getFluid(200L)).duration(20 * SECONDS)
    ...
    public static void spaceRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MU.materialOf(Materials2Materials.UUMatter).getFluid(250L)).requiresCleanRoom()
                .requiresLowGravity().duration(10 * MINUTES).eut(TierEU.RECIPE_EV).addTo(autoclaveRecipes);
