...
public class BECRecipes implements Runnable {
            ...
            if (DraconicEvolution.isModLoaded()) {
                ...
                addBec(
                        ...
                        new ItemStack[] { ItemRefer.Field_Restriction_Coil_T4.get(1),
                                ...
                                MaterialLibAPI.getStack(Materials.SpaceTime, Shapes.plateSuperdense, 16),
                                MaterialLibAPI.getStack(Materials.SuperconductorUMVBase, Shapes.plateSuperdense, 16),
                                MaterialLibAPI.getStack(Materials.Eternity, Shapes.plateSuperdense, 16),
                                MaterialLibAPI.getStack(Materials.Magmatter, Shapes.plateSuperdense, 16) },
    ...
    private void addComputationSingularityRecipes() {
        ...
        final ItemStack[] material1 = new ItemStack[] {
                MaterialLibAPI.getStack(Materials.Lead, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Tin, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Copper, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Gold, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Tungsten, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.VanadiumGallium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Naquadah, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.NaquadahAlloy, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Samarium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.TengamPurified, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Hypogen, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Quantium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Magmatter, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.ChromaticGlass, Shapes.plateSuperdense, 64), };

        final ItemStack[] material2 = new ItemStack[] {
                MaterialLibAPI.getStack(Materials.CastIron, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Steel, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Titanium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.RhodiumPlatedPalladium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Iridium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Osmium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Neutronium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Bedrockium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.TranscendentMetal, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.SpaceTime, Shapes.plateSuperdense, 64),
                MaterialLibAPI
                        .getStack(Materials.MagnetohydrodynamicallyConstrainedStarMatter, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Eternity, Shapes.plateSuperdense, 64), };

        final ItemStack[] material3 = new ItemStack[] {
                MaterialLibAPI.getStack(Materials.RedAlloy, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.RedstoneAlloy, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.AnnealedCopper, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.EnergeticAlloy, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Iridium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Ruridit, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Europium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.ElectrumFlux, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Tritanium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Draconium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Rhugnor, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Dragonblood, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Universium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Infinity, Shapes.plateSuperdense, 64), };
    ...
    private void addSGRecipes() {
        ...
        addBec(
                ...
                new ItemStack[] { CustomItemList.StabilisationFieldGeneratorTier8.get(64),
                        ...
                        MaterialLibAPI.getStack(
                                ...
                                8),
                        MaterialLibAPI.getStack(Materials.SpaceTime, Shapes.plateSuperdense, 16), Circuits.MAX.get(16),
                        ItemList.Sensor_UXV.get(32L), ItemList.Emitter_UXV.get(32L),
                        getModItem(EternalSingularity.ID, "combined_singularity", 64, 15),
                        GTOreDictUnificator.get(OrePrefixes.nanite, Materials.WhiteDwarfMatter, 32),
        ...
        addBec(
                ...
                new ItemStack[] { CustomItemList.EOH_Reinforced_Spatial_Casing.get(64),
                        ...
                        MaterialLibAPI.getStack(Materials.Amalgatite, Shapes.gemExquisite, 64),
                        ...
                        MaterialLibAPI.getStack(
                                ...
                                8),
                        GTOreDictUnificator
                                .get(OrePrefixes.frameGt, Materials.MagnetohydrodynamicallyConstrainedStarMatter, 16),
        ...
        addBec(
                ...
                new ItemStack[] { MaterialLibAPI.getStack(Materials.Infinity, Shapes.stickLong, 64),
                        ...
                        MaterialLibAPI.getStack(Materials.Hexanite, Shapes.stickLong, 64),
                        MaterialLibAPI.getStack(Materials.SpaceTime, Shapes.stickLong, 64),
                        ...
                        MaterialLibAPI
                                .getStack(Materials.MagnetohydrodynamicallyConstrainedStarMatter, Shapes.stickLong, 64),
                        MaterialLibAPI.getStack(Materials.Eternity, Shapes.stickLong, 64),
                        MaterialLibAPI.getStack(Materials.Magmatter, Shapes.stickLong, 64) },
    ...
    private void addCircuitArrayRecipes() {
        ...
        final ItemStack[] longRod = new ItemStack[] { MaterialLibAPI.getStack(Materials.CastIron, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.Steel, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.Aluminium, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.StainlessSteel, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.Titanium, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.TungstenSteel, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.RhodiumPlatedPalladium, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.Iridium, Shapes.stickLong, 64),
                ...
                MaterialLibAPI.getStack(Materials.Bedrockium, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.BlackPlutonium, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.SpaceTime, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.MagnetohydrodynamicallyConstrainedStarMatter, Shapes.stickLong, 64),
                MaterialLibAPI.getStack(Materials.Magmatter, Shapes.stickLong, 64), };
        ...
        final ItemStack[] boltSD = new ItemStack[] {
                ...
                MaterialLibAPI.getStack(Materials.Copper, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.RedAlloy, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Platinum, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.NiobiumTitanium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.YttriumBariumCuprate, Shapes.plateSuperdense, 64),
                ...
                MaterialLibAPI.getStack(
                        ...
                        Shapes.plateSuperdense,
                        64),
                MaterialLibAPI.getStack(Materials.Tetranaquadahdiindiumhexaplatiumosminid, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Longasssuperconductornameforuhvwire, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.SuperconductorUEVBase, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.TranscendentMetal, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.SuperconductorUMVBase, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.WhiteDwarfMatter, Shapes.plateSuperdense, 64), };

        final ItemStack[] wireSD = new ItemStack[] {
                MaterialLibAPI.getStack(Materials.AnnealedCopper, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Copper, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.AnnealedCopper, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Electrum, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Platinum, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.NiobiumTitanium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.YttriumBariumCuprate, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.NiobiumTitanium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Aluminium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.NaquadahEnriched, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.ElectrumFlux, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Tritanium, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Rhugnor, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.MetastableOganesson, Shapes.plateSuperdense, 64),
                MaterialLibAPI.getStack(Materials.Hexanite, Shapes.plateSuperdense, 64), };
        ...
        addBec(
                ...
                new ItemStack[] { ItemList.Circuit_Board_Optical.get(64),
                        ...
                        MaterialLibAPI.getStack(Materials.WhiteDwarfMatter, Shapes.plateSuperdense, 16),
                        MaterialLibAPI.getStack(Materials.BlackDwarfMatter, Shapes.plateSuperdense, 8),
                        IngredientFactory.getModItem(OpenComputers.ID, "case3", 64, 0),
                        IngredientFactory.getModItem(OpenComputers.ID, "screen3", 64, 0),
                        MaterialLibAPI.getStack(Materials.Universium, Shapes.plateSuperdense, 4),
