...
public class BendingMachineRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(3 * MINUTES).eut(TierEU.RECIPE_MV).addTo(sBenderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(3 * MINUTES).eut(TierEU.RECIPE_MV * 3 / 4).addTo(sBenderRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_LV / 2).addTo(sBenderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Plastic, 1L),
                        GT_Utility.getIntegratedCircuit(1))
