...
public class CentrifugeRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .outputChances(8000, 10000, 10000).noFluidInputs()
        ...
        GT_Values.RA.stdBuilder()
                ...
                .outputChances(9000, 10000, 10000).noFluidInputs()
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidInputs().fluidOutputs(new FluidStack(FluidRegistry.getFluid("pollution"), 500))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_EV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidInputs().fluidOutputs(new FluidStack(FluidRegistry.getFluid("pollution"), 1000))
                .duration(60 * SECONDS).eut(TierEU.RECIPE_IV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Forestry.ID, "beeCombs", 1L, 9))
                ...
                .outputChances(10000, 11).noFluidInputs().noFluidOutputs().duration(15 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(new ItemStack(Items.fire_charge, 1, 0))
                ...
                .noFluidInputs().noFluidOutputs().duration(20 * SECONDS).eut(8).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.MoonStoneDust.get(36L))
                ...
                .outputChances(5000, 2000, 1000, 750, 500, 250).noFluidInputs().noFluidOutputs()
                .duration(2 * MINUTES + 42 * SECONDS).eut(TierEU.RECIPE_MV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.MarsStoneDust.get(36L))
                ...
                .outputChances(5000, 3000, 1000, 750, 500, 250).noFluidInputs().noFluidOutputs()
                .duration(2 * MINUTES + 1 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.PhobosStoneDust.get(36L))
                ...
                .outputChances(5000, 2500, 1000, 750, 500, 150).noFluidInputs().noFluidOutputs()
                .duration(2 * MINUTES + 1 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.DeimosStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tungstate, 4L))
                .outputChances(5000, 3000, 1000, 750, 650, 350).noFluidInputs()
                .fluidOutputs(Materials.SulfuricAcid.getFluid(1800L)).duration(2 * MINUTES + 1 * SECONDS + 10 * TICKS)
                .eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.AsteroidsStoneDust.get(36L))
                ...
                .outputChances(5000, 3000, 1000, 750, 500, 150).noFluidInputs().noFluidOutputs()
                .duration(5 * MINUTES + 24 * SECONDS).eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.EuropaIceDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 4L))
                .outputChances(5000, 2500, 1250, 750, 500, 150).noFluidInputs()
                .fluidOutputs(Materials.Oxygen.getGas(1800L)).duration(5 * MINUTES + 24 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.EuropaStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Barium, 4L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Uranium, 4L))
                .outputChances(5000, 3000, 1000, 750, 500, 300).noFluidInputs()
                .fluidOutputs(Materials.Nitrogen.getGas(3600L)).duration(5 * MINUTES + 24 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.GanymedeStoneDust.get(36L))
                ...
                .outputChances(5000, 3000, 1000, 750, 600, 250).noFluidInputs().noFluidOutputs()
                .duration(5 * MINUTES + 24 * SECONDS).eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.CallistoStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tungsten, 4L))
                .outputChances(5000, 3000, 1000, 900, 750, 250).noFluidInputs().noFluidOutputs()
                .duration(5 * MINUTES + 24 * SECONDS).eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.IoStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iridium, 4L))
                .outputChances(5000, 3000, 1000, 750, 500, 250).noFluidInputs()
                .fluidOutputs(Materials.SulfuricGas.getGas(3600L)).duration(3 * MINUTES + 36 * SECONDS)
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.VenusStoneDust.get(36L))
                ...
                .outputChances(10000, 3000, 1000, 750, 500, 250).noFluidInputs()
                .fluidOutputs(Materials.CarbonDioxide.getGas(18000L)).duration(3 * MINUTES + 36 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.MercuryStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 4L))
                .outputChances(5000, 3000, 1000, 750, 500, 250).noFluidInputs()
                .fluidOutputs(Materials.Helium_3.getGas(1800L)).duration(3 * MINUTES + 36 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.MercuryCoreDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Diamond, 4L))
                .outputChances(5000, 3000, 1000, 750, 500, 250).noFluidInputs()
                .fluidOutputs(Materials.Helium.getGas(9000L)).duration(3 * MINUTES + 36 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.EnceladusIceDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 4L))
                .outputChances(5000, 3000, 1000, 750, 400, 200).noFluidInputs()
                .fluidOutputs(Materials.Oxygen.getGas(5400L)).duration(8 * MINUTES + 6 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.EnceladusStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Trinium, 4L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 4L))
                .outputChances(5000, 3000, 1000, 1000, 400, 100).noFluidInputs()
                .fluidOutputs(Materials.Nitrogen.getGas(5400L)).duration(8 * MINUTES + 6 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.TitanStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Trinium, 4L))
                .outputChances(5000, 2500, 1000, 900, 500, 200).noFluidInputs()
                .fluidOutputs(Materials.Methane.getGas(3600L)).duration(8 * MINUTES + 6 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.OberonStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Trinium, 4L))
                .outputChances(4000, 2000, 800, 300, 150, 150).noFluidInputs()
                .fluidOutputs(Materials.Argon.getGas(1800L)).duration(8 * MINUTES + 6 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.MirandaStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 4L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Osmium, 4L))
                .outputChances(4000, 2000, 1000, 750, 500, 350).noFluidInputs()
                .fluidOutputs(Materials.Argon.getGas(1800L)).duration(8 * MINUTES + 6 * SECONDS).eut(TierEU.RECIPE_EV)
                .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.TritonStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Gallium, 4L))
                .outputChances(5000, 3000, 1000, 750, 500, 350).noFluidInputs().noFluidOutputs()
                .duration(5 * MINUTES + 2 * SECONDS + 8 * TICKS).eut(TierEU.RECIPE_IV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.ProteusStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Uranium, 4L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Plutonium, 4L))
                .outputChances(5000, 2500, 1000, 750, 500, 350).noFluidInputs()
                .fluidOutputs(Materials.Radon.getGas(360L)).duration(5 * MINUTES + 2 * SECONDS + 8 * TICKS)
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.PlutoIceDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ledox, 4L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 4L))
                .outputChances(5000, 2500, 1250, 750, 500, 400).noFluidInputs().noFluidOutputs()
                .duration(10 * MINUTES + 48 * SECONDS).eut(TierEU.RECIPE_IV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.PlutoStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 4L))
                .outputChances(5000, 2500, 850, 500, 500, 300).noFluidInputs().noFluidOutputs()
                .duration(10 * MINUTES + 48 * SECONDS).eut(TierEU.RECIPE_IV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.MakeMakeStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Yttrium, 4L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Niobium, 4L))
                .outputChances(2500, 2500, 1000, 750, 500, 350).noFluidInputs().noFluidOutputs()
                .duration(10 * MINUTES + 48 * SECONDS).eut(TierEU.RECIPE_IV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.HaumeaStoneDust.get(36L))
                ...
                .outputChances(5000, 2500, 850, 750, 500, 450).noFluidInputs().noFluidOutputs()
                .duration(10 * MINUTES + 48 * SECONDS).eut(TierEU.RECIPE_IV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.CentauriASurfaceDust.get(36L))
                ...
                .outputChances(5000, 3000, 1000, 1000, 100, 50).noFluidInputs()
                .fluidOutputs(Materials.Mercury.getFluid(3600L)).duration(6 * MINUTES + 28 * SECONDS + 16 * TICKS)
                .eut(TierEU.RECIPE_LuV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.CentauriAStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_ModHandler.getModItem(Avaritia.ID, "Resource", 36L, 2),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.InfinityCatalyst, 4L))
                .outputChances(5000, 2000, 500, 2500, 150, 80).noFluidInputs()
                .fluidOutputs(Materials.Mercury.getFluid(7200L)).duration(6 * MINUTES + 28 * SECONDS + 16 * TICKS)
                .eut(TierEU.RECIPE_LuV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.VegaBStoneDust.get(36L))
                ...
                .outputChances(5000, 3000, 1500, 800, 500, 50).noFluidInputs().noFluidOutputs()
                .duration(6 * MINUTES + 28 * SECONDS + 16 * TICKS).eut(TierEU.RECIPE_LuV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.BarnardaEStoneDust.get(36L))
                ...
                .outputChances(2500, 2000, 1500, 750, 250, 250).noFluidInputs().noFluidOutputs()
                .duration(6 * MINUTES + 28 * SECONDS + 16 * TICKS).eut(TierEU.RECIPE_LuV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.TCetiEStoneDust.get(36L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.InfinityCatalyst, 4L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Trinium, 4L))
                .outputChances(5000, 2500, 1000, 750, 150, 50).noFluidInputs().noFluidOutputs()
                .duration(6 * MINUTES + 28 * SECONDS + 16 * TICKS).eut(TierEU.RECIPE_LuV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .outputChances(10000, 9000, 7500, 6500).noFluidInputs().noFluidOutputs().duration(60 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(BiomesOPlenty.ID, "newBopGrass", 1L, 0))
                ...
                .outputChances(10000, 3300).noFluidInputs().noFluidOutputs().duration(5 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(BiomesOPlenty.ID, "driedDirt", 1L, 0))
                ...
                .outputChances(9000, 5000, 277).noFluidInputs().noFluidOutputs().duration(5 * SECONDS)
                .eut(TierEU.RECIPE_LV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Thaumcraft.ID, "blockEldritch", 1L, 4))
                .itemOutputs(
                        ...
                        GT_ModHandler.getModItem(Thaumcraft.ID, "ItemResource", 1L, 14),
                        GT_ModHandler.getModItem(Thaumcraft.ID, "ItemResource", 1L, 14))
                .outputChances(10000, 3300, 1000, 200).noFluidInputs().noFluidOutputs().duration(15 * SECONDS)
                .eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(GalaxySpace.ID, "item.GlowstoneDusts", 1L, 0))
                .itemOutputs(
                        ...
                        CustomItemList.CeresStoneDust.get(1L))
                .outputChances(10000, 9000, 7500).noFluidInputs().noFluidOutputs().duration(15 * SECONDS)
                .eut(TierEU.RECIPE_MV).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.QuartzSand, 9L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 1L))
                .outputChances(9000, 3000, 2000, 1500, 1000, 750).noFluidInputs().noFluidOutputs()
                .duration(1 * MINUTES + 48 * SECONDS).eut(16).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.BlackPlutonium, 1L))
                .itemOutputs(
                        ...
                        GT_ModHandler.getModItem(Avaritia.ID, "Resource", 1L, 2),
                        GT_ModHandler.getModItem(Avaritia.ID, "Resource", 1L, 2))
                .outputChances(5000, 2000, 1000).noFluidInputs().noFluidOutputs().duration(60 * SECONDS)
                .eut(TierEU.RECIPE_EV).addTo(sCentrifugeRecipes);

        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.MaceratedPlantmass.get(1L))
                .itemOutputs(GT_ModHandler.getModItem(IndustrialCraft2.ID, "itemBiochaff", 1L, 0)).noFluidInputs()
                .noFluidOutputs().duration(15 * SECONDS).eut(4).addTo(sCentrifugeRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Electrotine, 8L))
                ...
                .noFluidInputs().noFluidOutputs().duration(40 * SECONDS).eut(TierEU.RECIPE_LV)
                .addTo(sCentrifugeRecipes);

        GT_Values.RA.stdBuilder().itemInputs(ItemList.Cell_Air.get(5L))
                .itemOutputs(Materials.Oxygen.getCells(1), ItemList.Cell_Empty.get(4L)).noFluidInputs()
        ...
        GT_Values.RA.stdBuilder().itemInputs(Materials.AstralSilver.getDust(3))
                ...
                .noFluidOutputs().duration(15 * SECONDS).eut(TierEU.RECIPE_HV).addTo(sCentrifugeRecipes);

        GT_Values.RA.stdBuilder().itemInputs(Materials.SolderingAlloy.getDust(10))
                .itemOutputs(Materials.Tin.getDust(9), Materials.Antimony.getDust(1)).noFluidInputs().noFluidOutputs()
                .duration(15 * SECONDS).eut(TierEU.RECIPE_LV).addTo(sCentrifugeRecipes);
        // Liquid Fertilizer reverse recipe

        GT_Values.RA.stdBuilder().itemInputs(GT_Utility.getIntegratedCircuit(1))
                .itemOutputs(ItemList.IC2_Fertilizer.get(1L))
                .fluidInputs(FluidRegistry.getFluidStack("fluid.fertiliser", 144)).noFluidOutputs()
                .duration(2 * SECONDS).eut(16).addTo(sCentrifugeRecipes);
        ...
        if (PamsHarvestCraft.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(PamsHarvestCraft.ID, "coconutItem", 1L, 0))
                    ...
                    .noFluidInputs().noFluidOutputs().duration(5 * SECONDS).eut(2).addTo(sCentrifugeRecipes);
        ...
        if (TinkerConstruct.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(TinkerConstruct.ID, "strangeFood", 1L, 0))
                    ...
                    .fluidOutputs(Materials.Glue.getFluid(50)).duration(15 * SECONDS).eut(5).addTo(sCentrifugeRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(TinkerConstruct.ID, "slime.gel", 1L, 2))
                    .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Rubber, 8L)).noFluidInputs()
                    .fluidOutputs(Materials.Glue.getFluid(200)).duration(15 * SECONDS).eut(5).addTo(sCentrifugeRecipes);

            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(TinkerConstruct.ID, "slime.gel", 1L, 1))
                    .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RawRubber, 8L)).noFluidInputs()
                    .fluidOutputs(Materials.Glue.getFluid(200)).duration(15 * SECONDS).eut(5).addTo(sCentrifugeRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(TinkerConstruct.ID, "CraftedSoil", 1L, 0))
                    ...
                    .outputChances(10000, 10000, 1000).noFluidInputs().fluidOutputs(Materials.Glue.getFluid(25))
