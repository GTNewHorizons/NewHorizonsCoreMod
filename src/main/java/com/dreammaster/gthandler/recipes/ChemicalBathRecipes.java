...
public class ChemicalBathRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder().itemInputs(new ItemStack(Blocks.sticky_piston, 1, 0))
                ...
                .duration(1 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_LV).addTo(sChemicalBathRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(CustomItemList.MysteriousCrystalGemExquisite.get(1L))
                ...
                .duration(30 * SECONDS).eut(TierEU.RECIPE_UV).addTo(sChemicalBathRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(ItemList.Circuit_Parts_GlassFiber.get(1L))
                ...
                .duration(12 * SECONDS).eut(TierEU.RECIPE_LV / 2).addTo(sChemicalBathRecipes);
        ...
        if (OpenModularTurrets.isModLoaded()) {
            GT_Values.RA.stdBuilder()
                    ...
                    .eut(TierEU.RECIPE_LV / 2).addTo(sChemicalBathRecipes);
            GT_Values.RA.stdBuilder()
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.DarkSteel, 1L))
                    ...
                    .fluidInputs(FluidRegistry.getFluidStack("wet.concrete", 144)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_MV / 2).addTo(sChemicalBathRecipes);
            GT_Values.RA.stdBuilder()
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .fluidInputs(FluidRegistry.getFluidStack("wet.concrete", 144)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_HV / 2).addTo(sChemicalBathRecipes);
        }
