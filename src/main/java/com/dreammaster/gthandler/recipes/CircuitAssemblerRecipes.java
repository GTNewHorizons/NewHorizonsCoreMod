...
public class CircuitAssemblerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(5 * SECONDS).eut(TierEU.RECIPE_IV)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(10 * SECONDS).eut(TierEU.RECIPE_IV)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(20 * SECONDS).eut(TierEU.RECIPE_IV).addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(10 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(sCircuitAssemblerRecipes);
        // Wetware SoC recipe
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(2 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_UV)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.YttriumBariumCuprate, 8))
                .itemOutputs(ItemList.Circuit_Neuroprocessor.get(1L)).fluidInputs(new FluidStack(solderIndalloy, 72))
                .noFluidOutputs().requiresCleanRoom().duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ZPM)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(15 * SECONDS).eut(TierEU.RECIPE_LuV)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.YttriumBariumCuprate, 16))
                .itemOutputs(ItemList.Circuit_Wetwarecomputer.get(1L)).fluidInputs(new FluidStack(solderIndalloy, 144))
                .noFluidOutputs().requiresCleanRoom().duration(1 * SECONDS + 17 * TICKS).eut(TierEU.RECIPE_ZPM)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(new FluidStack(solderIndalloy, 144)).noFluidOutputs().requiresCleanRoom()
                .duration(30 * SECONDS).eut(TierEU.RECIPE_LuV).addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Circuit_Wetwaresupercomputer.get(1L))
                .fluidInputs(new FluidStack(solderIndalloy, 144)).noFluidOutputs().requiresCleanRoom()
                .duration(3 * SECONDS + 15 * TICKS).eut(TierEU.RECIPE_ZPM).addTo(sCircuitAssemblerRecipes);
        // Bio Circuits
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(15 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.NiobiumTitanium, 16))
                .itemOutputs(ItemList.Circuit_Bioprocessor.get(1L)).fluidInputs(new FluidStack(solderIndalloy, 72))
                .noFluidOutputs().requiresCleanRoom().duration(1 * SECONDS + 17 * TICKS).eut(TierEU.RECIPE_UV)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(20 * SECONDS).eut(TierEU.RECIPE_ZPM)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(2 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_IV)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidOutputs().requiresCleanRoom().duration(2 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_LuV)
                .addTo(sCircuitAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(ItemList.Circuit_Crystalprocessor.get(1L)).fluidInputs(new FluidStack(solderIndalloy, 72))
                .noFluidOutputs().requiresCleanRoom().duration(2 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_ZPM)
                .addTo(sCircuitAssemblerRecipes);
    ...
    public void solderingMaterials() {
        for (Materials tMat : solderingMaterials) {
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Circuit_Processor.get(1L))
                    .fluidInputs(tMat.getMolten(144L * tMultiplier / 2L)).noFluidOutputs().requiresCleanRoom()
                    .duration(5 * SECONDS).eut(TierEU.RECIPE_MV).addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Circuit_Nanoprocessor.get(1L))
                    .fluidInputs(tMat.getMolten(144L * tMultiplier / 2L)).noFluidOutputs().requiresCleanRoom()
                    .duration(5 * SECONDS).eut(TierEU.RECIPE_HV).addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    .itemInputs(
                            ...
                            GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Electrum, 16))
                    .itemOutputs(ItemList.Circuit_Nanocomputer.get(1L)).fluidInputs(tMat.getMolten(144L * tMultiplier))
                    .noFluidOutputs().requiresCleanRoom().duration(10 * SECONDS).eut(TierEU.RECIPE_HV)
                    .addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .noFluidOutputs().requiresCleanRoom().duration(20 * SECONDS).eut(TierEU.RECIPE_EV)
                    .addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .duration(20 * SECONDS).eut(TierEU.RECIPE_HV).addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .fluidInputs(tMat.getMolten(144L * tMultiplier / 2L)).noFluidOutputs().requiresCleanRoom()
                    .duration(10 * SECONDS).eut(TierEU.RECIPE_EV).addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Circuit_Quantumprocessor.get(1L))
                    .fluidInputs(tMat.getMolten(144L * tMultiplier / 2L)).noFluidOutputs().requiresCleanRoom()
                    .duration(5 * SECONDS).eut(TierEU.RECIPE_EV).addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .fluidInputs(tMat.getMolten(144L * tMultiplier)).noFluidOutputs().requiresCleanRoom()
                    .duration(20 * SECONDS).eut(TierEU.RECIPE_EV).addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Circuit_Microprocessor.get(2L))
                    .fluidInputs(tMat.getMolten(144L * tMultiplier / 2L)).noFluidOutputs().requiresCleanRoom()
                    .duration(2 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_HV).addTo(sCircuitAssemblerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Circuit_Processor.get(1L))
                    .fluidInputs(tMat.getMolten(144L * tMultiplier / 2L)).noFluidOutputs().requiresCleanRoom()
                    .duration(2 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_EV).addTo(sCircuitAssemblerRecipes);
            // Lapo orbs
