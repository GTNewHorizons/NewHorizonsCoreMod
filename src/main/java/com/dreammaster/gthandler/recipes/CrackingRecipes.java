...
public class CrackingRecipes implements Runnable {
    ...
    public void run() {
        GT_Values.RA.stdBuilder()
                ...
                .noItemOutputs()
                .fluidInputs(RadoxLight.getGas(100L), Silver.getPlasma(1))
                .fluidOutputs( RadoxSuperLight.getGas(50L) )
                .duration(25*SECONDS)
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(GT_Utility.getIntegratedCircuit(24))
                .noItemOutputs()
                .fluidInputs(RadoxHeavy.getFluid(100L), Silver.getPlasma(1))
                .fluidOutputs(  RadoxLight.getGas(20L) )
                .duration(25*SECONDS)
                .eut(TierEU.RECIPE_UV)
                .addTo(sCrackingRecipes);
    }
