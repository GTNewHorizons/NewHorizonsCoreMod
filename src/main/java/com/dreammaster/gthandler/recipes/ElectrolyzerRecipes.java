...
public class ElectrolyzerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials2Materials.Cryolite, Materials2Shapes.dust, (int) (10L)))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Sodium, Materials2Shapes.dust, (int) (3L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials2Materials.Magnesia, Materials2Shapes.dust, (int) (2L)))
                .itemOutputs(MaterialLibAPI.getStack(Materials2Materials.Magnesium, Materials2Shapes.dust, (int) (1L)))
                .fluidOutputs(
                        MaterialLibAPI.getFluidStack(
                                Materials2Materials.Oxygen,
                                Materials2FluidShapes.fluidGas,
        ...
        // Clay
        GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials2Materials.Clay, Materials2Shapes.dust, (int) (16L)))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Sodium, Materials2Shapes.dust, (int) (2L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Tanzanite, Materials2Shapes.dust, (int) (44L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Biotite, Materials2Shapes.dust, (int) (44L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials2Materials.GraniteRed, Materials2Shapes.dust, (int) (6L)))
                .itemOutputs(
                        MaterialLibAPI
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Pollucite, Materials2Shapes.dust, (int) (22L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Lepidolite, Materials2Shapes.dust, (int) (20L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.GlauconiteSand, Materials2Shapes.dust, (int) (21L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Glauconite, Materials2Shapes.dust, (int) (21L)),
                        ItemList.Cell_Empty.get(6L))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Potassium, Materials2Shapes.dust, (int) (1L)),
                        MaterialLibAPI.getStack(Materials2Materials.Magnesium, Materials2Shapes.dust, (int) (2L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Chlorite, Materials2Shapes.dust, (int) (18L)),
                        ItemList.Cell_Empty.get(4L))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Iron, Materials2Shapes.dust, (int) (3L)),
                        MaterialLibAPI.getStack(Materials2Materials.Magnesium, Materials2Shapes.dust, (int) (2L)),
        ...
        // Cordierite
        GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials2Materials.Cordierite, Materials2Shapes.dust, (int) (13L)))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Staurolite, Materials2Shapes.dust, (int) (32L)),
                        ItemList.Cell_Empty.get(1L))
                .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Epidote, Materials2Shapes.dust, (int) (10L)),
                        ItemList.Cell_Empty.get(1L))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Calcium, Materials2Shapes.dust, (int) (2L)),
                        MaterialLibAPI.getStack(Materials2Materials.Aluminium, Materials2Shapes.dust, (int) (3L)),
                        MaterialLibAPI.getStack(Materials2Materials.SiliconDioxide, Materials2Shapes.dust, (int) (3L)),
                        MaterialLibAPI.getStack(Materials2Materials.Hydrogen, Materials2CellShapes.cell, (int) (1L)))
                .fluidOutputs(
                        MaterialLibAPI.getFluidStack(
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Datolite, Materials2Shapes.dust, (int) (7L)),
                        ItemList.Cell_Empty.get(1L))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Calcium, Materials2Shapes.dust, (int) (1L)),
                        MaterialLibAPI.getStack(Materials2Materials.Boron, Materials2Shapes.dust, (int) (1L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Plagioclase, Materials2Shapes.dust, (int) (14L)))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Calcium, Materials2Shapes.dust, (int) (1L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Vermiculite, Materials2Shapes.dust, (int) (29L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Mica, Materials2Shapes.dust, (int) (38L)),
                        ItemList.Cell_Empty.get(11L))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Potassium, Materials2Shapes.dust, (int) (2L)),
                        MaterialLibAPI.getStack(Materials2Materials.Alumina, Materials2Shapes.dust, (int) (15L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Alunite, Materials2Shapes.dust, (int) (52L)),
                        ItemList.Cell_Empty.get(11L))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Potassium, Materials2Shapes.dust, (int) (2L)),
                        MaterialLibAPI.getStack(Materials2Materials.Alumina, Materials2Shapes.dust, (int) (15L)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.Zeolite, Materials2Shapes.dust, (int) (64L)),
                        MaterialLibAPI.getStack(Materials2Materials.Zeolite, Materials2Shapes.dust, (int) (49L)))
                .itemOutputs(
                        MaterialLibAPI.getStack(Materials2Materials.Sodium, Materials2Shapes.dust, (int) (1L)),
                        MaterialLibAPI.getStack(Materials2Materials.Calcium, Materials2Shapes.dust, (int) (4L)),
                        MaterialLibAPI.getStack(Materials2Materials.SiliconDioxide, Materials2Shapes.dust, (int) (64L)),
                        MaterialLibAPI.getStack(Materials2Materials.SiliconDioxide, Materials2Shapes.dust, (int) (17L)),
                        MaterialLibAPI.getStack(Materials2Materials.Aluminium, Materials2Shapes.dust, (int) (9L)))
                .fluidOutputs(
                        MaterialLibAPI.getFluidStack(
                                Materials2Materials.Oxygen,
                                Materials2FluidShapes.fluidGas,
