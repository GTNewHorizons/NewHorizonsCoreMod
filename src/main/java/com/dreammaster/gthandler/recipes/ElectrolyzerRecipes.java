    ...
    public void run() {
        ...
        if (TwilightForest.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .noFluidInputs().fluidOutputs(Materials.Helium_3.getFluid(100)).duration(20 * TICKS)
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .itemOutputs(
                            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone, 1L),
                            GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Helium, 1))
                    .noFluidInputs().fluidOutputs(Materials.Helium_3.getFluid(200)).duration(20 * TICKS)
                    .eut(TierEU.RECIPE_HV).addTo(sElectrolyzerRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .itemOutputs(
                            GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone, 1L),
                            GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Helium, 1))
                    .noFluidInputs().fluidOutputs(Materials.Helium_3.getFluid(50)).duration(20 * TICKS)
                    .eut(TierEU.RECIPE_HV).addTo(sElectrolyzerRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 5L))
                .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium, 2L)).noFluidInputs()
                .fluidOutputs(Materials.Oxygen.getGas(3000L)).duration(20 * TICKS).eut(TierEU.RECIPE_HV)
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Cryolite, 10L))
                ...
                .noFluidInputs().fluidOutputs(Materials.Fluorine.getGas(6000L)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_HV).addTo(sElectrolyzerRecipes);
        // Magnesia

        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesia, 2L))
                .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesium, 1L)).noFluidInputs()
                .fluidOutputs(Materials.Oxygen.getGas(1000L)).duration(20 * TICKS).eut(TierEU.RECIPE_LV)
                .addTo(sElectrolyzerRecipes);
        // Brick Dust
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Brick, 17L))
                ...
                .noFluidInputs().noFluidOutputs().duration(20 * TICKS).eut(10).addTo(sElectrolyzerRecipes);
        // Jade
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Jade, 20L))
                ...
                .noFluidInputs().fluidOutputs(Materials.Oxygen.getGas(1000L)).duration(20 * TICKS).eut(90)
                .addTo(sElectrolyzerRecipes);
        // Almandine
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Almandine, 20L))
                ...
                .noFluidInputs().fluidOutputs(Materials.Oxygen.getGas(3000L)).duration(20 * TICKS).eut(TierEU.RECIPE_HV)
                .addTo(sElectrolyzerRecipes);
        // Kaolinite
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidInputs().fluidOutputs(Materials.Hydrogen.getGas(4000L)).duration(20 * TICKS).eut(90)
                .addTo(sElectrolyzerRecipes);
        // Kyanite
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Kyanite, 8L))
                ...
                .noFluidInputs().noFluidOutputs().duration(20 * TICKS).eut(60).addTo(sElectrolyzerRecipes);
        // Spodumene
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidInputs().fluidOutputs(Materials.Fluorine.getGas(2000L)).duration(20 * TICKS)
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Emerald, 29L))
                ...
                .noFluidInputs().fluidOutputs(Materials.Oxygen.getFluid(3000L)).duration(20 * TICKS).eut(90)
                .addTo(sElectrolyzerRecipes);
        // Grossular
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Pyrope, 20L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 5L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 9L))
                .noFluidInputs().noFluidOutputs().duration(20 * TICKS).eut(90).addTo(sElectrolyzerRecipes);
        // Ruby
        ...
        GT_Values.RA.stdBuilder().itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Spessartine, 20L))
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 5L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 9L))
                .noFluidInputs().fluidOutputs(Materials.Oxygen.getGas(3000L)).duration(20 * TICKS).eut(90)
                .addTo(sElectrolyzerRecipes);
        // Tanzanite
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidInputs().fluidOutputs(Materials.Hydrogen.getGas(2000L)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_MV).addTo(sElectrolyzerRecipes);
        // Potassium Feldspar
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminiumoxide, 5L),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 18L))
                .noFluidInputs().fluidOutputs(Materials.Oxygen.getFluid(1000L)).duration(20 * TICKS).eut(90)
                .addTo(sElectrolyzerRecipes);
        // Biotite
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidInputs().fluidOutputs(Materials.Fluorine.getGas(4000L)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_MV).addTo(sElectrolyzerRecipes);
        // Red Granite
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 12L),
                        GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 1L))
                .noFluidInputs().fluidOutputs(Materials.Water.getFluid(2000L)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_MV).addTo(sElectrolyzerRecipes);
        // Lepidolite
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 6L),
                        GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2L))
                .noFluidInputs().fluidOutputs(Materials.Water.getFluid(4000L)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_MV).addTo(sElectrolyzerRecipes);
        // Mica
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide, 12L),
                        GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 11L))
                .noFluidInputs().fluidOutputs(Materials.Hydrogen.getGas(12000L)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_MV).addTo(sElectrolyzerRecipes);
        // Zeolite
        ...
        GT_Values.RA.stdBuilder()
                ...
                .noFluidInputs().fluidOutputs(Materials.Oxygen.getGas(18000L)).duration(20 * TICKS)
                .eut(TierEU.RECIPE_MV).addTo(sElectrolyzerRecipes);
    }
}
