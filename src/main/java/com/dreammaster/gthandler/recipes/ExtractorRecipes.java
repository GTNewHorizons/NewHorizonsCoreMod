    ...
    public void run() {
        ...
        if (GalaxySpace.isModLoaded() && SGCraft.isModLoaded()) {
            for (int i = 0; i < 6; ++i) {
                GT_Values.RA.stdBuilder()
                        ...
                        .noFluidOutputs().duration(20 * TICKS).eut(262144).addTo(sExtractorRecipes);
            }
        }
        ...
        if (TinkerConstruct.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(TinkerConstruct.ID, "slime.sapling", 1L, 0))
                    ...
                    .noFluidOutputs().duration(20 * TICKS).eut(2).addTo(sExtractorRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(TinkerConstruct.ID, "slime.gel", 1L, 1))
                    ...
                    .duration(20 * TICKS).eut(2).addTo(sExtractorRecipes);
        ...
        if (Natura.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Natura.ID, "florasapling", 1L, 5))
                    ...
                    .noFluidOutputs().duration(20 * TICKS).eut(TierEU.RECIPE_MV).addTo(sExtractorRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Natura.ID, "florasapling", 2L, 6))
                    .itemOutputs(ItemList.IC2_Fertilizer.get(1)).noFluidInputs().noFluidOutputs().duration(20 * TICKS)
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Natura.ID, "Natura.netherfood", 1L, 0))
                    .itemOutputs(ItemList.IC2_Fertilizer.get(4)).noFluidInputs().noFluidOutputs().duration(20 * TICKS)
                    .eut(TierEU.RECIPE_MV).addTo(sExtractorRecipes);
