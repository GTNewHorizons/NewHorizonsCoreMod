    ...
    public void run() {
        ...
        if (GalaxySpace.isModLoaded() && SGCraft.isModLoaded()) {
            for (int i = 0; i < 6; ++i) {
                ...
                GT_Values.RA.stdBuilder()
                        ...
                        .itemOutputs(com.dreammaster.item.ItemList.TCetiESeaweedExtract.getIS()).noFluidInputs()
                        .noFluidOutputs().duration(3 * MINUTES).eut(262144).addTo(sExtractorRecipes);
        ...
        if (BiomesOPlenty.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(BiomesOPlenty.ID, "flowers", 2L, 3))
                    .itemOutputs(new ItemStack(Items.glowstone_dust, 1, 0)).noFluidInputs().noFluidOutputs()
                    .duration(15 * SECONDS).eut(2).addTo(sExtractorRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(BiomesOPlenty.ID, "flowers", 2L, 13))
                    .itemOutputs(new ItemStack(Items.spider_eye, 1, 0)).noFluidInputs().noFluidOutputs()
                    .duration(15 * SECONDS).eut(2).addTo(sExtractorRecipes);

            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(BiomesOPlenty.ID, "mudball", 1L, 0))
                    .itemOutputs(new ItemStack(Items.clay_ball, 1, 0)).noFluidInputs().noFluidOutputs()
                    .duration(10 * SECONDS).eut(2).addTo(sExtractorRecipes);
        ...
        if (PamsHarvestCraft.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(PamsHarvestCraft.ID, "pamMaple", 1L, 0))
                    .itemOutputs(GT_ModHandler.getModItem(PamsHarvestCraft.ID, "maplesyrupItem", 1L, 0)).noFluidInputs()
                    .noFluidOutputs().duration(10 * SECONDS).eut(2).addTo(sExtractorRecipes);
        ...
        if (Natura.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Natura.ID, "florasapling", 1L, 5))
                    .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 1L)).noFluidInputs()
                    .noFluidOutputs().duration(5 * SECONDS).eut(TierEU.RECIPE_MV).addTo(sExtractorRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Natura.ID, "florasapling", 2L, 7))
                    .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Gunpowder, 1L)).noFluidInputs()
                    .noFluidOutputs().duration(5 * SECONDS).eut(TierEU.RECIPE_MV).addTo(sExtractorRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Natura.ID, "florasapling", 2L, 6))
                    .itemOutputs(ItemList.IC2_Fertilizer.get(1)).noFluidInputs().noFluidOutputs().duration(5 * SECONDS)
                    .eut(TierEU.RECIPE_MV).addTo(sExtractorRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Natura.ID, "Natura.netherfood", 1L, 0))
                    .itemOutputs(ItemList.IC2_Fertilizer.get(4)).noFluidInputs().noFluidOutputs().duration(5 * SECONDS)
                    .eut(TierEU.RECIPE_MV).addTo(sExtractorRecipes);

            GT_Values.RA.stdBuilder().itemInputs(GT_ModHandler.getModItem(Natura.ID, "florasapling", 2L, 4))
                    .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Bone, 1L)).noFluidInputs()
                    .noFluidOutputs().duration(5 * SECONDS).eut(TierEU.RECIPE_MV).addTo(sExtractorRecipes);
