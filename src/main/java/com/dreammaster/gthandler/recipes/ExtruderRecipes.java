...
public class ExtruderRecipes implements Runnable {
    ...
    public void run() {
        GT_Values.RA.stdBuilder()
                ...
                .duration(10 * SECONDS).eut(90).addTo(sExtruderRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(4 * TICKS).eut(TierEU.RECIPE_MV).addTo(sExtruderRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(8 * TICKS).eut(TierEU.RECIPE_MV).addTo(sExtruderRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(1 * SECONDS + 4 * TICKS).eut(TierEU.RECIPE_MV).addTo(sExtruderRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(2 * SECONDS + 8 * TICKS).eut(TierEU.RECIPE_MV).addTo(sExtruderRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(4 * SECONDS + 16 * TICKS).eut(TierEU.RECIPE_MV).addTo(sExtruderRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(7 * SECONDS + 10 * TICKS).eut(TierEU.RECIPE_MV).addTo(sExtruderRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .eut(TierEU.RECIPE_LV).addTo(sExtruderRecipes);
    }
}
