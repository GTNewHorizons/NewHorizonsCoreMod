...
public class ExtruderRecipes implements Runnable {
    ...
    public void run() {
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.stick, Materials.AnnealedCopper, 2L))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemList.Shape_Extruder_Rod.get(0L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.stick, Materials.WroughtIron, 2L))
                .duration(10 * SECONDS).eut(90).addTo(extruderRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.pipeTiny, Materials.WroughtIron, 2L))
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.pipeSmall, Materials.WroughtIron, 1L))
                .duration(8 * TICKS).eut(TierEU.RECIPE_MV).addTo(extruderRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron, 3L),
                        ItemList.Shape_Extruder_Pipe_Medium.get(0L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.pipeMedium, Materials.WroughtIron, 1L))
                .duration(1 * SECONDS + 4 * TICKS).eut(TierEU.RECIPE_MV).addTo(extruderRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron, 6L),
                        ItemList.Shape_Extruder_Pipe_Large.get(0L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.pipeLarge, Materials.WroughtIron, 1L))
                .duration(2 * SECONDS + 8 * TICKS).eut(TierEU.RECIPE_MV).addTo(extruderRecipes);

        GTValues.RA.stdBuilder()
                .itemInputs(
                        GTOreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron, 12L),
                        ItemList.Shape_Extruder_Pipe_Huge.get(0L))
                .itemOutputs(GTOreDictUnificator.get(OrePrefixes.pipeHuge, Materials.WroughtIron, 1L))
