...
public class FluidSolidifierRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Ball.get(0L))
                ...
                .duration(20 * TICKS).eut(16).addTo(sFluidExtractionRecipes);
        ...
        if (TinkerConstruct.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(ItemList.Shape_Mold_Ball.get(0L))
                    ...
                    .duration(20 * TICKS).eut(8).addTo(sFluidExtractionRecipes);
            ...
            GT_Values.RA.stdBuilder().itemInputs(GT_Utility.getIntegratedCircuit(1))
                    ...
                    .duration(20 * TICKS).eut(48).addTo(sFluidExtractionRecipes);
            ...
            GT_Values.RA.stdBuilder()
                    ...
                    .noFluidOutputs().duration(20 * TICKS).eut(TierEU.RECIPE_MV).addTo(sFluidExtractionRecipes);
