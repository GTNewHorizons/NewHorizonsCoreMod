...
public class FluidSolidifierRecipes implements Runnable {
    ...
    public void run() {
        ...
        if (TinkerConstruct.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                    .itemInputs(com.dreammaster.item.ItemList.MoldFormAnvil.getIS(1))
