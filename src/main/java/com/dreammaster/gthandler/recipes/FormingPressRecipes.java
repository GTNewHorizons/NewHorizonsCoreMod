...
public class FormingPressRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.UV, 1),
                        GT_Utility.getIntegratedCircuit(24))
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.UMV, 1),
                        GT_Utility.getIntegratedCircuit(24))
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.MAX, 1),
                        GT_Utility.getIntegratedCircuit(24))
