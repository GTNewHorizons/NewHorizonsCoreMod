...
public class NeutroniumCompressorRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder().itemInputs(
                ...
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 1)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
        ...
        GT_Values.RA.stdBuilder().itemInputs(
                ...
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 2)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(7296, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Redstone, 1)))
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 3)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility
                        .copyAmountUnsafe(1215, GT_OreDictUnificator.get(OrePrefixes.block, Materials.NetherQuartz, 1)))
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 4)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(3648, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Copper, 1)))
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 5)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(3648, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Tin, 1)))
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 6)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(3648, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Lead, 1)))
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 7)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(7296, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Silver, 1)))
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 8)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(3648, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Nickel, 1)))
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 9)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(608, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Enderium, 1)))
                .itemOutputs(getModItem(Avaritia.ID, "Singularity", 1L, 10)).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
        ...
        GT_Values.RA.stdBuilder().itemInputs(
                ...
                .itemOutputs(getModItem(UniversalSingularities.ID, "universal.draconicEvolution.singularity", 1, 0))
                .duration(3 * SECONDS).eut(TierEU.RECIPE_HV).addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_Utility.copyAmountUnsafe(
                ...
                .itemOutputs(getModItem(UniversalSingularities.ID, "universal.draconicEvolution.singularity", 1, 1))
                .duration(3 * SECONDS).eut(TierEU.RECIPE_HV).addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_Utility.copyAmountUnsafe(
        ...
        GT_Values.RA.stdBuilder().itemInputs(
                ...
                .itemOutputs(getModItem(UniversalSingularities.ID, "universal.extraUtilities.singularity", 1, 0))
                .duration(3 * SECONDS).eut(TierEU.RECIPE_HV).addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 0))
                .duration(3 * SECONDS).eut(TierEU.RECIPE_HV).addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(229, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Alumite, 1)))
                .itemOutputs(getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 1))
                .duration(3 * SECONDS).eut(TierEU.RECIPE_HV).addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(304, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Ardite, 1)))
                .itemOutputs(getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 2))
                .duration(3 * SECONDS).eut(TierEU.RECIPE_HV).addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(1824, GT_OreDictUnificator.get(OrePrefixes.block, Materials.Cobalt, 1)))
                .itemOutputs(getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 3))
                .duration(3 * SECONDS).eut(TierEU.RECIPE_HV).addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                GT_Utility.copyAmountUnsafe(608, GT_OreDictUnificator.get(OrePrefixes.block, Materials.EnderPearl, 1)))
                .itemOutputs(getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1, 4))
                .duration(3 * SECONDS).eut(TierEU.RECIPE_HV).addTo(neutroniumCompressorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
        ...
        GT_Values.RA.stdBuilder().fluidInputs((MaterialsUEVplus.SpaceTime).getMolten(72))
                .itemOutputs(getModItem(EternalSingularity.ID, "eternal_singularity", 1, 0)).metadata(BLACKHOLE, 1).duration(3 * SECONDS).eut(TierEU.RECIPE_HV)
                .addTo(neutroniumCompressorRecipes);
    }
}
