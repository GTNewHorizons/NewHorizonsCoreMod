...
public class SolarFactoryRecipes implements Runnable {
    ...
    public List<GTRecipeBuilder> SolarFactoryRawRecipes = new ArrayList<>() {

        {
            if (EnderIO.isModLoaded() && AdvancedSolarPanel.isModLoaded()) {
            ...
            if (AdvancedSolarPanel.isModLoaded()) {
                add(
                        GTValues.RA.stdBuilder()
                                ...
                                .duration(30 * SECONDS).eut(TierEU.RECIPE_HV));
                ...
                add(
                        GTValues.RA.stdBuilder()
                                ...
                                .duration(30 * SECONDS).eut(TierEU.RECIPE_EV));
            }
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .duration(30 * SECONDS).eut(TierEU.RECIPE_IV));
            ...
            if (AdvancedSolarPanel.isModLoaded()) {
                add(
                        GTValues.RA.stdBuilder()
                                ...
                                .metadata(data, new SolarFactoryRecipeData(0, 0, 2)).duration(30 * SECONDS)
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .metadata(data, new SolarFactoryRecipeData(0, 0, 3)).duration(30 * SECONDS)
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .metadata(data, new SolarFactoryRecipeData(2, 4)).duration(10 * SECONDS)
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .fluidInputs(Materials.Epoxid.getMolten(2 * 144))
                            .metadata(data, new SolarFactoryRecipeData(2, 4)).duration(10 * SECONDS)
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .metadata(data, new SolarFactoryRecipeData(3, 4)).duration(10 * SECONDS)
                            .eut(TierEU.RECIPE_LuV));
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .metadata(data, new SolarFactoryRecipeData(3, 8)).duration(10 * SECONDS)
                            .eut(TierEU.RECIPE_ZPM));
            ...
            if (AdvancedSolarPanel.isModLoaded() || SuperSolarPanels.isModLoaded()) {
                add(
                        GTValues.RA.stdBuilder()
                                ...
                                .metadata(data, new SolarFactoryRecipeData(4, 8)).duration(10 * SECONDS)
                                .eut(TierEU.RECIPE_UV));
            }
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .fluidInputs(Materials.Kevlar.getMolten(1 * 144))
                            .metadata(data, new SolarFactoryRecipeData(5, 8)).duration(10 * SECONDS)
                            .eut(TierEU.RECIPE_UHV));
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .fluidInputs(Materials.Kevlar.getMolten(2 * 144))
                            .metadata(data, new SolarFactoryRecipeData(5, 4)).duration(10 * SECONDS)
                            .eut(TierEU.RECIPE_UEV));
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .metadata(data, new SolarFactoryRecipeData(2, 4, 2)).duration(10 * SECONDS)
                            .eut(TierEU.RECIPE_HV));
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .itemOutputs(ItemList.Cover_SolarPanel_MV.get(1))
                            .fluidInputs(
                                    Materials.Barium.getMolten(2 * 144),
                                    Materials.MeteoricSteel.getMolten(4 * 144))
                            .metadata(data, new SolarFactoryRecipeData(3, 4, 2)).duration(10 * SECONDS)
                            .eut(TierEU.RECIPE_EV));
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .metadata(data, new SolarFactoryRecipeData(3, 8, 2)).duration(10 * SECONDS)
                            .eut(TierEU.RECIPE_IV));
            ...
            if (AdvancedSolarPanel.isModLoaded()) {
                add(
                        GTValues.RA.stdBuilder()
                                ...
                                .metadata(data, new SolarFactoryRecipeData(4, 8, 2)).duration(10 * SECONDS)
                                .eut(TierEU.RECIPE_LuV));
            }
            ...
            add(
                    GTValues.RA.stdBuilder()
                            ...
                            .metadata(data, new SolarFactoryRecipeData(5, 8, 2)).duration(10 * SECONDS)
                            .eut(TierEU.RECIPE_ZPM));
                ...
                add(
                        GTValues.RA.stdBuilder()
                                .itemInputs(
                                        ...
                                        GTOreDictUnificator
                                                .get(OrePrefixes.plateSuperdense.get(Materials.SiliconSG), 2),
            ...
            if (AdvancedSolarPanel.isModLoaded()) {
                add(
                        GTValues.RA.stdBuilder()
                                ...
                                .metadata(data, new SolarFactoryRecipeData(0, 0, 3)).duration(20 * TICKS)
                                .eut(TierEU.RECIPE_UHV));
            }
