    ...
    public void run() {
        ...
        if (SuperSolarPanels.isModLoaded()) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Polytetrafluoroethylene.getMolten(288)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_HV).fake().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(10 * SECONDS).eut(TierEU.RECIPE_EV).fake().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .duration(10 * SECONDS).eut(TierEU.RECIPE_IV).fake().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(576)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_LuV).fake().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(1152)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_ZPM).fake().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(1728)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_UV).fake().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(2304)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_UHV).fake().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Cover_SolarPanel_UV.get(1)).fluidInputs(new FluidStack(solderIndalloy, 1152))
                    .duration(10 * SECONDS).eut(TierEU.RECIPE_UEV).fake().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Cover_SolarPanel_LV.get(1))
                    .fluidInputs(Materials.Polytetrafluoroethylene.getMolten(288)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_HV).metadata(SOLAR_FACTORY_RECIPE_DATA, new SolarFactoryRecipeData(2, 4))
                    .hidden().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            GTOreDictUnificator.get(OrePrefixes.circuit.get(Materials.EV), 2))
                    .itemOutputs(ItemList.Cover_SolarPanel_MV.get(1)).fluidInputs(Materials.Epoxid.getMolten(576))
                    .duration(10 * SECONDS).eut(TierEU.RECIPE_EV)
                    .metadata(SOLAR_FACTORY_RECIPE_DATA, new SolarFactoryRecipeData(2, 4)).hidden()
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(576)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_IV).metadata(SOLAR_FACTORY_RECIPE_DATA, new SolarFactoryRecipeData(2, 4))
                    .hidden().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Cover_SolarPanel_EV.get(1))
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(576)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_LuV).metadata(SOLAR_FACTORY_RECIPE_DATA, new SolarFactoryRecipeData(3, 4))
                    .hidden().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Cover_SolarPanel_IV.get(1))
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(1152)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_ZPM).metadata(SOLAR_FACTORY_RECIPE_DATA, new SolarFactoryRecipeData(3, 8))
                    .hidden().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Cover_SolarPanel_LuV.get(1))
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(1728)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_UV).metadata(SOLAR_FACTORY_RECIPE_DATA, new SolarFactoryRecipeData(4, 8))
                    .hidden().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(ItemList.Cover_SolarPanel_ZPM.get(1))
                    .fluidInputs(Materials.Polybenzimidazole.getMolten(2304)).duration(10 * SECONDS)
                    .eut(TierEU.RECIPE_UHV).metadata(SOLAR_FACTORY_RECIPE_DATA, new SolarFactoryRecipeData(5, 8))
                    .hidden().addTo(solarFactoryRecipes);
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            GTOreDictUnificator.get(OrePrefixes.plateSuperdense.get(Materials.SiliconSG), 4))
                    .itemOutputs(ItemList.Cover_SolarPanel_UV.get(1)).fluidInputs(new FluidStack(solderIndalloy, 1152))
                    .duration(10 * SECONDS).eut(TierEU.RECIPE_UEV)
                    .metadata(SOLAR_FACTORY_RECIPE_DATA, new SolarFactoryRecipeData(5, 8)).hidden()
                    .addTo(solarFactoryRecipes);
        }
    }
