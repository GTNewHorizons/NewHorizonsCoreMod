...
public enum ItemList
{
    ...
    RuneOfVigorFragment(new ModSimpleBaseItem("ReinforcedTungstenSteelIronPlate", ModTabList.ModGenericTab)),
    RuneOfDefenseFragment(new ModSimpleBaseItem("RuneOfVigorFragment", ModTabList.ModGenericTab)),
