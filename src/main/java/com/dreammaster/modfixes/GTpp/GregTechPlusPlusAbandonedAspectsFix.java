...
public class GregTechPlusPlusAbandonedAspectsFix {
    ...
    static {
        try {
            ...
            Constructor<?> aspectConstructor = mNamedAspectClass.getConstructor(
                    String.class,
                    int.class,
                    Array.newInstance(mAspectClass, 1).getClass(),
            ...
            CUSTOMASPECTCOMPAT[0] = aspectConstructor.newInstance(
                    "custom1",
                    0xEEF0EA,
                    tmpArray[0],
                    new ResourceLocation(Refstrings.MODID + ":textures/thaumcraft/aspect/aequalitas.png"),
                    1);
            // Vesania
            Array.set(tmpArray[1], 0, mAspectClass.getField("MIND").get(null));
            Array.set(tmpArray[1], 1, mAspectClass.getField("TAINT").get(null));
            CUSTOMASPECTCOMPAT[1] = aspectConstructor.newInstance(
                    "custom2",
                    0x1B122C,
                    tmpArray[1],
                    new ResourceLocation(Refstrings.MODID + ":textures/thaumcraft/aspect/vesania.png"),
                    1);
            // Primordium
            Array.set(tmpArray[2], 0, mAspectClass.getField("VOID").get(null));
            Array.set(tmpArray[2], 1, mAspectClass.getField("MOTION").get(null));
            CUSTOMASPECTCOMPAT[2] = aspectConstructor.newInstance(
                    "custom3",
                    0xF7F7DB,
                    tmpArray[2],
                    new ResourceLocation(Refstrings.MODID + ":textures/thaumcraft/aspect/primordium.png"),
                    1);
            // Astrum
            Array.set(tmpArray[3], 0, mAspectClass.getField("LIGHT").get(null));
            Array.set(tmpArray[3], 1, CUSTOMASPECTCOMPAT[2]);
            CUSTOMASPECTCOMPAT[3] = aspectConstructor.newInstance(
                    "custom4",
                    0x2D2C2B,
                    tmpArray[3],
                    new ResourceLocation(Refstrings.MODID + ":textures/thaumcraft/aspect/astrum.png"),
                    1);
            // Gloria
            Array.set(tmpArray[4], 0, mAspectClass.getField("MAN").get(null));
            Array.set(tmpArray[4], 1, mAspectClass.getField("TRAVEL").get(null));
            CUSTOMASPECTCOMPAT[4] = aspectConstructor.newInstance(
                    "custom5",
                    0xFFE980,
                    tmpArray[4],
                    new ResourceLocation(Refstrings.MODID + ":textures/thaumcraft/aspect/gloria.png"),
                    1);
        } catch (Exception e) {
            e.printStackTrace();
        }
