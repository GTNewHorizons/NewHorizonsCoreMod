...
public class ScriptArchitectureCraft implements IScriptLoader {
    ...
    public void loadRecipes() {
        addShapedRecipe(
                getModItem("ArchitectureCraft", "sawbench", 1),
                new Object[] { "screwSteel", getModItem("minecraft", "heavy_weighted_pressure_plate", 1), "screwSteel",
                        getModItem("TConstruct", "trap.barricade.oak", 1),
                        getModItem("ArchitectureCraft", "sawblade", 1),
                        getModItem("TConstruct", "trap.barricade.oak", 1), "craftingToolScrewdriver",
                        getModItem("ArchitectureCraft", "largePulley", 1), "craftingToolHardHammer" });
