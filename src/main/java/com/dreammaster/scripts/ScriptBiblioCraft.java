    ...
    public void loadRecipes() {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            if (i < 7) {
                ...
                addShapelessCraftingRecipe(getModItem("BiblioCraft", "BiblioFancySign", 1, i), new Object[] {
                    getModItem("minecraft", "paper", 1), getModItem("minecraft", "sign", 1), LableB[i]
                });

                addShapedRecipe(getModItem("BiblioCraft", "BiblioWorkbench", 1, i), new Object[] {
                    ink,
                    craftingTable,
                    feather,
                    Bwood[i],
                ...
                addShapedRecipe(getModItem("BiblioCraft", "Bibliotheca", 1, i), new Object[] {
                    planks[i], Bwood[i], planks[i],
                    planks[i], Bwood[i], planks[i],
                    planks[i], Bwood[i], planks[i],
                });

                addShapedRecipe(getModItem("BiblioCraft", "BiblioPotionShelf", 1, i), new Object[] {
                    Bwood[i], Bwood[i], Bwood[i],
                    planks[i], emptyBottle, planks[i],
                    Bwood[i], Bwood[i], Bwood[i],
                });

                addShapedRecipe(getModItem("BiblioCraft", "BiblioShelf", 1, i), new Object[] {
                    Bwood[i], Bwood[i], Bwood[i], null, planks[i], null, Bwood[i], Bwood[i], Bwood[i],
                });

                addShapedRecipe(getModItem("BiblioCraft", "BiblioRack", 1, i), new Object[] {
                    Bwood[i], Bwood[i], Bwood[i],
                    Bwood[i], ironIngot, Bwood[i],
                    Bwood[i], Bwood[i], Bwood[i],
                });

                addShapedRecipe(getModItem("BiblioCraft", "BiblioCase", 1, i), new Object[] {
                    Bwood[i], glass, Bwood[i],
                    Bwood[i], whiteWool, Bwood[i],
                    Bwood[i], Bwood[i], Bwood[i],
                });

                addShapedRecipe(
                        getModItem("BiblioCraft", "BiblioDesk", 1, i),
                        new Object[] {torch, null, feather, Bwood[i], Bwood[i], Bwood[i], planks[i], null, planks[i]});

                addShapedRecipe(
                        getModItem("BiblioCraft", "BiblioTable", 1, i),
                        new Object[] {Bwood[i], Bwood[i], Bwood[i], null, planks[i], null, null, planks[i], null});

                addShapedRecipe(getModItem("BiblioCraft", "BiblioMapFrames", 1, i), new Object[] {
                    stick, stick, stick,
                    stick, Bwood[i], stick,
                    stick, stick, stick
                });
                ...
                addShapedRecipe(
                        ...
                        new Object[] {null, whiteWool, null, null, Bwood[i], null, stick, woodenPressurePlate, stick});
                ...
                addShapelessCraftingRecipe(getModItem("BiblioCraft", "item.seatBack3", 1, i), new Object[] {
                    Bwood[i], getModItem("BiblioCraft", "item.seatBack2", 1, i),
                });

                addShapelessCraftingRecipe(getModItem("BiblioCraft", "item.seatBack5", 1, i), new Object[] {
                    Bwood[i], Bwood[i], getModItem("BiblioCraft", "item.seatBack2", 1, i),
                });
            }
        }
        addShapedRecipe(getModItem("BiblioCraft", "BiblioStuffs", 1, 3), new Object[] {
            "stickWood", "stickWood", "stickWood", "slabWood", "slabWood", "slabWood", null, null, null
        });
        ...
        addShapedRecipe(getModItem("BiblioCraft", "tile.BiblioFramedChest", 1), new Object[] {
            ...
            getModItem("BiblioCraft", "item.FramingSheet", 1),
            "screwIron",
            getModItem("BiblioCraft", "BiblioLabel", 1, 6),
            "screwIron",
            getModItem("BiblioCraft", "item.FramingSheet", 1),
            getModItem("BiblioCraft", "item.FramingSheet", 1),
            getModItem("BiblioCraft", "item.FramingSheet", 1)
        ...
        addShapedRecipe(getModItem("BiblioCraft", "BiblioPaneler", 1), new Object[] {
            ...
            "craftingToolSaw",
            "plateIron",
            getModItem("minecraft", "wooden_slab", 1),
            getMeta02(32470),
            getModItem("minecraft", "wooden_slab", 1),
        ...
        addShapedRecipe(getModItem("BiblioCraft", "BiblioLamp", 1), new Object[] {
            "plateGold",
            getModItem("FloodLights", "electricIncandescentLightBulb", 1),
            "plateGold",
            null,
            "stickGold",
            null,
        ...
        addShapedRecipe(getModItem("BiblioCraft", "BiblioBell", 1), new Object[] {
            null,
            getModItem("minecraft", "stone_button", 1),
            null,
            null,
            "plateIron",
            null,
        ...
        addShapedRecipe(getModItem("BiblioCraft", "BiblioStuffs", 1), new Object[] {
            ...
            "plateAnyRubber",
            null,
            getModItem("minecraft", "glass_pane", 1),
            null,
            getModItem("minecraft", "glass_pane", 1),
            getModItem("minecraft", "glass_pane", 1),
            getModItem("minecraft", "glass_pane", 1),
        ...
        addShapedRecipe(getModItem("BiblioCraft", "BiblioStuffs", 1, 2), new Object[] {
            null, null, null, "plateNetherQuartz", null, "plateNetherQuartz", null, "plateNetherQuartz", null
        });
        ...
        addShapedRecipe(getModItem("BiblioCraft", "item.PaintingCanvas", 1), new Object[] {
            "stickWood",
            getModItem("minecraft", "string", 1),
            "stickWood",
            getModItem("minecraft", "string", 1),
            getModItem("minecraft", "wool", 1),
            getModItem("minecraft", "string", 1),
            "stickWood",
            getModItem("minecraft", "string", 1),
            "stickWood"
        ...
        addShapedRecipe(getModItem("BiblioCraft", "item.BiblioGlasses", 1, 1), new Object[] {
            null, getModItem("BiblioCraft", "item.BiblioGlasses", 1), null, null, "dyeGray", null, null, null, null
        });
        ...
        for (int i = 0; i < 16; i++) {
            addShapedRecipe(TypeWriterB[i], new Object[] {
                "plateRubber",
                getModItem("OpenComputers", "item", 1, 20),
                "plateRubber",
                "ringIron",
                color16[i],
                "ringIron",
            ...
            if (i < 7) {
                ...
                addShapedRecipe(Pedestals[i], new Object[] {
                    null, null, null, "plateIron", "ringIron", "plateIron", "slabStone", cwool16[i], "slabStone"
                });
