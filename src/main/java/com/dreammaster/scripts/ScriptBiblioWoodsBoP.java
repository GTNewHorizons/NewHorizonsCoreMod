...
public class ScriptBiblioWoodsBoP implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        for (int i = 0; i < 14; i++) {
            ...
            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWoodtable", 1, i), new Object[] {
                BOBwood[i], BOBwood[i], BOBwood[i], null, BOPplanks[i], null, null, BOPplanks[i], null
            });
            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWooddesk", 1, i), new Object[] {
                torch, null, feather, BOBwood[i], BOBwood[i], BOBwood[i], BOPplanks[i], null, BOPplanks[i]
            });
            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWoodFancyWorkbench", 1, i), new Object[] {
                ink, craftingTable, feather, BOBwood[i], bookCaseBOP[i], BOBwood[i], BOBwood[i], null, BOBwood[i]
            });

            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWoodFancyWorkbench", 1, i), new Object[] {
                feather, craftingTable, ink, BOBwood[i], bookCaseBOP[i], BOBwood[i], BOBwood[i], BOBwood[i], BOBwood[i]
            });

            addShapedRecipe(bookCaseBOP[i], new Object[] {
                BOPplanks[i], BOBwood[i], BOPplanks[i],
                BOPplanks[i], BOBwood[i], BOPplanks[i],
                BOPplanks[i], BOBwood[i], BOPplanks[i],
            });

            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWoodpotshelf", 1, i), new Object[] {
                BOBwood[i], BOBwood[i], BOBwood[i],
                BOPplanks[i], emptyBottle, BOPplanks[i],
                BOBwood[i], BOBwood[i], BOBwood[i],
            });

            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWoodshelf", 1, i), new Object[] {
                BOBwood[i], BOBwood[i], BOBwood[i], null, BOPplanks[i], null, BOBwood[i], BOBwood[i], BOBwood[i],
            });

            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWoodrack", 1, i), new Object[] {
                BOBwood[i], BOBwood[i], BOBwood[i],
                BOBwood[i], ironIngot, BOBwood[i],
                BOBwood[i], BOBwood[i], BOBwood[i],
            });

            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWoodcase", 1, i), new Object[] {
                BOBwood[i], glass, BOBwood[i],
                BOBwood[i], whiteWool, BOBwood[i],
                BOBwood[i], BOBwood[i], BOBwood[i],
            });

            addShapedRecipe(getModItem("BiblioWoodsBoP", "BiblioWoodMapFrame", 1, i), new Object[] {
                stick, stick, stick,
            ...
            addShapelessCraftingRecipe(getModItem("BiblioWoodsBoP", "seatBack3", 1, i), new Object[] {
                BOBwood[i], getModItem("BiblioWoodsBoP", "seatBack2", 1, i),
            });

            addShapelessCraftingRecipe(getModItem("BiblioWoodsBoP", "seatBack5", 1, i), new Object[] {
                BOBwood[i], BOBwood[i], getModItem("BiblioWoodsBoP", "seatBack2", 1, i),
            });

            addShapelessCraftingRecipe(fancySignBOP[i], new Object[] {
                getModItem("minecraft", "paper", 1), getModItem("minecraft", "sign", 1), LableBOP[i]
            });
        }
    }
}
