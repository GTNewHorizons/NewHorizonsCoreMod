    ...
    public void loadRecipes() {
        ...
        for (int i = 0; i < 13; i++) {
            addShapelessCraftingRecipe(
                    fancySignNatura[i],
                    new Object[] {getModItem("minecraft", "paper", 1), getModItem("minecraft", "sign", 1), LableN[i]});
            ...
            addShapedRecipe(getModItem("BiblioWoodsNatura", "BiblioWoodcase0", 1, i), new Object[] {
                Nwood[i], glass, Nwood[i],
                Nwood[i], whiteWool, Nwood[i],
                Nwood[i], Nwood[i], Nwood[i],
            });

            addShapedRecipe(bookcaseNatura[i], new Object[] {
                Nplanks[i], Nwood[i], Nplanks[i],
                Nplanks[i], Nwood[i], Nplanks[i],
                Nplanks[i], Nwood[i], Nplanks[i],
            });

            addShapedRecipe(getModItem("BiblioWoodsNatura", "BiblioWoodpotshelf", 1, i), new Object[] {
                Nwood[i], Nwood[i], Nwood[i],
                Nplanks[i], emptyBottle, Nplanks[i],
                Nwood[i], Nwood[i], Nwood[i],
            });

            addShapedRecipe(getModItem("BiblioWoodsNatura", "BiblioWoodshelf", 1, i), new Object[] {
                Nwood[i], Nwood[i], Nwood[i], null, Nplanks[i], null, Nwood[i], Nwood[i], Nwood[i],
            });

            addShapedRecipe(getModItem("BiblioWoodsNatura", "BiblioWoodrack", 1, i), new Object[] {
                Nwood[i], Nwood[i], Nwood[i],
            ...
            addShapedRecipe(getModItem("BiblioWoodsNatura", "BiblioWoodFancyWorkbench", 1, i), new Object[] {
                ink,
                craftingTable,
                feather,
                Nwood[i],
                getModItem("BiblioWoodsNatura", "BiblioWoodBookcase", 1, i),
                Nwood[i],
                Nwood[i],
                Nwood[i],
                Nwood[i]
            ...
            addShapedRecipe(getModItem("BiblioWoodsNatura", "BiblioWoodMapFrame", 1, i), new Object[] {
                stick, stick, stick,
                stick, Nwood[i], stick,
                stick, stick, stick
            });
            ...
            addShapelessCraftingRecipe(getModItem("BiblioWoodsNatura", "seatBack3", 1, i), new Object[] {
                Nwood[i], getModItem("BiblioWoodsNatura", "seatBack2", 1, i),
            });

            addShapelessCraftingRecipe(getModItem("BiblioWoodsNatura", "seatBack5", 1, i), new Object[] {
                Nwood[i], Nwood[i], getModItem("BiblioWoodsNatura", "seatBack2", 1, i),
            });
        }
    }
}
