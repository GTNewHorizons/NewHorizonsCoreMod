...
public class ScriptBiblioWoodsNatura implements IScriptLoader {
    ...
    public void loadRecipes() {
        ItemStack[] FClockN = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodClock", 1),
        ...
        ItemStack[] Nwood = new ItemStack[] { getModItem("Natura", "plankSlab1", 1, 4),
                getModItem("Natura", "plankSlab2", 1, 3), getModItem("Natura", "plankSlab1", 1),
                getModItem("Natura", "plankSlab2", 1, 4), getModItem("Natura", "plankSlab1", 1, 2),
                getModItem("Natura", "plankSlab1", 1, 5), getModItem("Natura", "plankSlab1", 1, 6),
                getModItem("Natura", "plankSlab2", 1), getModItem("Natura", "plankSlab1", 1, 3),
                getModItem("Natura", "plankSlab1", 1, 7), getModItem("Natura", "plankSlab1", 1, 1),
                getModItem("Natura", "plankSlab2", 1, 1), getModItem("Natura", "plankSlab2", 1, 2) };

        ItemStack[] PaintingN = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodPaintingT0", 1),
        ...
        ItemStack[] NPT1 = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodPaintingT1", 1),
        ...
        ItemStack[] NPT2 = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodPaintingT2", 1),
        ...
        ItemStack[] NPT3 = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodPaintingT3", 1),
        ...
        ItemStack[] NPT4 = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodPaintingT4", 1),
        ...
        ItemStack[] FrameN = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodMapFrame", 1),
        ...
        ItemStack[] fancySignNatura = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodFancySign", 1),
        ...
        ItemStack[] LableN = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodlabel", 1),
        ...
        ItemStack[] bookcaseNatura = new ItemStack[] { getModItem("BiblioWoodsNatura", "BiblioWoodBookcase", 1),
        ...
        ItemStack[] Nplanks = new ItemStack[] { getModItem("Natura", "planks", 1, 4),
                getModItem("Natura", "planks", 1, 11), getModItem("Natura", "planks", 1, 0),
                getModItem("Natura", "planks", 1, 12), getModItem("Natura", "planks", 1, 2),
                getModItem("Natura", "planks", 1, 5), getModItem("Natura", "planks", 1, 6),
                getModItem("Natura", "planks", 1, 8), getModItem("Natura", "planks", 1, 3),
                getModItem("Natura", "planks", 1, 7), getModItem("Natura", "planks", 1, 1),
                getModItem("Natura", "planks", 1, 9), getModItem("Natura", "planks", 1, 10) };
        ...
        for (int i = 0; i < 13; i++) {
            ...
            addShapedRecipe(
                    FClockN[i],
                    new Object[] { Nwood[i], getModItem("minecraft", "clock", 1), Nwood[i], Nwood[i], "stickWood",
                            Nwood[i], Nwood[i], "plateGold", Nwood[i] });
            addShapedRecipe(
                    PaintingN[i],
                    new Object[] { Nwood[i], Nwood[i], Nwood[i], Nwood[i],
                            getModItem("BiblioCraft", "item.PaintingCanvas", 1), Nwood[i], Nwood[i], Nwood[i],
                            Nwood[i] });
            addShapedRecipe(
                    NPT1[i],
            ...
            addShapedRecipe(
                    getModItem("BiblioWoodsNatura", "BiblioWoodcase0", 1, i),
            ...
            addShapedRecipe(
                    getModItem("BiblioWoodsNatura", "BiblioWoodpotshelf", 1, i),
                    new Object[] { Nwood[i], Nwood[i], Nwood[i], Nplanks[i], emptyBottle, Nplanks[i], Nwood[i],
                            Nwood[i], Nwood[i], });

            addShapedRecipe(
                    getModItem("BiblioWoodsNatura", "BiblioWoodshelf", 1, i),
                    new Object[] { Nwood[i], Nwood[i], Nwood[i], null, Nplanks[i], null, Nwood[i], Nwood[i],
                            Nwood[i], });

            addShapedRecipe(
                    getModItem("BiblioWoodsNatura", "BiblioWoodrack", 1, i),
            ...
            addShapedRecipe(
                    getModItem("BiblioWoodsNatura", "BiblioWooddesk", 1, i),
                    new Object[] { torch, null, feather, Nwood[i], Nwood[i], Nwood[i], Nplanks[i], null, Nplanks[i] });

            addShapedRecipe(
                    getModItem("BiblioWoodsNatura", "BiblioWoodtable", 1, i),
                    new Object[] { Nwood[i], Nwood[i], Nwood[i], null, Nplanks[i], null, null, Nplanks[i], null });

            addShapedRecipe(
                    getModItem("BiblioWoodsNatura", "BiblioWoodFancyWorkbench", 1, i),
                    new Object[] { ink, craftingTable, feather, Nwood[i],
                            getModItem("BiblioWoodsNatura", "BiblioWoodBookcase", 1, i), Nwood[i], Nwood[i], Nwood[i],
                            Nwood[i] });
            ...
            addShapedRecipe(
                    getModItem("BiblioWoodsNatura", "seatBack4", 1, i),
                    new Object[] { null, whiteWool, null, null, Nwood[i], null, null, null, null });

            addShapelessCraftingRecipe(
                    getModItem("BiblioWoodsNatura", "seatBack3", 1, i),
                    new Object[] { Nwood[i], getModItem("BiblioWoodsNatura", "seatBack2", 1, i), });

            addShapelessCraftingRecipe(
                    getModItem("BiblioWoodsNatura", "seatBack5", 1, i),
                    new Object[] { Nwood[i], Nwood[i], getModItem("BiblioWoodsNatura", "seatBack2", 1, i), });
        }
    }
}
