...
public class ScriptBotany implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.rubber", 288)).duration(800).eut(64)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 144)).duration(1200).eut(64)
                .addTo(sAssemblerRecipes);
