...
public class ScriptBuildCraft implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("for.honey", 400)).duration(300).eut(48)
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(Forestry.ID, "propolis", 2, 0, missing))
                .itemOutputs(getModItem(BuildCraftCompat.ID, "item.buildcraftPipe.pipeitemspropolis", 1, 0, missing))
                .fluidInputs(FluidRegistry.getFluidStack("honey", 400)).duration(300).eut(48).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "redstone_torch", 1, 0, missing),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 30, missing))
                .itemOutputs(getModItem(BuildCraftCore.ID, "markerBlock", 1, 0, missing)).duration(100).eut(120)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "redstone_torch", 1, 0, missing),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 24, missing))
                .itemOutputs(getModItem(BuildCraftCore.ID, "pathMarkerBlock", 1, 0, missing)).duration(100).eut(120)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("squidink", 144)).duration(100).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "paper", 1, 0, missing),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("dye.watermixed.dyeblue", 144)).duration(100).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Railcraft.ID, "glass", 1, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Iron, 2L))
                .itemOutputs(getModItem(BuildCraftFactory.ID, "tankBlock", 1, 0, missing)).duration(100).eut(8)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(ExtraUtilities.ID, "decorativeBlock2", 1, 5, missing),
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 144)).duration(200).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(getModItem(BuildCraftRobotics.ID, "robotStation", 1, 0, missing)).duration(300).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(getModItem(Minecraft.ID, "paper", 8, 0, missing), ItemList.Color_11.get(1L))
                .itemOutputs(getModItem(BuildCraftCore.ID, "mapLocation", 1, 0, missing)).duration(200).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(BuildCraftCore.ID, "wrenchItem", 1, 0, missing),
                        getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1, 0, missing))
                .itemOutputs(getModItem(BuildCraftTransport.ID, "gateCopier", 1, 0, missing)).duration(100).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .duration(400).eut(480).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedTransportation.ID, "projectred.transportation.pipe", 16, 0, missing),
                        getModItem(ProjectRedTransportation.ID, "projectred.transportation.pipe", 1, 1, missing))
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        ItemList.Electric_Motor_LV.get(1L))
                .itemOutputs(getModItem(BuildCraftFactory.ID, "autoWorkbenchBlock", 1, 0, missing)).duration(200)
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1, 0, missing))
                .itemOutputs(getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1, 7, missing)).duration(200).eut(480)
                .addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(getModItem(BuildCraftSilicon.ID, "redstoneCrystal", 1, 0, missing)).duration(600).eut(120)
