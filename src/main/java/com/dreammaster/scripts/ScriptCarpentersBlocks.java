...
public class ScriptCarpentersBlocks implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 4, 0, missing)).duration(100)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Wood, 3L),
                        GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Iron, 1L))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 8, 0, missing)).duration(100)
                .eut(30).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Wood, 3L),
                        GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Steel, 1L))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 12, 0, missing)).duration(100)
                .eut(48).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Wood, 3L),
                        GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Aluminium, 1L))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 16, 0, missing)).duration(100)
                .eut(64).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Wood, 3L),
                        GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 1L))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 20, 0, missing)).duration(100)
                .eut(64).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Wood, 3L),
                        GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Titanium, 1L))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 24, 0, missing)).duration(100)
                .eut(64).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "fence", 1, 0, missing),
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBarrier", 2, 0, missing)).duration(200)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        getModItem(Minecraft.ID, "flower_pot", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersFlowerPot", 1, 0, missing)).duration(100)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Iron, 1L))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersGarageDoor", 2, 0, missing)).duration(150)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Steel, 1L))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersGarageDoor", 4, 0, missing)).duration(300)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "fence_gate", 1, 0, missing),
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersGate", 1, 0, missing)).duration(100)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        getModItem(Minecraft.ID, "trapdoor", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersHatch", 1, 0, missing)).duration(100)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        getModItem(Minecraft.ID, "ladder", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersLadder", 1, 0, missing)).duration(100)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        getModItem(Minecraft.ID, "lever", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersLever", 1, 0, missing)).duration(50)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersCollapsibleBlock", 3, 0, missing),
                        getModItem(IndustrialCraft2.ID, "blockPersonal", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersSafe", 1, 0, missing)).duration(300)
                .eut(30).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        getModItem(Minecraft.ID, "torch", 10, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersTorch", 10, 0, missing)).duration(100)
                .eut(16).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        getModItem(TinkerConstruct.ID, "chiselHead", 1, 2, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "itemCarpentersChisel", 1, 0, missing)).duration(200)
                .eut(30).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.toolHeadHammer, Materials.Iron, 1L))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "itemCarpentersHammer", 1, 0, missing)).duration(200)
                .eut(30).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersPressurePlate", 1, 0, missing),
                        getModItem(Minecraft.ID, "clay_ball", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "itemCarpentersTile", 2, 0, missing)).duration(50).eut(16)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing),
                        getModItem(Minecraft.ID, "wooden_door", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "itemCarpentersDoor", 1, 0, missing)).duration(150).eut(16)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 2, 0, missing),
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("water", 20)).duration(100).eut(30).addTo(sCutterRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(getModItem(CarpentersBlocks.ID, "blockCarpentersPressurePlate", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersButton", 4, 0, missing))
                .fluidInputs(FluidRegistry.getFluidStack("ic2distilledwater", 10)).duration(100).eut(30)
        ...
        GT_Values.RA.stdBuilder().itemInputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing))
                ...
                .fluidInputs(FluidRegistry.getFluidStack("water", 20)).duration(100).eut(16).addTo(sCutterRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersSlope", 4, 0, missing))
                .fluidInputs(FluidRegistry.getFluidStack("ic2distilledwater", 10)).duration(100).eut(16)
                .addTo(sCutterRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(CarpentersBlocks.ID, "blockCarpentersBlock", 1, 0, missing))
                .itemOutputs(getModItem(CarpentersBlocks.ID, "blockCarpentersSlope", 4, 0, missing))
                .fluidInputs(FluidRegistry.getFluidStack("lubricant", 2)).duration(50).eut(16).addTo(sCutterRecipes);
