...
public class ScriptCatWalk implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(CatWalks.ID, "steelgrate", 10, 0, missing)).duration(100).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 6L),
                        getModItem(CatWalks.ID, "steelgrate", 4, 0, missing))
                .itemOutputs(getModItem(CatWalks.ID, "support_column", 4, 0, missing)).duration(300).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CatWalks.ID, "steelgrate", 3, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Steel, 2L))
                .itemOutputs(getModItem(CatWalks.ID, "catwalk_unlit", 6, 0, missing)).duration(300).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Steel, 1L),
                        getModItem(CatWalks.ID, "steelgrate", 1, 0, missing))
                .itemOutputs(getModItem(CatWalks.ID, "scaffold", 1, 0, missing)).duration(100).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(CatWalks.ID, "steelgrate", 4, 0, missing),
                        getModItem(Minecraft.ID, "ladder", 1, 0, missing))
                .itemOutputs(getModItem(CatWalks.ID, "cagedLadder_north_unlit", 6, 0, missing)).duration(300).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "rail", 1, 0, missing),
                        getModItem(CatWalks.ID, "steelgrate", 1, 0, missing))
                .itemOutputs(getModItem(CatWalks.ID, "sturdy_rail", 1, 0, missing)).duration(150).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "activator_rail", 1, 0, missing),
                        getModItem(CatWalks.ID, "steelgrate", 1, 0, missing))
                .itemOutputs(getModItem(CatWalks.ID, "sturdy_rail_activator", 1, 0, missing)).duration(150).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "detector_rail", 1, 0, missing),
                        getModItem(CatWalks.ID, "steelgrate", 1, 0, missing))
                .itemOutputs(getModItem(CatWalks.ID, "sturdy_rail_detector", 1, 0, missing)).duration(150).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "golden_rail", 1, 0, missing),
                        getModItem(CatWalks.ID, "steelgrate", 1, 0, missing))
                .itemOutputs(getModItem(CatWalks.ID, "sturdy_rail_powered", 1, 0, missing)).duration(150).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Steel, 2L),
                        getModItem(Minecraft.ID, "glowstone_dust", 1, 0, missing))
                .itemOutputs(getModItem(CatWalks.ID, "ropeLight", 8, 0, missing)).duration(100).eut(16)
                .addTo(sAssemblerRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(getModItem(CatWalks.ID, "scaffold", 1, 0, missing))
                ...
                .outputChances(10000, 10000).duration(300).eut(2).addTo(sMaceratorRecipes);
