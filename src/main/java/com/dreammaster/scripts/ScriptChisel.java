...
public class ScriptChisel implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        ChiselHelper.addVariationFromStack("marble", new ItemStack(GregTech_API.sBlockStones, 1, 0));
        ChiselHelper.addVariationFromStack("marble", new ItemStack(GregTech_API.sBlockStones, 1, 1));
        ChiselHelper.addVariationFromStack("marble", new ItemStack(GregTech_API.sBlockStones, 1, 2));
        ChiselHelper.addVariationFromStack("marble", new ItemStack(GregTech_API.sBlockStones, 1, 3));
        ChiselHelper.addVariationFromStack("marble", new ItemStack(GregTech_API.sBlockStones, 1, 4));
        ChiselHelper.addVariationFromStack("marble", new ItemStack(GregTech_API.sBlockStones, 1, 5));
        ChiselHelper.addVariationFromStack("marble", new ItemStack(GregTech_API.sBlockStones, 1, 6));
        ChiselHelper.addVariationFromStack("marble", new ItemStack(GregTech_API.sBlockStones, 1, 7));
        ...
        ChiselHelper.addVariationFromStack("RCAbyssalBlock", new ItemStack(GregTech_API.sBlockGranites, 1, 1));
        ChiselHelper.addVariationFromStack("RCAbyssalBlock", new ItemStack(GregTech_API.sBlockGranites, 1, 2));
        ChiselHelper.addVariationFromStack("RCAbyssalBlock", new ItemStack(GregTech_API.sBlockGranites, 1, 3));
        ChiselHelper.addVariationFromStack("RCAbyssalBlock", new ItemStack(GregTech_API.sBlockGranites, 1, 4));
        ChiselHelper.addVariationFromStack("RCAbyssalBlock", new ItemStack(GregTech_API.sBlockGranites, 1, 5));
        ChiselHelper.addVariationFromStack("RCAbyssalBlock", new ItemStack(GregTech_API.sBlockGranites, 1, 6));
        ChiselHelper.addVariationFromStack("RCAbyssalBlock", new ItemStack(GregTech_API.sBlockGranites, 1, 7));
        ChiselHelper.addGroup("basalts");
        ChiselHelper.addVariationFromStack("basalts", new ItemStack(GregTech_API.sBlockStones, 1, 8));
        ChiselHelper.addVariationFromStack("basalts", new ItemStack(GregTech_API.sBlockStones, 1, 9));
        ChiselHelper.addVariationFromStack("basalts", new ItemStack(GregTech_API.sBlockStones, 1, 10));
        ChiselHelper.addVariationFromStack("basalts", new ItemStack(GregTech_API.sBlockStones, 1, 11));
        ChiselHelper.addVariationFromStack("basalts", new ItemStack(GregTech_API.sBlockStones, 1, 12));
        ChiselHelper.addVariationFromStack("basalts", new ItemStack(GregTech_API.sBlockStones, 1, 13));
        ChiselHelper.addVariationFromStack("basalts", new ItemStack(GregTech_API.sBlockStones, 1, 14));
        ChiselHelper.addVariationFromStack("basalts", new ItemStack(GregTech_API.sBlockStones, 1, 15));
        ChiselHelper.addVariationFromStack(
                "basalts",
        ...
        ChiselHelper.addVariationFromStack("redgranite", new ItemStack(GregTech_API.sBlockGranites, 1, 9));
        ChiselHelper.addVariationFromStack("redgranite", new ItemStack(GregTech_API.sBlockGranites, 1, 10));
        ChiselHelper.addVariationFromStack("redgranite", new ItemStack(GregTech_API.sBlockGranites, 1, 11));
        ChiselHelper.addVariationFromStack("redgranite", new ItemStack(GregTech_API.sBlockGranites, 1, 12));
        ChiselHelper.addVariationFromStack("redgranite", new ItemStack(GregTech_API.sBlockGranites, 1, 13));
        ChiselHelper.addVariationFromStack("redgranite", new ItemStack(GregTech_API.sBlockGranites, 1, 14));
        ChiselHelper.addVariationFromStack("redgranite", new ItemStack(GregTech_API.sBlockGranites, 1, 15));
        ChiselHelper.addVariationFromStack("limestone", getModItem(BiomesOPlenty.ID, "rocks", 1, 0, missing));
        ChiselHelper.addVariationFromStack("amber", new ItemStack(GregTech_API.sBlockGem1, 1, 1));
        ...
        ChiselHelper.addVariationFromStack("concrete", new ItemStack(GregTech_API.sBlockConcretes, 1, 8));
        ...
        ChiselHelper.addVariationFromStack("aluminumblock", new ItemStack(GregTech_API.sBlockMetal1, 1, 1));
        ...
        ChiselHelper.addVariationFromStack("blazeblock", new ItemStack(GregTech_API.sBlockGem3, 1, 5));
        ...
        ChiselHelper.addVariationFromStack("steeleafblock", new ItemStack(GregTech_API.sBlockMetal8, 1, 12));
        ChiselHelper.addGroup("knightmetalblock");
        ChiselHelper.addVariationFromStack(
                "knightmetalblock",
                getModItem(TwilightForest.ID, "tile.KnightmetalBlock", 1, 0, missing));
        ChiselHelper.addVariationFromStack("knightmetalblock", new ItemStack(GregTech_API.sBlockMetal4, 1, 0));
        ChiselHelper.addGroup("ironwoodblock");
        ChiselHelper.addVariationFromStack(
                "ironwoodblock",
                getModItem(TwilightForest.ID, "tile.IronwoodBlock", 1, 0, missing));
        ChiselHelper.addVariationFromStack("ironwoodblock", new ItemStack(GregTech_API.sBlockMetal3, 1, 14));
        ...
        ChiselHelper.addVariationFromStack("fieryblock", new ItemStack(GregTech_API.sBlockMetal3, 1, 4));
    }
}
