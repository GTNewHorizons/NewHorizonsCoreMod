...
public class ScriptCoreMod implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.alpha", 1, 7, missing))
                .itemOutputs(CustomItemList.CokeOvenBrick.get(4L)).duration(300).eut(2).addTo(sExtractorRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(Railcraft.ID, "machine.alpha", 1, 12, missing))
                .itemOutputs(CustomItemList.AdvancedCokeOvenBrick.get(4L)).duration(300).eut(2)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(2000).eut(TierEU.RECIPE_UV).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(
                        getModItem(
                                ...
                                0,
                                missing))
                .duration(2400).eut(TierEU.RECIPE_UHV).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder().itemInputs(
                ...
                .duration(2800).eut(8000000).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.steel", 144)).duration(200).eut(4)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.aluminium", 144)).duration(250).eut(16)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(IndustrialCraft2.ID, "blockAlloy", 1, 0, missing),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.platinum", 144)).duration(300).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(IndustrialCraft2.ID, "blockAlloy", 1, 0, missing),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.iridium", 144)).duration(350).eut(64)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(IndustrialCraft2.ID, "blockAlloy", 1, 0, missing),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.osmium", 144)).duration(450).eut(256)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(IndustrialCraft2.ID, "blockAlloy", 1, 0, missing),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.naquadria", 144)).duration(500).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.LightBinding", 1, 0, missing)).duration(600)
                .eut(480).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(NewHorizonsCoreMod.ID, "item.RawBioFiber", 2, 0, missing),
                        GT_Utility.getIntegratedCircuit(2))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.BioOrganicMesh", 1, 0, missing)).duration(800)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.BioChunk", 1, 0, missing)).duration(1200).eut(64)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Diamond, 4L),
                        GT_Utility.getIntegratedCircuit(4))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "tile.DiamondFrameBox", 1, 0, missing)).duration(64)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "tile.CompressedGraphite", 2, 0, missing)).duration(100)
                .eut(8).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(RemoteIO.ID, "item.chip.location", 1, 0, missing),
                        getModItem(RemoteIO.ID, "item.blank_plate", 1, 0, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.BlankPlatedChip", 1, 0, missing)).duration(100)
                .eut(480).addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.LogicProcessorItemGoldCore.get(1L)).duration(100).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(AppliedEnergistics2.ID, "item.ItemMultiMaterial", 1, 24, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.DiamondCoreChip", 1, 0, missing))
                .itemOutputs(CustomItemList.EngineeringProcessorItemDiamondCore.get(1L)).duration(100).eut(1920)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(AppliedEnergistics2.ID, "item.ItemMultiMaterial", 1, 24, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.EmeraldAdvancedCoreChip", 1, 0, missing))
                .itemOutputs(CustomItemList.EngineeringProcessorItemEmeraldCore.get(1L)).duration(100).eut(7680)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(AppliedEnergistics2.ID, "item.ItemMultiMaterial", 1, 24, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.EmeraldHighAdvancedCoreChip", 1, 0, missing))
                .itemOutputs(CustomItemList.EngineeringProcessorItemAdvEmeraldCore.get(1L)).duration(100).eut(30720)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("ic2coolant", 2000)).duration(600).eut(1024)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 144)).duration(600).eut(120)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 288)).duration(600).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.ReinforcedTitaniumIronPlate.get(1L),
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 576)).duration(600).eut(1920)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 1152)).duration(600).eut(7680)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 2304)).duration(600).eut(30720)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 4608)).duration(600).eut(122880)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 9216)).duration(600)
        ...
        GT_Values.RA.stdBuilder().itemInputs(
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 18432)).duration(600)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.solderingalloy", 36864)).duration(600).eut(8000000)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("water", 1000)).duration(3600).eut(480)
                .addTo(sAutoclaveRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.MysteriousCrystal, 1L))
                .itemOutputs(getModItem(GalaxySpace.ID, "item.UnknowCrystal", 1, 0, missing)).outputChances(9000)
                .fluidInputs(FluidRegistry.getFluidStack("ic2distilledwater", 800)).duration(2400).eut(480)
                .addTo(sAutoclaveRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.MysteriousCrystal, 1L))
                .itemOutputs(getModItem(GalaxySpace.ID, "item.UnknowCrystal", 1, 0, missing)).outputChances(10000)
                .fluidInputs(FluidRegistry.getFluidStack("molten.void", 288)).duration(1200).eut(480)
                .addTo(sAutoclaveRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(IndustrialCraft2.ID, "itemFuelPlantBall", 16, 0, missing))
                ...
                .fluidInputs(FluidRegistry.getFluidStack("ic2biomass", 8)).duration(200).eut(20)
                .addTo(sAutoclaveRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(IndustrialCraft2.ID, "itemFuelPlantBall", 16, 0, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.RawBioFiber", 1, 0, missing)).outputChances(5000)
                .fluidInputs(FluidRegistry.getFluidStack("methanol", 8)).duration(150).eut(20).addTo(sAutoclaveRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(IndustrialCraft2.ID, "itemFuelPlantBall", 16, 0, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.RawBioFiber", 1, 0, missing)).outputChances(9000)
                .fluidInputs(FluidRegistry.getFluidStack("fuel", 8)).duration(100).eut(20).addTo(sAutoclaveRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(IndustrialCraft2.ID, "itemFuelPlantBall", 16, 0, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.RawBioFiber", 1, 0, missing)).outputChances(10000)
                .fluidInputs(FluidRegistry.getFluidStack("nitrofuel", 8)).duration(50).eut(20).addTo(sAutoclaveRecipes);
        ...
        GT_Values.RA.stdBuilder().itemInputs(getModItem(IndustrialCraft2.ID, "itemPartIridium", 1, 0, missing))
                ...
                .fluidInputs(FluidRegistry.getFluidStack("water", 288)).duration(1200).eut(256).addTo(sCutterRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(IndustrialCraft2.ID, "itemPartIridium", 1, 0, missing))
                .itemOutputs(CustomItemList.IridiumAlloyItemCasing.get(2L))
                .fluidInputs(FluidRegistry.getFluidStack("ic2distilledwater", 160)).duration(1200).eut(256)
                .addTo(sCutterRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(IndustrialCraft2.ID, "itemPartIridium", 1, 0, missing))
                .itemOutputs(CustomItemList.IridiumAlloyItemCasing.get(2L))
                .fluidInputs(FluidRegistry.getFluidStack("lubricant", 64)).duration(600).eut(256).addTo(sCutterRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(NewHorizonsCoreMod.ID, "tile.CallistoColdIce", 1, 0, missing))
                ...
                .fluidInputs(FluidRegistry.getFluidStack("ic2coolant", 1000)).duration(3600).eut(30)
                .addTo(sCutterRecipes);
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.EngravedDiamondCrystalChip.get(1L)).duration(400).eut(1920)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.EngravedEnergyChip.get(1L)).duration(600).eut(4096)
                .addTo(sLaserEngraverRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.EngravedQuantumChip.get(1L)).duration(1200).eut(30720)
                .addTo(sLaserEngraverRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(IndustrialCraft2.ID, "itemBatCrystal", 1, wildcard, missing))
                .itemOutputs(CustomItemList.NanoCrystal.get(1L)).duration(600).eut(480).addTo(sLaserEngraverRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.QuantumCrystal.get(1L)).duration(800).eut(1920)
                .addTo(sLaserEngraverRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_Utility.copyAmount(0L, GT_OreDictUnificator.get(OrePrefixes.lens, Materials.EnderPearl, 1L)),
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.ManyullynCrystal.get(1L)).duration(1200).eut(1920)
                .addTo(sLaserEngraverRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(900).eut(7680).addTo(sLaserEngraverRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_Utility.copyAmount(0L, GT_OreDictUnificator.get(OrePrefixes.lens, Materials.Amethyst, 1L)),
                        CustomItemList.ManyullynCrystal.get(1L))
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.EngravedGoldChip", 1, 0, missing)).duration(100)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.IridiumAlloyItemCasing.get(2L)).duration(400).eut(384)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(TinkerConstruct.ID, "materials", 2, 4, missing),
                        ItemList.Shape_Extruder_Saw.get(0L))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.SawBladeArdite", 1, 0, missing)).duration(400)
                .eut(120).addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(TinkerConstruct.ID, "materials", 2, 5, missing),
                        ItemList.Shape_Extruder_Saw.get(0L))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.SawBladeManyullyn", 1, 0, missing)).duration(600)
                .eut(120).addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(TinkerConstruct.ID, "materials", 1, 5, missing),
                        ItemList.Shape_Extruder_Plate.get(0L))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.ManyullynPlate", 1, 0, missing)).duration(100)
                .eut(480).addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "feather", 1, 0, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.BowFletchingCast", 0, 0, missing))
                .itemOutputs(getModItem(TinkerConstruct.ID, "fletching", 1, 0, missing)).duration(200).eut(30)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(TinkerConstruct.ID, "materials", 1, 1, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.BowFletchingCast", 0, 0, missing))
                .itemOutputs(getModItem(TinkerConstruct.ID, "fletching", 1, 2, missing)).duration(200).eut(30)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(TinkerConstruct.ID, "materials", 1, 17, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.BowFletchingCast", 0, 0, missing))
                .itemOutputs(getModItem(TinkerConstruct.ID, "fletching", 1, 3, missing)).duration(200).eut(30)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "leaves", 1, 0, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.BowFletchingCast", 0, 0, missing))
                .itemOutputs(getModItem(TinkerConstruct.ID, "fletching", 1, 1, missing)).duration(200).eut(30)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(TinkerConstruct.ID, "slime.leaves", 1, 0, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.BowFletchingCast", 0, 0, missing))
                .itemOutputs(getModItem(TinkerConstruct.ID, "fletching", 1, 4, missing)).duration(200).eut(30)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "string", 3, 0, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.BowStringCast", 0, 0, missing))
                .itemOutputs(getModItem(TinkerConstruct.ID, "bowstring", 1, 0, missing)).duration(400).eut(30)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Natura.ID, "barleyFood", 3, 7, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.BowStringCast", 0, 0, missing))
                .itemOutputs(getModItem(TinkerConstruct.ID, "bowstring", 1, 2, missing)).duration(400).eut(30)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Thaumcraft.ID, "ItemResource", 3, 7, missing),
                        getModItem(NewHorizonsCoreMod.ID, "item.BowStringCast", 0, 0, missing))
                .itemOutputs(getModItem(TinkerConstruct.ID, "bowstring", 1, 1, missing)).duration(400).eut(30)
                .addTo(sExtruderRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(getModItem(AppliedEnergistics2.ID, "item.ItemMultiMaterial", 1, 1, missing))
                .itemOutputs(CustomItemList.ChargedCertusQuartzDust.get(1L)).duration(10).eut(16).addTo(sHammerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .duration(300).eut(7680).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .duration(300).eut(480).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Parts_Crystal_Chip_Master.get(1L),
                ...
                .duration(300).eut(1024).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                ...
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.GoldCoreChip", 1, 0, missing)).duration(300)
                .eut(256).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.EngravedDiamondCrystalChip.get(1L),
                        getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1, 3, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.DiamondCoreChip", 1, 0, missing)).duration(300)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .duration(300).eut(4096).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Parts_Crystal_Chip_Elite.get(1L),
                        getModItem(BuildCraftSilicon.ID, "redstoneChipset", 1, 4, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.GeneticCircuit", 1, 0, missing)).duration(300)
                .eut(480).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Parts_Crystal_Chip_Elite.get(1L),
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(CustomItemList.AluminiumIronPlate.get(1L)).duration(600).eut(120).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 2L),
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(IndustrialCraft2.ID, "itemPlates", 4, 4, missing))
                .itemOutputs(CustomItemList.TitaniumIronPlate.get(1L)).duration(600).eut(480).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 2L),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 4L))
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(IndustrialCraft2.ID, "itemPlates", 4, 4, missing))
                .itemOutputs(CustomItemList.TungstenIronPlate.get(1L)).duration(600).eut(1920).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Tungsten, 2L),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 4L))
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(IndustrialCraft2.ID, "itemPlates", 4, 4, missing))
                .itemOutputs(CustomItemList.TungstenSteelIronPlate.get(1L)).duration(600).eut(7680)
                .addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 2L),
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(IndustrialCraft2.ID, "itemPlates", 4, 4, missing))
                .itemOutputs(CustomItemList.ChromeIronPlate.get(1L)).duration(600).eut(30720).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Chrome, 2L),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 4L))
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 2L),
                        getModItem(IndustrialCraft2.ID, "itemPlates", 4, 4, missing))
                .itemOutputs(getModItem(AdvancedSolarPanel.ID, "asp_crafting_items", 1, 6, missing)).duration(600)
                .eut(122880).addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 2L),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 4L))
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(IndustrialCraft2.ID, "itemPlates", 4, 4, missing))
                .itemOutputs(CustomItemList.NaquadriaIronPlate.get(1L)).duration(600).eut(TierEU.RECIPE_UV)
                .addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Naquadria, 2L),
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(IndustrialCraft2.ID, "itemPlates", 4, 4, missing))
                .itemOutputs(CustomItemList.NeutroniumIronPlate.get(1L)).duration(600).eut(TierEU.RECIPE_UHV)
                .addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 2L),
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(IndustrialCraft2.ID, "itemPlates", 4, 4, missing))
                .itemOutputs(CustomItemList.BedrockiumIronPlate.get(1L)).duration(600).eut(8000000)
                .addTo(sPressRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder().itemInputs(getModItem(Minecraft.ID, "obsidian", 1, 0, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.LongObsidianRod", 4, 0, missing)).duration(640)
                .eut(16).addTo(sLatheRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(Minecraft.ID, "stone", 1, 0, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.LongStoneRod", 4, 0, missing)).duration(320)
                .eut(16).addTo(sLatheRecipes);
        GT_Values.RA.stdBuilder()
                ...
                .duration(200).eut(16).addTo(sLatheRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(Minecraft.ID, "sandstone", 1, wildcard, missing))
                .itemOutputs(CustomItemList.SandStoneRod.get(1L)).duration(160).eut(16).addTo(sLatheRecipes);
        GT_Values.RA.stdBuilder().itemInputs(getModItem(Minecraft.ID, "cobblestone", 1, 0, missing))
                ...
                .duration(160).eut(16).addTo(sLatheRecipes);
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(getModItem(AppliedEnergistics2.ID, "item.ItemMultiMaterial", 1, 1, missing))
                .itemOutputs(CustomItemList.ChargedCertusQuartzDust.get(1L)).outputChances(10000).duration(300).eut(2)
        ...
        GT_Values.RA.stdBuilder().itemInputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 55, missing))
                .itemOutputs(getModItem(NewHorizonsCoreMod.ID, "item.ElectrotineWire", 2, 0, missing)).duration(100)
