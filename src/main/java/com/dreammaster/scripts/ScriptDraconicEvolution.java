...
public class ScriptDraconicEvolution implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                ...
                's',
                getModItem(EtFuturumRequiem.ID, "chorus_fruit_popped", 1, 0, missing));
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                ...
                's',
                getModItem(EtFuturumRequiem.ID, "chorus_flower", 1, 0, missing));
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                ...
                getModItem(DraconicEvolution.ID, "wyvernHelm", 1, 0, missing),
                'f',
                getModItem(EtFuturumRequiem.ID, "amethyst_cluster_2", 1, 6, missing),
                's',
                getModItem(EtFuturumRequiem.ID, "netherite_scrap", 1, 0, missing));
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
