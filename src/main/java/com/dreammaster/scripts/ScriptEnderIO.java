...
public class ScriptEnderIO implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(Materials.ConductiveIron.getMolten(144L)).noFluidOutputs().duration(10 * SECONDS).eut(256)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(Materials.EnergeticAlloy.getMolten(144L)).noFluidOutputs().duration(10 * SECONDS)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(Materials.VibrantAlloy.getMolten(144L)).noFluidOutputs().duration(10 * SECONDS).eut(960)
                .addTo(sAssemblerRecipes);
