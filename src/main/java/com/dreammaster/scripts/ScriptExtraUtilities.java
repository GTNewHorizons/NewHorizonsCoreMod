    ...
    public void loadRecipes() {
        ...
        // --- Carved Imminence Stone
        {
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    ...
                                    .add(Aspect.getAspect("sensus"), 12)
                    ...
                    .setPages(new ResearchPage("ExtraUtilities.research_page.EMINENCESTONE"), new ResearchPage(recipe))
                    .setParents("INFUSION");
        ...
        // --- Portal to the Last Millennium
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    4,
                    new AspectList()
                            .add(Aspect.getAspect("alienis"), 75)
                            .add(Aspect.getAspect("sensus"), 25)
                            .add(Aspect.getAspect("praecantatio"), 75)
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            getModItem("ExtraUtilities", "dark_portal", 1, 2, missing))
                    .setPages(
                            new ResearchPage("ExtraUtilities.research_page.PORTALMILLENIUM"), new ResearchPage(recipe))
                    .setParents("EMINENCESTONE", "OCULUS")
                    .setConcealed();
        ...
        // --- Portal to the Deep Dark
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    32,
                    new AspectList()
                            .add(Aspect.getAspect("vacuos"), 512)
                            .add(Aspect.getAspect("tempus"), 512)
                            .add(Aspect.getAspect("luxuria"), 512)
                            .add(Aspect.getAspect("alienis"), 512)
                            .add(Aspect.getAspect("terminus"), 512)
                            .add(Aspect.getAspect("gula"), 512)
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            "NEWHORIZONS",
                            new AspectList()
                                    .add(Aspect.getAspect("vacuos"), 27)
                                    .add(Aspect.getAspect("tempus"), 24)
                                    .add(Aspect.getAspect("luxuria"), 21)
                                    .add(Aspect.getAspect("alienis"), 18)
                                    .add(Aspect.getAspect("gula"), 12)
                                    .add(Aspect.getAspect("superbia"), 9),
                            2,
                            8,
                            4,
                            getModItem("ExtraUtilities", "dark_portal", 1, missing))
                    .setPages(new ResearchPage("ExtraUtilities.research_page.PORTALDEEPDARK"), new ResearchPage(recipe))
                    .setParents("PORTALMILLENIUM", "ICHOR")
                    .setConcealed();
        ...
        // --- Magical Wood
        {
            ...
            ResearchItem research = new ResearchItem(
                    ...
                    .setPages(new ResearchPage("ExtraUtilities.research_page.MAGICALWOOD"), new ResearchPage(recipe))
                    .setParents("EMINENCESTONE")
                    .setConcealed();
            ResearchCategories.addResearch(research);
        }
        // --- Angel Block
        {
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    ...
                                    .add(Aspect.getAspect("terra"), 6),
                            -2,
                            8,
                            4,
                            getModItem("ExtraUtilities", "angelBlock", 1, missing))
                    .setPages(new ResearchPage("ExtraUtilities.research_page.ANGELBLOCK"), new ResearchPage(recipe))
                    .setParents("MAGICALWOOD")
                    .setConcealed();
            ResearchCategories.addResearch(research);
        }
        // --- Dezlis Marshmallow
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    new AspectList()
                            ...
                            .add(Aspect.getAspect("sano"), 28)
                            .add(Aspect.getAspect("iter"), 20)
                            .add(Aspect.getAspect("potentia"), 12),
                    getModItem("dreamcraft", "item.Marshmallow", 1, missing),
                    new ItemStack[] {
                        getModItem("harvestcraft", "epicbaconItem", 1, missing),
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    .add(Aspect.getAspect("alienis"), 15)
                                    .add(Aspect.getAspect("praecantatio"), 12)
                                    .add(Aspect.getAspect("superbia"), 9)
                                    .add(Aspect.getAspect("sano"), 6)
        ...
        // --- Enchanting Table
        {
            ShapedArcaneRecipe recipe = ThaumcraftApi.addArcaneCraftingRecipe(
                    ...
                    new AspectList()
                            .add(Aspect.getAspect("aer"), 45)
                            .add(Aspect.getAspect("aqua"), 45)
                            .add(Aspect.getAspect("terra"), 45)
                            .add(Aspect.getAspect("ignis"), 45)
                            .add(Aspect.getAspect("ordo"), 45)
                            .add(Aspect.getAspect("perditio"), 45),
                    "ABA",
                    "CDE",
                    "AFA",
                    'A',
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    .add(Aspect.getAspect("praecantatio"), 15)
                                    .add(Aspect.getAspect("fabrico"), 12)
                                    .add(Aspect.getAspect("cognitio"), 9)
                                    .add(Aspect.getAspect("potentia"), 6),
                            0,
                            0,
                            4,
                            getModItem("minecraft", "enchanting_table", 1, missing))
                    .setPages(new ResearchPage("Minecraft.research_page.ENCHANTINGTABLE"), new ResearchPage(recipe))
        ...
        // --- Disenchanting Table
        {
            ShapedArcaneRecipe recipe = ThaumcraftApi.addArcaneCraftingRecipe(
                    ...
                    new AspectList()
                            .add(Aspect.getAspect("aer"), 75)
                            .add(Aspect.getAspect("aqua"), 75)
                            .add(Aspect.getAspect("terra"), 75)
                            .add(Aspect.getAspect("ignis"), 75)
                            .add(Aspect.getAspect("ordo"), 75)
                            .add(Aspect.getAspect("perditio"), 75),
                    "ABA",
                    "CDC",
                    "EFE",
                    'A',
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            "NEWHORIZONS",
                            new AspectList()
                                    .add(Aspect.getAspect("alienis"), 21)
                                    .add(Aspect.getAspect("perditio"), 18)
                                    .add(Aspect.getAspect("praecantatio"), 15)
                                    .add(Aspect.getAspect("fabrico"), 12)
                                    .add(Aspect.getAspect("cognitio"), 9)
                                    .add(Aspect.getAspect("potentia"), 6),
        ...
        // --- Brewing Stand
        {
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    .add(Aspect.getAspect("praecantatio"), 15)
                                    .add(Aspect.getAspect("fabrico"), 15)
                                    .add(Aspect.getAspect("cognitio"), 12)
                                    .add(Aspect.getAspect("perditio"), 12)
                                    .add(Aspect.getAspect("ignis"), 9)
                                    .add(Aspect.getAspect("terra"), 6)
        ...
        // --- Beacon Infusion
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    6,
                    new AspectList()
                            .add(Aspect.getAspect("praecantatio"), 64)
                            .add(Aspect.getAspect("alienis"), 64)
                            .add(Aspect.getAspect("lux"), 64)
                            .add(Aspect.getAspect("ordo"), 64)
                            .add(Aspect.getAspect("ignis"), 64)
                            .add(Aspect.getAspect("terra"), 64),
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    .add(Aspect.getAspect("alienis"), 15)
                                    .add(Aspect.getAspect("praecantatio"), 12)
                                    .add(Aspect.getAspect("auram"), 9)
                                    .add(Aspect.getAspect("fames"), 6),
                            4,
                            0,
                            4,
                            getModItem("minecraft", "beacon", 1, missing))
        ...
        // --- Dragon Egg
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    new AspectList()
                            .add(Aspect.getAspect("alienis"), 64)
                            .add(Aspect.getAspect("bestia"), 56)
                            .add(Aspect.getAspect("praecantatio"), 48)
                            .add(Aspect.getAspect("victus"), 48),
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    .add(Aspect.getAspect("alienis"), 15)
                                    .add(Aspect.getAspect("praecantatio"), 12)
                                    .add(Aspect.getAspect("victus"), 9)
                                    .add(Aspect.getAspect("bestia"), 6),
                            2,
                            5,
                            4,
                            getModItem("minecraft", "dragon_egg", 1, missing))
        ...
        // --- Silky Cloth and Jewel
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    new AspectList()
                            ...
                            .add(Aspect.getAspect("praecantatio"), 35)
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            "NEWHORIZONS",
                            new AspectList()
                                    .add(Aspect.getAspect("pannus"), 15)
                                    .add(Aspect.getAspect("lucrum"), 2)
                            ...
                            4,
                            getModItem("TConstruct", "materials", 1, 26, missing))
                    .setPages(new ResearchPage("TConstruct.research_page.SILKYCRYSTAL"), new ResearchPage(recipe))
                    .setParents("ENCHANTINGTABLE")
                    .setConcealed()
                    .setRound();
            ResearchCategories.addResearch(research);
        ...
        // --- Lava Crystal
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    new AspectList()
                            ...
                            .add(Aspect.getAspect("vacuos"), 20)
                            .add(Aspect.getAspect("praecantatio"), 35),
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    ...
                                    .add(Aspect.getAspect("praecantatio"), 12)
                                    .add(Aspect.getAspect("vacuos"), 9)
                                    .add(Aspect.getAspect("perditio"), 6),
                            2,
                            -2,
                            4,
                            getModItem("TConstruct", "materials", 1, 7, missing))
                    .setPages(new ResearchPage("TConstruct.research_page.LAVACRYSTAL"), new ResearchPage(recipe))
                    .setParents("ENCHANTINGTABLE")
                    .setConcealed()
                    .setRound();
            ResearchCategories.addResearch(research);
        ...
        // --- Ball of Moss
        {
            ...
            ResearchItem research = new ResearchItem(
                    ...
                    .setParents("SILKYCRYSTAL", "LAVACRYSTAL")
                    .setConcealed()
                    .setRound();
            ResearchCategories.addResearch(research);
        }
        // --- Necrotic Bone
        {
            CrucibleRecipe recipe = ThaumcraftApi.addCrucibleRecipe(
                    ...
                    new AspectList()
                            .add(Aspect.getAspect("exanimis"), 20)
                            .add(Aspect.getAspect("mortuus"), 30)
                            .add(Aspect.getAspect("infernus"), 20)
                            .add(Aspect.getAspect("spiritus"), 20)
                            .add(Aspect.getAspect("venenum"), 20)
                            .add(Aspect.getAspect("corpus"), 5));
            ResearchItem research = new ResearchItem(
                            "NECROTICBONE",
                            "NEWHORIZONS",
                            new AspectList()
                                    .add(Aspect.getAspect("exanimis"), 15)
                                    .add(Aspect.getAspect("mortuus"), 12)
                                    .add(Aspect.getAspect("spiritus"), 9)
                                    .add(Aspect.getAspect("venenum"), 6),
                            0,
                            -2,
                            4,
                            getModItem("TConstruct", "materials", 1, 8, missing))
                    .setPages(new ResearchPage("TConstruct.research_page.NECROTICBONE"), new ResearchPage(recipe))
        ...
        // --- Red Heart
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    3,
                    new AspectList()
                            .add(Aspect.getAspect("exanimis"), 25)
                            .add(Aspect.getAspect("ignis"), 35)
                            .add(Aspect.getAspect("lucrum"), 35)
                            .add(Aspect.getAspect("sano"), 50)
            ...
            ResearchItem research = new ResearchItem(
                    ...
                    .setParents("RUNICAUGMENTATION", "BALLOFMOSS")
                    .setConcealed()
                    .setRound();
        ...
        // --- Red Heart Canister
        {
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            "NEWHORIZONS",
                            new AspectList()
                                    .add(Aspect.getAspect("metallum"), 15)
                                    .add(Aspect.getAspect("lucrum"), 15)
                                    .add(Aspect.getAspect("sano"), 12)
                                    .add(Aspect.getAspect("ignis"), 9)
                                    .add(Aspect.getAspect("mortuus"), 6)
                                    .add(Aspect.getAspect("exanimis"), 3),
                            0,
                            ...
                            4,
                            getModItem("TConstruct", "heartCanister", 1, 2, missing))
                    .setPages(new ResearchPage("TConstruct.research_page.REDHEARTCANISTER.1"), new ResearchPage(recipe))
                    .setParents("REDHEART")
                    .setConcealed();
        ...
        // --- Yellow Heart
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    3,
                    new AspectList()
                            .add(Aspect.getAspect("exanimis"), 50)
                            .add(Aspect.getAspect("ignis"), 75)
                            .add(Aspect.getAspect("lucrum"), 75)
                            .add(Aspect.getAspect("sano"), 100)
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            "NEWHORIZONS",
                            new AspectList()
                                    .add(Aspect.getAspect("mortuus"), 15)
                                    .add(Aspect.getAspect("praecantatio"), 12)
                                    .add(Aspect.getAspect("exanimis"), 9)
                                    .add(Aspect.getAspect("sano"), 6)
                            ...
                            4,
                            getModItem("TConstruct", "heartCanister", 1, 3, missing))
                    .setPages(new ResearchPage("TConstruct.research_page.YELLOWHEART.1"), new ResearchPage(recipe))
                    .setParents("REDHEART")
                    .setConcealed()
                    .setRound();
        ...
        // --- Yellow Heart Canister
        {
            ShapedArcaneRecipe recipe = ThaumcraftApi.addArcaneCraftingRecipe(
                    ...
                    new AspectList()
                            ...
                            .add(Aspect.getAspect("aqua"), 100)
                            .add(Aspect.getAspect("ignis"), 100)
                            .add(Aspect.getAspect("terra"), 100)
                            .add(Aspect.getAspect("ordo"), 100)
                            .add(Aspect.getAspect("perditio"), 100),
                    "ABA",
                    "CDC",
                    "EEE",
                    'A',
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    ...
                                    .add(Aspect.getAspect("lucrum"), 15)
                                    .add(Aspect.getAspect("sano"), 12)
                                    .add(Aspect.getAspect("praecantatio"), 9)
                                    .add(Aspect.getAspect("mortuus"), 6)
                                    .add(Aspect.getAspect("exanimis"), 3),
                            -2,
                            -9,
        ...
        // --- Green Heart
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    3,
                    new AspectList()
                            .add(Aspect.getAspect("exanimis"), 100)
                            .add(Aspect.getAspect("ignis"), 150)
                            .add(Aspect.getAspect("lucrum"), 150)
                            .add(Aspect.getAspect("sano"), 200)
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            4,
                            getModItem("TConstruct", "heartCanister", 1, 5, missing))
                    .setPages(new ResearchPage("TConstruct.research_page.GREENHEART.1"), new ResearchPage(recipe))
                    .setParents("YELLOWHEART")
                    .setConcealed()
                    .setRound();
        ...
        // --- Green Heart Canister
        {
            ShapedArcaneRecipe recipe = ThaumcraftApi.addArcaneCraftingRecipe(
                    ...
                    new AspectList()
                            .add(Aspect.getAspect("aer"), 200)
                            .add(Aspect.getAspect("aqua"), 200)
                            .add(Aspect.getAspect("ignis"), 200)
                            .add(Aspect.getAspect("terra"), 200)
                            .add(Aspect.getAspect("ordo"), 200)
                            .add(Aspect.getAspect("perditio"), 200),
                    "ABA",
                    "CDC",
                    "ACA",
                    'A',
        ...
        // --- Ender Chest Arcane
        {
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    .add(Aspect.getAspect("metallum"), 15)
                                    .add(Aspect.getAspect("electrum"), 15)
                                    .add(Aspect.getAspect("machina"), 12)
                                    .add(Aspect.getAspect("alienis"), 9)
                            ...
                            4,
                            getModItem("EnderStorage", "enderChest", 1, missing))
                    .setPages(new ResearchPage("EnderStorage.research_page.ENDERCHEST"), new ResearchPage(recipe))
                    .setParents("INFUSION")
                    .setConcealed();
            ResearchCategories.addResearch(research);
        }
        // --- Ender Tank Arcane
        {
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            4,
                            getModItem("EnderStorage", "enderChest", 1, 4096, missing))
                    .setPages(new ResearchPage("EnderStorage.research_page.ENDERTANK"), new ResearchPage(recipe))
                    .setParents("ENDERCHEST")
                    .setConcealed();
            ResearchCategories.addResearch(research);
        }
        // --- Ender Pouch Arcane
        {
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    .add(Aspect.getAspect("lucrum"), 15)
                                    .add(Aspect.getAspect("vitreus"), 15)
                                    .add(Aspect.getAspect("metallum"), 12)
                                    .add(Aspect.getAspect("electrum"), 9)
                                    .add(Aspect.getAspect("machina"), 6)
                                    .add(Aspect.getAspect("alienis"), 3),
                            -4,
                            4,
                            4,
                            getModItem("EnderStorage", "enderPouch", 1, missing))
                    .setPages(new ResearchPage("EnderStorage.research_page.ENDERPOUCHE"), new ResearchPage(recipe))
                    .setParents("ENDERTANK")
                    .setConcealed();
            ResearchCategories.addResearch(research);
        }
        ...
        // --- Luggage
        {
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    .add(Aspect.getAspect("alienis"), 15)
                                    .add(Aspect.getAspect("sensus"), 15)
                                    .add(Aspect.getAspect("iter"), 12)
                                    .add(Aspect.getAspect("praecantatio"), 9)
                                    .add(Aspect.getAspect("fabrico"), 6)
        ...
        // --- Ghost Amulet HEE
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    9,
                    new AspectList()
                            .add(Aspect.getAspect("auram"), 64)
                            .add(Aspect.getAspect("potentia"), 64)
                            .add(Aspect.getAspect("vitium"), 32)
                            .add(Aspect.getAspect("vitreus"), 48)
                            .add(Aspect.getAspect("spiritus"), 32)
                            .add(Aspect.getAspect("corpus"), 16)
                            .add(Aspect.getAspect("alienis"), 24)
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            "NEWHORIZONS",
                            new AspectList()
                                    .add(Aspect.getAspect("potentia"), 21)
                                    .add(Aspect.getAspect("auram"), 18)
                                    .add(Aspect.getAspect("infernus"), 15)
                                    .add(Aspect.getAspect("lucrum"), 12)
                                    .add(Aspect.getAspect("praecantatio"), 12)
                                    .add(Aspect.getAspect("spiritus"), 9)
                    ...
                    .setParents("ENCHANTINGTABLE", "BREWINGSTAND")
                    .setConcealed()
                    .setRound();
        ...
        // --- Skullfire Sword
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    new AspectList()
                            .add(Aspect.getAspect("auram"), 64)
                            .add(Aspect.getAspect("corpus"), 64)
                            .add(Aspect.getAspect("exanimis"), 64)
                            .add(Aspect.getAspect("metallum"), 64)
