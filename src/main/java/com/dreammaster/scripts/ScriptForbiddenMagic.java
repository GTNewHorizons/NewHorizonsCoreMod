...
public class ScriptForbiddenMagic implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        TCHelper.removeInfusionRecipe(getModItem(ForbiddenMagic.ID, "WandCores", 1, 8, missing));
        ...
        TCHelper.addInfusionCraftingRecipe(
                "ROD_livingwood",
                getModItem(ForbiddenMagic.ID, "WandCores", 1, 8, missing),
                9,
                ...
                getModItem(Botania.ID, "livingwood", 1, 0, missing),
                getModItem(Botania.ID, "manaResource", 1, 2, missing),
                getModItem(Botania.ID, "rune", 1, 0, missing),
                getModItem(Botania.ID, "rune", 1, 1, missing),
                getModItem(Botania.ID, "rune", 1, 2, missing),
                getModItem(Botania.ID, "rune", 1, 3, missing),
                getModItem(Botania.ID, "rune", 1, 8, missing));
        new ResearchItem(
                "ROD_livingwood",
                "FORBIDDEN",
