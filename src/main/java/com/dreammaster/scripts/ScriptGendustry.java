...
public class ScriptGendustry implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                ...
                "---------",
                'a',
                getModItem("gendustry", "MutagenTank", 1, 0, missing),
                'b',
                "plateBlackPlutonium",
                'c',
                getModItem("gendustry", "PowerModule", 1, 0, missing),
                ...
                'e',
                getModItem("gregtech", "gt.metaitem.01", 1, 32656, missing),
                'f',
                getModItem("gendustry", "GeneticsProcessor", 1, 0, missing),
                'g',
                getModItem("gendustry", "BeeReceptacle", 1, 0, missing),
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                getModItem("gendustry", "Mutatron", 1, 0, missing),
                "---------",
                "---------",
                "--abcba--",
                "--defed--",
                ...
                "---------",
                'a',
                getModItem("gregtech", "gt.blockcasings", 1, 11, missing),
                'b',
                getModItem("ExtraBees", "alveary", 1, 5, missing),
                'c',
                getModItem("Forestry", "factory", 1, 2, missing),
                'd',
                getModItem("gregtech", "gt.comb", 1, 79, missing),
                'e',
                getModItem("gregtech", "gt.metaitem.01", 1, 32655, missing),
                'f',
                getModItem("gendustry", "MutagenTank", 1, 0, missing),
                'g',
                getModItem("miscutils", "itemGearRuthenium", 1, 0, missing),
                'h',
        ...
        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                getModItem("gendustry", "MutatronAdv", 1, 0, missing),
                "---------",
                "-aaaaaaa-",
                "-abcccda-",
                "-aefgfea-",
                ...
                "---------",
                'a',
                getModItem("gregtech", "gt.metaitem.01", 1, 21070, missing),
                'b',
                getModItem("gendustry", "Replicator", 1, 0, missing),
                'c',
                getModItem("gregtech", "gt.metaitem.01", 1, 21327, missing),
                'd',
                getModItem("gendustry", "Liquifier", 1, 0, missing),
                'e',
                getModItem("gendustry", "Labware", 1, 0, missing),
                'f',
                getModItem("gendustry", "GeneticsProcessor", 1, 0, missing),
                'g',
                getModItem("gregtech", "gt.metaitem.01", 1, 32656, missing),
                ...
                getModItem("gendustry", "Sampler", 1, 0, missing),
                'i',
                getModItem("gregtech", "gt.comb", 1, 85, missing),
                'j',
                getModItem("gendustry", "Mutatron", 1, 0, missing),
                'k',
                getModItem("gendustry", "Imprinter", 1, 0, missing),
