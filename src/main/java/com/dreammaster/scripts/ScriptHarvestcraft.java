...
public class ScriptHarvestcraft implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        addShapedRecipe(
                ...
                "plateStainlessSteel",
                "plateStainlessSteel",
                MaterialLibAPI.getStack(Materials2Materials.StainlessSteel, Materials2Shapes.toolHeadDrill, (int) (1L)),
                "plateStainlessSteel",
                "boltStainlessSteel",
                "plateStainlessSteel",
                "boltStainlessSteel");
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(PamsHarvestCraft.ID, "heavycreamItem", 1, 0),
                        MaterialLibAPI.getStack(Materials2Materials.Salt, Materials2Shapes.dustTiny, (int) (1L)))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        MaterialLibAPI.getStack(Materials2Materials.Salt, Materials2Shapes.dustTiny, (int) (2L)))
