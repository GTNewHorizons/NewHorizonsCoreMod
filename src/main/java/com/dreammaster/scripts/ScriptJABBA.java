...
public class ScriptJABBA implements IScriptLoader{
    ...
    public void loadRecipes() {
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                ...
                200, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("BiomesOPlenty", "planks", 8, 32767),
                        getModItem("minecraft", "chest", 1)},
                GT_Values.NF,
                getModItem("JABBA", "barrel", 1),
                200, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("ExtraTrees", "planks", 8, 32767),
                        getModItem("minecraft", "chest", 1)},
                GT_Values.NF,
                getModItem("JABBA", "barrel", 1),
                200, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("ExtraUtilities", "colorWoodPlanks", 8, 32767),
                        getModItem("minecraft", "chest", 1)},
                GT_Values.NF,
                getModItem("JABBA", "barrel", 1),
                200, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("Forestry", "planks", 8, 32767),
                        getModItem("minecraft", "chest", 1)},
                GT_Values.NF,
                getModItem("JABBA", "barrel", 1),
                200, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("Forestry", "planksFireproof", 8, 32767),
                        getModItem("minecraft", "chest", 1)},
                GT_Values.NF,
                getModItem("JABBA", "barrel", 1),
                200, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("Natura", "planks", 8, 32767),
                        getModItem("minecraft", "chest", 1)},
                GT_Values.NF,
                getModItem("JABBA", "barrel", 1),
                200, 16);
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                ...
                900, 30);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("JABBA", "upgradeCore", 3, 4),
                        getModItem("gregtech", "gt.integrated_circuit", 0, 3)},
                GT_Values.NF,
                getModItem("JABBA", "upgradeCore", 1, 5),
                600, 64);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("JABBA", "upgradeCore", 3, 5),
                        getModItem("gregtech", "gt.integrated_circuit", 0, 3)},
                GT_Values.NF,
                getModItem("JABBA", "upgradeCore", 1, 6),
                400, 120);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("JABBA", "upgradeCore", 3, 6),
                        getModItem("gregtech", "gt.integrated_circuit", 0, 3)},
                GT_Values.NF,
                getModItem("JABBA", "upgradeCore", 1, 8),
                200, 256);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        getModItem("JABBA", "upgradeCore", 3, 8),
                        getModItem("gregtech", "gt.integrated_circuit", 0, 3)},
                GT_Values.NF,
        ...
        addShapedRecipe(getModItem("JABBA", "tuningFork", 1), new Object[]{
                getModItem("GTore", "craftingToolScrewdriver", 1),"stickAnyIron",null,
        ...
        addShapedRecipe(getModItem("JABBA", "upgradeStructural", 1), new Object[]{
                "stickWood",getModItem("gregtech", "gt.metaitem.01", 1, 17809),"stickWood",
                getModItem("gregtech", "gt.metaitem.01", 1, 17809),getModItem("JABBA", "barrel", 1),getModItem("gregtech", "gt.metaitem.01", 1, 17809),
                "stickWood",getModItem("gregtech", "gt.metaitem.01", 1, 17809),"stickWood"});
        ...
        addShapedRecipe(getModItem("JABBA", "upgradeCore", 2, 1), new Object[]{
                "plateEnderEye",getModItem("minecraft", "piston", 1),"plateEnderEye",
                getModItem("minecraft", "piston", 1),getModItem("EnderStorage","enderChest", 1),getModItem("minecraft", "piston", 1),
                "plateEnderEye",getModItem("minecraft", "piston", 1),"plateEnderEye"});

        addShapedRecipe(getModItem("JABBA", "upgradeCore", 2, 1), new Object[]{
                "plateEnderEye",getModItem("minecraft", "sticky_piston", 1),"plateEnderEye",
                getModItem("minecraft", "piston", 1),getModItem("EnderStorage","enderChest", 1),getModItem("minecraft", "piston", 1),
                "plateEnderEye",getModItem("minecraft", "sticky_piston", 1),"plateEnderEye"});

        addShapedRecipe(getModItem("JABBA", "upgradeCore", 1, 2), new Object[]{
                "plateRedAlloy",getModItem("minecraft", "piston", 1),"plateRedAlloy",
                getModItem("minecraft", "piston", 1),getModItem("minecraft", "redstone_block", 1),getModItem("minecraft", "piston", 1),
                "plateRedAlloy",getModItem("minecraft", "piston", 1),"plateRedAlloy"});

        addShapedRecipe(getModItem("JABBA", "upgradeCore", 1, 2), new Object[]{
                "plateRedAlloy",getModItem("minecraft", "sticky_piston", 1),"plateRedAlloy",
                getModItem("minecraft", "piston", 1),getModItem("minecraft", "redstone_block", 1),getModItem("minecraft", "piston", 1),
                "plateRedAlloy",getModItem("minecraft", "sticky_piston", 1),"plateRedAlloy"});

        addShapedRecipe(getModItem("JABBA", "upgradeCore", 1, 3), new Object[]{
                "plateIron",getModItem("minecraft", "piston", 1),"plateIron",
                getModItem("minecraft", "piston", 1),getModItem("minecraft", "hopper", 1),getModItem("minecraft", "piston", 1),
                "plateIron",getModItem("minecraft", "piston", 1),"plateIron"});

        addShapedRecipe(getModItem("JABBA", "upgradeCore", 1, 3), new Object[]{
                "plateIron",getModItem("minecraft", "sticky_piston", 1),"plateIron",
                getModItem("minecraft", "piston", 1),getModItem("minecraft", "hopper", 1),getModItem("minecraft", "piston", 1),
                "plateIron",getModItem("minecraft", "sticky_piston", 1),"plateIron"});

        addShapedRecipe(getModItem("JABBA", "upgradeCore", 1, 7), new Object[]{
                "plateIron",getModItem("minecraft", "piston", 1),"plateIron",
                getModItem("minecraft", "piston", 1),getModItem("Railcraft", "machine.beta", 1, 11),getModItem("minecraft", "piston", 1),
                "plateIron",getModItem("minecraft", "piston", 1),"plateIron"});
        ...
        addShapedRecipe(getModItem("JABBA", "upgradeCore", 1), new Object[]{
                "screwSteel",getModItem("minecraft", "piston", 1),"screwSteel",
