...
public class ScriptLoader {
    ...
    public static void run() {
        ...
        IScriptLoader[] scripts = new IScriptLoader[] { new ScriptAdvancedBackpacks(), new ScriptAdvancedSolarPanel(),
                new ScriptAE2FC(), new ScriptAE2Stuff(), new ScriptAE2WC(), new ScriptAFSU(), new ScriptAmunRa(),
                ...
                new ScriptDraconicEvolution(), new ScriptEMT(), new ScriptEnderIO(), new ScriptEnderZoo(),
                new ScriptEnhancedLootBags(), new ScriptExtraBees(), new ScriptExtraTrees(), new ScriptExtraUtilities(),
                new ScriptFloodLight(), new ScriptForbiddenMagic(), new ScriptForestry(), new ScriptForgeMultipart(),
                new ScriptGadomancy(), new ScriptGalacticraft(), new ScriptGendustry(), new ScriptGenetics(),
                new ScriptGraviSuite(), new ScriptGregtech(), new ScriptGregtechPlusPlus(),
