...
public class ScriptLoader {
    ...
    public static void run() {
        ...
        IScriptLoader[] scripts = new IScriptLoader[] { new ScriptAdvancedBackpacks(), new ScriptAdvancedSolarPanel(),
                ...
                new ScriptForgeMultipart(), new ScriptGadomancy(), new ScriptGregtechPlusPlus(),
                new ScriptHoloInventory(), new ScriptIguanaTweaks(), new ScriptJABBA(), new ScriptMagicBees(),
