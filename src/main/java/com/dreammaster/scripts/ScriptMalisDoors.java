...
public class ScriptMalisDoors implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(MalisisDoors.ID, "iron_trapdoor", 1, 0, missing)).duration(100).eut(16)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(MalisisDoors.ID, "iron_trapdoor", 1, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 2L))
                .itemOutputs(getModItem(MalisisDoors.ID, "sliding_trapdoor", 1, 0, missing)).duration(150).eut(16)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "heavy_weighted_pressure_plate", 1, 0, missing),
                        getModItem(Minecraft.ID, "skull", 1, 3, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "player_sensor", 2, 0, missing)).duration(100).eut(16)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Wood, 1L),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 288)).duration(300).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Iron, 1L),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 288)).duration(400).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Gold, 1L),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 288)).duration(500).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(NewHorizonsCoreMod.ID, "tile.DiamondFrameBox", 1, 0, missing),
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 288)).duration(600).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 4L),
                        getModItem(MalisisDoors.ID, "item.rustyHandle", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "rustyHatch", 1, 0, missing)).duration(200).eut(16)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Plastic, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Steel, 1L))
                .itemOutputs(getModItem(MalisisDoors.ID, "garage_door", 2, 0, missing)).duration(150).eut(16)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.AnyIron, 3L),
                        GT_Utility.getIntegratedCircuit(5))
                .itemOutputs(getModItem(MalisisDoors.ID, "rustyLadder", 2, 0, missing)).duration(60).eut(30)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(MalisisDoors.ID, "item.wood_sliding_door", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "wooden_door", 1, 0, missing),
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "iron_door", 1, 0, missing),
                        getModItem(Minecraft.ID, "glass_pane", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.iron_sliding_door", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "iron_door", 1, 0, missing),
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(MalisisDoors.ID, "item.jail_door", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "wooden_door", 1, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 2L))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.laboratory_door", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "wooden_door", 1, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 2L))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.factory_door", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_purple", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 4, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_yellow", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 2, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_magenta", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 6, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_pink", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 0, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_white", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 11, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_blue", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 9, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_cyan", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 14, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_red", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 7, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_gray", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 12, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_brown", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 5, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_lime", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 1, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_orange", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 8, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_silver", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 13, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_green", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 3, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_light_blue", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "carpet", 3, 15, missing),
                        getModItem(Minecraft.ID, "string", 1, 0, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.curtain_black", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "trapdoor", 2, 0, missing),
                        GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.Iron, 2L))
                .itemOutputs(getModItem(MalisisDoors.ID, "item.saloon", 1, 0, missing)).duration(400).eut(4)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "stick", 2, 0, missing),
                        getModItem(Minecraft.ID, "planks", 2, 4, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "acaciaFenceGate", 1, 0, missing)).duration(300).eut(8)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "stick", 2, 0, missing),
                        getModItem(Minecraft.ID, "planks", 2, 2, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "birchFenceGate", 1, 0, missing)).duration(300).eut(8)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "stick", 2, 0, missing),
                        getModItem(Minecraft.ID, "planks", 2, 5, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "darkOakFenceGate", 1, 0, missing)).duration(300).eut(8)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "stick", 2, 0, missing),
                        getModItem(Minecraft.ID, "planks", 2, 3, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "jungleFenceGate", 1, 0, missing)).duration(300).eut(8)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "stick", 2, 0, missing),
                        getModItem(Minecraft.ID, "planks", 2, 1, missing))
                .itemOutputs(getModItem(MalisisDoors.ID, "spruceFenceGate", 1, 0, missing)).duration(300).eut(8)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
