...
public class ScriptMatterManipulator implements IScriptLoader {
    ...
    private static void addMK0Recipes() {
        ...
        GTValues.RA.stdBuilder().itemInputs(
                MaterialLibAPI
                        .getStack(Materials2Materials.StainlessSteel, Materials2Shapes.shapeItemCasing, (int) (8)),
                ...
                MaterialLibAPI.getStack(Materials2Materials.StainlessSteel, Materials2Shapes.shapeScrew, (int) (16)))
                .circuit(5)
                .fluidInputs(
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        MaterialLibAPI
                                .getStack(Materials2Materials.Thaumium, Materials2Shapes.shapeItemCasing, (int) (8)),
                        MaterialLibAPI.getStack(Materials2Materials.Thaumium, Materials2Shapes.shapeScrew, (int) (16)))
        ...
        // Frame MK0
        GTValues.RA.stdBuilder().itemInputs(
                MaterialLibAPI.getStack(Materials2Materials.StainlessSteel, Materials2Shapes.shapePlate, (int) (16)))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI
                                .getStack(Materials2Materials.StainlessSteel, Materials2Shapes.shapeRing, (int) (4)),
    ...
    private static void addMK1Recipes() {
        // Power core MK1
        GTValues.RA.stdBuilder().itemInputs(
                MaterialLibAPI.getStack(Materials2Materials.TungstenSteel, Materials2Shapes.shapeItemCasing, (int) (8)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.NetherStar, Materials2Shapes.shapeLens, (int) (2)),
                        MaterialLibAPI
                                .getStack(Materials2Materials.TungstenSteel, Materials2Shapes.shapeRing, (int) (4)),
    ...
    private static void addMK2Recipes() {
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Circuit_Chip_HPIC.get(1))
                ...
                .itemInputs(
                        MaterialLibAPI.getStack(Materials2Materials.HSSS, Materials2Shapes.shapeItemCasing, (int) (8)),
                        ...
                        MaterialLibAPI.getStack(Materials2Materials.HSSS, Materials2Shapes.shapeScrew, (int) (16)))
                .fluidInputs(
        ...
        // Frame MK2
        GTValues.RA.stdBuilder()
                .itemInputs(MaterialLibAPI.getStack(Materials2Materials.HSSS, Materials2Shapes.shapePlate, (int) (48)))
    ...
    private static void addMK3Recipe() {
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, ItemList.Circuit_Chip_UHPIC.get(1))
                ...
                .itemInputs(
                        ...
                        new Object[] { OrePrefixes.circuit.get(Materials.ZPM), 2 },
                        MaterialLibAPI
                                .getStack(Materials2Materials.NaquadahAlloy, Materials2Shapes.shapeScrew, (int) (16)))
                .fluidInputs(
                        MaterialsAlloy.INDALLOY_140.getFluidStack(INGOTS * 16),
                        MaterialLibAPI.getFluidStack(
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemInputs(
                        ...
                        MaterialLibAPI
                                .getStack(Materials2Materials.Trinium, Materials2Shapes.shapeItemCasing, (int) (8)),
                        MaterialLibAPI.getStack(Materials2Materials.Trinium, Materials2Shapes.shapeScrew, (int) (16)))
                .fluidInputs(
                        MaterialsAlloy.INDALLOY_140.getFluidStack(INGOTS * 16),
                        MaterialLibAPI.getFluidStack(
        ...
        // Frame MK3
        GTValues.RA.stdBuilder().itemInputs(
                MaterialLibAPI.getStack(Materials2Materials.NaquadahAlloy, Materials2Shapes.shapePlate, (int) (64)))
        ...
        GTValues.RA.stdBuilder().metadata(RESEARCH_ITEM, WerkstoffLoader.MagnetoResonaticDust.get(OrePrefixes.lens, 1))
                ...
                .itemInputs(
                        ...
                        MaterialLibAPI
                                .getStack(Materials2Materials.NaquadahAlloy, Materials2Shapes.shapeRing, (int) (4)),
                        ItemList.Field_Generator_ZPM.get(1),
    ...
    private static void addUpgradeRecipes() {
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI
                                .getStack(Materials2Materials.VibrantAlloy, Materials2Shapes.shapeFoil, (int) (16)),
                        MaterialLibAPI.getStack(Materials2Materials.Titanium, Materials2Shapes.shapePlate, (int) (8)),
                        MaterialLibAPI.getStack(Materials2Materials.Gold, Materials2Shapes.shapeFoil, (int) (16)),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        MaterialLibAPI
                                .getStack(Materials2Materials.Thaumium, Materials2Shapes.shapeItemCasing, (int) (8)),
                        MaterialLibAPI.getStack(Materials2Materials.Thaumium, Materials2Shapes.shapeScrew, (int) (8)),
        ...
        GTValues.RA.stdBuilder().itemInputs(
                ...
                jarredNode,
                MaterialLibAPI.getStack(Materials2Materials.Thaumium, Materials2Shapes.shapeItemCasing, (int) (8)),
                MaterialLibAPI.getStack(Materials2Materials.Thaumium, Materials2Shapes.shapeWireFine, (int) (32)))
                .fluidInputs(
                        MaterialLibAPI.getFluidStack(
