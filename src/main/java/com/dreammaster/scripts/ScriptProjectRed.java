...
public class ScriptProjectRed implements IScriptLoader {
    ...
    private void recipes1() {
        GTValues.RA.stdBuilder().itemInputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 0))
                .circuit(1).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 1))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(ProjectRedTransmission.ID, "projectred.transmission.wire", 1, 0))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 2))
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 3))
                .duration(20 * SECONDS).eut(30).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 1),
                        getModItem(Minecraft.ID, "redstone", 3, 0))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 4))
                .duration(20 * SECONDS).eut(30).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 1),
                        getModItem(Minecraft.ID, "redstone_torch", 1, 0))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 5))
                .duration(20 * SECONDS).eut(30).addTo(assemblerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 5),
                        GTOreDictUnificator.get(OrePrefixes.lens, Materials.Ruby, 1L))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 6))
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 9))
    ...
    private void circuitAssemblerRecipes() {
        for (Materials solderingMaterial : solderingMaterials) {
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 44))
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(getSolderingFluid(solderingMaterial, 36))
                    .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 8, 44))
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .fluidInputs(getSolderingFluid(solderingMaterial, 36))
                    .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 16, 44))
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(1)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 0))
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 5))
                    .circuit(2)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 1))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // NOT Gate
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(3)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 2))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // AND Gate
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(4)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 3))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // NAND Gate
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 3, 5))
                    .circuit(5)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 4))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // XOR Gate
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 3, 5))
                    .circuit(1)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 5))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // XNOR Gate
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 5))
                    .circuit(2)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 6))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Buffer Gate
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 5))
                    .circuit(6)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 7))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Multiplexr
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 5))
                    .circuit(7)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 8))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Pulser Former
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 3, 5))
                    .circuit(8)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 9))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Repeater
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 5))
                    .circuit(9)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 10))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Randomizer
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(10)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 11))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // RS Latch
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 5))
                    .circuit(11)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 12))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Toggle Latch
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 5))
                    .circuit(12)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 13))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Transparent Latch
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(13)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 14))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Light Sensor
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(16)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 17))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Sequenzer
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 6))
                    .circuit(17)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 18))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Counter
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 6))
                    .circuit(18)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 19))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // State Cell
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(19)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 20))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Synchronizer
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(3)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 21))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Bus Transition
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 7))
                    .circuit(20)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 22))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Null Cell
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(21)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 23))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Inverter Cell
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 9))
                    .circuit(22)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 24))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Buffer Cell
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 9))
                    .circuit(23)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 25))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Comparator
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(4)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 26))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // And Cell
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 9))
                    .circuit(24)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 27))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Bus Randomizer
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(5)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 28))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Bus Converter
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 7))
                    .circuit(6)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 29))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Bus Input Pannel
            ...
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            getModItem(ProjectRedCore.ID, "projectred.core.part", 5, 5))
                    .circuit(8)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 31))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            ...
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(9)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 32))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
            // Segment Display Gate
            GTValues.RA.stdBuilder()
                    ...
                    .circuit(10)
                    .itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 33))
                    .fluidInputs(getSolderingFluid(solderingMaterial, 72)).duration(15 * SECONDS).eut(30)
                    .addTo(circuitAssemblerRecipes);
        }
    }
    ...
    private void recipes2() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 7))
                .duration(30 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 0),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 14))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 8))
                .duration(30 * SECONDS).eut(30).addTo(formingPressRecipes);
        for (ItemStack itemStack : OreDictionary.getOres("craftingLensRed")) {
            GTValues.RA.stdBuilder()
                    ...
                    .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 13))
        ...
        for (ItemStack itemStack : OreDictionary.getOres("craftingLensYellow")) {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            GTUtility.copyAmount(0, itemStack))
                    .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 14))
                    .duration(30 * SECONDS).eut(30).addTo(laserEngraverRecipes);
        }
        for (ItemStack itemStack : OreDictionary.getOres("craftingLensBlue")) {
            GTValues.RA.stdBuilder()
                    .itemInputs(
                            ...
                            GTUtility.copyAmount(0, itemStack))
                    .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 59))
                    .duration(30 * SECONDS).eut(30).addTo(laserEngraverRecipes);
        }
        GTValues.RA.stdBuilder()
                .itemInputs(ItemList.Circuit_Silicon_Wafer.get(1L), getModItem(Minecraft.ID, "redstone", 8, 0))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 42))
                .duration(20 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Silicon_Wafer2.get(1L),
                        getModItem(Minecraft.ID, "redstone", 16, 0))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 42))
                .duration(40 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Silicon_Wafer3.get(1L),
                        getModItem(Minecraft.ID, "redstone", 32, 0))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 42))
        ...
        GTValues.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 43))
                .duration(20 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Silicon_Wafer2.get(1L),
                        getModItem(Minecraft.ID, "glowstone_dust", 16, 0))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 43))
                .duration(40 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Silicon_Wafer3.get(1L),
                        getModItem(Minecraft.ID, "glowstone_dust", 32, 0))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 43))
                .duration(60 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Silicon_Wafer.get(1L),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 8, 56))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 58))
                .duration(20 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Silicon_Wafer2.get(1L),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 16, 56))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 58))
                .duration(40 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ItemList.Circuit_Silicon_Wafer3.get(1L),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 32, 56))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 58))
                .duration(60 * SECONDS).eut(30).addTo(formingPressRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(Minecraft.ID, "iron_ingot", 1, 0),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 8, 56))
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 57))
                .duration(20 * SECONDS).eut(30).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 15))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 0))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 19))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 25))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 19))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 14))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 20))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 1))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 20))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 24))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 20))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 13))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 21))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 2))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 21))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 23))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 21))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 12))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 22))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 3))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 22))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 22))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 22))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 11))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 23))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 4))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 23))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 21))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 23))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 10))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 24))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 5))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 24))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 20))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 24))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
                ...
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 9))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 25))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 6))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 25))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 19))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 25))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 8))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 26))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 7))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 26))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 18))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 26))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 7))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 27))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 8))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 27))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 17))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 27))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 6))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 28))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 9))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 28))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 16))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 28))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 5))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 29))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 10))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 29))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 15))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 29))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 4))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 30))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 11))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 30))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 14))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 30))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 3))
        ...
        GTValues.RA.stdBuilder()
                ...
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 12))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 31))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 13))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 31))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 2))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 32))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 13))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 32))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 12))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 32))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 1))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 33))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 14))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 33))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 11))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 33))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Minecraft.ID, "dye", 1, 0))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 34))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), getModItem(Botania.ID, "dye", 1, 15))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 34))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(ThaumicHorizons.ID, "inkEgg", 1, 0))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 34))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        new ItemStack(Items.glowstone_dust, 1),
                        getModItem(Gendustry.ID, "HoneyDrop", 1, 10))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 34))
                .duration(1 * SECONDS + 5 * TICKS).eut(8).addTo(mixerRecipes);
