...
public class ScriptProjectRed implements IScriptLoader {
    ...
    private void craftingRecipes() {
        ...
        addShapedRecipe(
                ...
                "circuitBasic",
                "itemCasingSteel",
                createItemStack(GregTech.ID, "gt.metaitem.01", 1, 32510, "{GT.ItemCharge:18000L}"),
                "itemCasingSteel");
        addShapedRecipe(
                getModItem(ProjectRedTransportation.ID, "projectred.transportation.routerutil", 1, 0),
                "wireGt01RedAlloy",
                ...
                "circuitBasic",
                "itemCasingSteel",
                createItemStack(GregTech.ID, "gt.metaitem.01", 1, 32511, "{GT.ItemCharge:32000L}"),
                "itemCasingSteel");
        addShapedRecipe(
                getModItem(ProjectRedTransportation.ID, "projectred.transportation.routerutil", 1, 0),
                "wireGt01RedAlloy",
                ...
                "circuitBasic",
                "itemCasingSteel",
                createItemStack(GregTech.ID, "gt.metaitem.01", 1, 32517, "{GT.ItemCharge:75000L}"),
                "itemCasingSteel");
        addShapedRecipe(
                getModItem(ProjectRedTransportation.ID, "projectred.transportation.routerutil", 1, 0),
                "wireGt01RedAlloy",
        ...
        addShapedRecipe(
                ...
                "circuitBasic",
                "itemCasingSteel",
                createItemStack(GregTech.ID, "gt.metaitem.01", 1, 32519, "{GT.ItemCharge:50000L}"),
                "itemCasingSteel");
        addShapedRecipe(
    ...
    private void routingChipRecipes() {
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
                .itemOutputs(getModItem(ProjectRedTransportation.ID, "projectred.transportation.routingchip", 16, 0))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 28))
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
                .itemOutputs(getModItem(ProjectRedTransportation.ID, "projectred.transportation.routingchip", 16, 1))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedTransportation)
                .addTo(circuitAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
                .itemOutputs(getModItem(ProjectRedTransportation.ID, "projectred.transportation.routingchip", 16, 2))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedTransportation)
                .addTo(circuitAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 26))
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
                .itemOutputs(getModItem(ProjectRedTransportation.ID, "projectred.transportation.routingchip", 16, 3))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedTransportation)
                .addTo(circuitAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
                .itemOutputs(getModItem(ProjectRedTransportation.ID, "projectred.transportation.routingchip", 16, 4))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedTransportation)
                .addTo(circuitAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
                .itemOutputs(getModItem(ProjectRedTransportation.ID, "projectred.transportation.routingchip", 16, 5))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedTransportation)
                .addTo(circuitAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
                .itemOutputs(getModItem(ProjectRedTransportation.ID, "projectred.transportation.routingchip", 16, 6))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedTransportation)
                .addTo(circuitAssemblerRecipes);
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(SubstituteFluidStack.soldering(1 * QUARTER_INGOTS))
                .itemOutputs(getModItem(ProjectRedTransportation.ID, "projectred.transportation.routingchip", 16, 7))
                .duration(50 * SECONDS).eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedTransportation)
                .addTo(circuitAssemblerRecipes);
    ...
    private void logicGateRecipes() {
        // OR Gate
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 1),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 5),
                        NHItemList.EtchedLowVoltageWiring.get(2))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 5))
                .circuit(1).itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 1))
                .fluidInputs(SubstituteFluidStack.soldering(1 * HALF_INGOTS)).duration(15 * SECONDS)
                .eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedIntegration)
                .addTo(circuitAssemblerRecipes);
        // NOT Gate
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 4),
        ...
        GTValues.RA.stdBuilder()
                ...
                .circuit(2).itemOutputs(getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 4))
                .fluidInputs(SubstituteFluidStack.soldering(1 * HALF_INGOTS)).duration(15 * SECONDS)
                .eut(TierEU.RECIPE_LV).requireMods(ProjectRedCore, ProjectRedIntegration)
                .addTo(circuitAssemblerRecipes);
        // XOR Gate
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 0),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 5),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 5),
                        NHItemList.EtchedLowVoltageWiring.get(2))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 2),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 5),
                        NHItemList.EtchedLowVoltageWiring.get(2))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(Minecraft.ID, "repeater", 1),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 0),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 2),
                        getModItem(Minecraft.ID, "repeater", 1))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 4),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 1, 5),
                        getModItem(Minecraft.ID, "repeater", 2))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 9),
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 23),
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 7),
                        NHItemList.EtchedLowVoltageWiring.get(2))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 23),
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 3),
                        NHItemList.EtchedLowVoltageWiring.get(2))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        ...
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 3),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 1))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedIntegration.ID, "projectred.integration.gate", 1, 2),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 3),
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 2, 1))
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 3),
                        NHItemList.EtchedLowVoltageWiring.get(4),
    ...
    private void recipes2() {
        ...
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeWhite", 1))
                ...
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeOrange", 1)).circuit(8)
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 20))
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeMagenta", 1)).circuit(8)
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 21))
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeLightBlue", 1)).circuit(8)
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 22))
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeYellow", 1)).circuit(8)
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 23))
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeLime", 1))
                ...
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyePink", 1))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 25))
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeGray", 1))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 26))
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeLightGray", 1)).circuit(8)
                .itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 27))
                .duration(1 * SECONDS + 5 * TICKS).requireMods(ProjectRedCore).eut(TierEU.RECIPE_ULV)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeCyan", 1))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 28))
                .duration(1 * SECONDS + 5 * TICKS).requireMods(ProjectRedCore).eut(TierEU.RECIPE_ULV)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder()
                .itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyePurple", 1)).circuit(8)
        ...
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeBrown", 1))
                ...
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeGreen", 1))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 32))
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeRed", 1))
                .circuit(8).itemOutputs(getModItem(ProjectRedCore.ID, "projectred.core.part", 4, 33))
                .duration(1 * SECONDS + 5 * TICKS).eut(TierEU.RECIPE_ULV).requireMods(ProjectRedCore)
                .addTo(mixerRecipes);
        GTValues.RA.stdBuilder().itemInputs(new ItemStack(Items.glowstone_dust, 1), new OreDictItemStack("dyeBlack", 1))
