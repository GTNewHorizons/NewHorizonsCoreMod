...
public class ScriptStevesFactoryManager implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.stainlesssteel", 144)).duration(150).eut(480)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 288)).duration(200).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(StevesFactoryManager.ID, "BlockCableName", 1, 0, missing),
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 576)).duration(300).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(StevesFactoryManager.ID, "BlockCableName", 1, 0, missing),
        ...
        GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(getModItem(StevesFactoryManager.ID, "BlockCableClusterName", 1, 8, missing)).duration(200)
        ...
        GT_Values.RA.stdBuilder()
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 864)).duration(400).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        getModItem(StevesFactoryManager.ID, "BlockCableName", 1, 0, missing),
        ...
        GT_Values.RA.stdBuilder().itemInputs(ItemList.Tool_Scanner.get(1L), ItemList.Tool_DataStick.get(1L))
                ...
                .fluidInputs(FluidRegistry.getFluidStack("molten.redstone", 144)).duration(150).eut(480)
                .addTo(sAssemblerRecipes);
        GT_Values.RA.stdBuilder()
                .itemInputs(
                        CustomItemList.Display.get(1L),
