...
public class ScriptThaumicBases implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        CrucibleRecipe leatherHelmetBP = ThaumcraftApi.addCrucibleRecipe(
                "TB.Backprocessing",
                getModItem(Minecraft.ID, "leather", 5, 1, missing),
