...
public class ScriptTwilightForest implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
                .itemInputs(
                        MaterialLibAPI.getStack(Materials.Steeleaf, Shapes.dust, (int) (1L)),
        ...
        GTValues.RA.stdBuilder()
                ...
                .fluidInputs(MaterialLibAPI.getFluidStack(Materials.Glowstone, FluidShapes.fluidMolten, (int) (144)))
        ...
        GTValues.RA.stdBuilder().itemInputs(getModItem(ZTones.ID, "auroraBlock", 1, 0), NHItemList.StonePlate.get(16))
                ...
                .fluidInputs(
                        MaterialUtils.gas(Materials.Helium3, 1600),
                        MaterialLibAPI.getFluidStack(Materials.Helium, FluidShapes.fluidGas, (int) (16000)))
