...
public class ScriptVendingMachine implements IScriptLoader {
    ...
    public void loadRecipes() {
        addShapedRecipe(getModItem(VendingMachine.ID, "multimachine.vendingmachine", 1, 0, missing),
        ...
        addShapelessRecipe(getModItem(VendingMachine.ID, "hatch.vendinguplink.me", 1, 0, missing),
