    ...
    public void loadRecipes() {
        coins.addAll(
                GTValues.RA.stdBuilder()
                        .itemInputs(CustomItemList.CoinBlank.get(1L), GTUtility.getIntegratedCircuit(1))
        ...
        coins.addAll(
                GTValues.RA.stdBuilder()
                        .itemInputs(CustomItemList.CoinBlank.get(1L), GTUtility.getIntegratedCircuit(2))
        ...
        coins.addAll(
                GTValues.RA.stdBuilder()
                        .itemInputs(CustomItemList.CoinBlank.get(1L), GTUtility.getIntegratedCircuit(3))
        ...
        coins.addAll(
                GTValues.RA.stdBuilder()
                        .itemInputs(CustomItemList.CoinBlank.get(1L), GTUtility.getIntegratedCircuit(4))
        ...
        coins.addAll(
                GTValues.RA.stdBuilder()
                        .itemInputs(CustomItemList.CoinBlank.get(1L), GTUtility.getIntegratedCircuit(5))
