    ...
    private static void registerResearch() {
        ...
        // --- Wither Ring
        {
            InfusionRecipe recipe = ThaumcraftApi.addInfusionCraftingRecipe(
                    ...
                    3,
                    new AspectList()
                            .add(Aspect.getAspect("alienis"), 45)
                            .add(Aspect.getAspect("praecantatio"), 35)
                            .add(Aspect.getAspect("spiritus"), 30)
                            .add(Aspect.getAspect("superbia"), 25)
                            .add(Aspect.getAspect("infernus"), 15),
                    getModItem("Thaumcraft", "ItemBaubleBlanks", 1, 1, missing),
                    new ItemStack[] {
                        getModItem("minecraft", "nether_star", 1, missing),
            ...
            ResearchItem research = new ResearchItem(
                            ...
                            new AspectList()
                                    ...
                                    .add(Aspect.getAspect("spiritus"), 6)
                                    .add(Aspect.getAspect("infernus"), 3),
                            3,
                            2,
                            4,
                            getModItem("dreamcraft", "item.WitherProtectionRing", 1, missing))
                    .setPages(new ResearchPage("NewHorizons.research_page.WITHERRING"), new ResearchPage(recipe))
                    .setParents("RUNICARMOR")
                    .setSiblings("RUNICARMOR")
                    .setConcealed();
