...
public class SmelteryFluidTypes {
    ...
    public static void registerGregtechFluidTypes() {
        ...
        Fluid moltenBrass = FluidRegistry.getFluid("molten.brass");
        FluidType.registerFluidType("Zinc", TinkerWorld.metalBlock, 6, 350, moltenZinc, false);
        String brassFluidTypeName = "Brass";
        FluidType.registerFluidType(brassFluidTypeName, TinkerWorld.metalBlock, 7, 350, moltenBrass, false);
